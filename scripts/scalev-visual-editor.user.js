...
`;case 114:return"\r";case 120:return String.fromCharCode(this.readHexChar(2));case 117:return ct(this.readCodePoint());case 116:return"	";case 98:return"\b";case 118:return"\v";case 102:return"\f";case 13:this.input.charCodeAt(this.pos)===10&&++this.pos;case 10:return this.options.locations&&(this.lineStart=this.pos,++this.curLine),"";case 56:case 57:if(this.strict&&this.invalidStringToken(this.pos-1,"Invalid escape sequence"),e){var i=this.pos-1;this.invalidStringToken(i,"Invalid escape sequence in template string")}default:if(t>=48&&t<=55){var n=this.input.substr(this.pos-1,3).match(/^[0-7]+/)[0],l=parseInt(n,8);return l>255&&(n=n.slice(0,-1),l=parseInt(n,8)),this.pos+=n.length-1,t=this.input.charCodeAt(this.pos),(n!=="0"||t===56||t===57)&&(this.strict||e)&&this.invalidStringToken(this.pos-1-n.length,e?"Octal literal in template string":"Octal literal in strict mode"),String.fromCharCode(l)}return Wt(t)?(this.options.locations&&(this.lineStart=this.pos,++this.curLine),""):String.fromCharCode(t)}};V.readHexChar=function(e){var t=this.pos,i=this.readInt(16,e);return i===null&&this.invalidStringToken(t,"Bad character escape sequence"),i};V.readWord1=function(){this.containsEsc=!1;for(var e="",t=!0,i=this.pos,n=this.options.ecmaVersion>=6;this.pos<this.input.length;){var l=this.fullCharCodeAtPos();if(yt(l,n))this.pos+=l<=65535?1:2;else if(l===92){this.containsEsc=!0,e+=this.input.slice(i,this.pos);var p=this.pos;this.input.charCodeAt(++this.pos)!==117&&this.invalidStringToken(this.pos,"Expecting Unicode escape sequence \\uXXXX"),++this.pos;var d=this.readCodePoint();(t?et:yt)(d,n)||this.invalidStringToken(p,"Invalid Unicode escape"),e+=ct(d),i=this.pos}else break;t=!1}return e+this.input.slice(i,this.pos)};V.readWord=function(){var e=this.readWord1(),t=f.name;return this.keywords.test(e)&&(t=_n[e]),this.finishToken(t,e)};var om="8.18.0";ue.acorn={Parser:ue,version:om,defaultOptions:En,Position:Si,SourceLocation:dr,getLineInfo:wc,Node:br,TokenType:W,tokTypes:f,keywordTypes:_n,TokContext:qe,tokContexts:ee,isIdentifierChar:yt,isIdentifierStart:et,Token:Rn,isNewLine:Wt,lineBreak:Ce,lineBreakG:Lf,nonASCIIwhitespace:kc};function eu(e,t){return ue.parse(e,t)}var Kt=null,Ei=class e{static createItem(t){return{prev:null,next:null,data:t}}constructor(){this.head=null,this.tail=null,this.cursor=null}createItem(t){return e.createItem(t)}allocateCursor(t,i){let n;return Kt!==null?(n=Kt,Kt=Kt.cursor,n.prev=t,n.next=i,n.cursor=this.cursor):n={prev:t,next:i,cursor:this.cursor},this.cursor=n,n}releaseCursor(){let{cursor:t}=this;this.cursor=t.cursor,t.prev=null,t.next=null,t.cursor=Kt,Kt=t}updateCursors(t,i,n,l){let{cursor:p}=this;for(;p!==null;)p.prev===t&&(p.prev=i),p.next===n&&(p.next=l),p=p.cursor}*[Symbol.iterator](){for(let t=this.head;t!==null;t=t.next)yield t.data}get size(){let t=0;for(let i=this.head;i!==null;i=i.next)t++;return t}get isEmpty(){return this.head===null}get first(){return this.head&&this.head.data}get last(){return this.tail&&this.tail.data}fromArray(t){let i=null;this.head=null;for(let n of t){let l=e.createItem(n);i!==null?i.next=l:this.head=l,l.prev=i,i=l}return this.tail=i,this}toArray(){return[...this]}toJSON(){return[...this]}forEach(t,i=this){let n=this.allocateCursor(null,this.head);for(;n.next!==null;){let l=n.next;n.next=l.next,t.call(i,l.data,l,this)}this.releaseCursor()}forEachRight(t,i=this){let n=this.allocateCursor(this.tail,null);for(;n.prev!==null;){let l=n.prev;n.prev=l.prev,t.call(i,l.data,l,this)}this.releaseCursor()}reduce(t,i,n=this){let l=this.allocateCursor(null,this.head),p=i,d;for(;l.next!==null;)d=l.next,l.next=d.next,p=t.call(n,p,d.data,d,this);return this.releaseCursor(),p}reduceRight(t,i,n=this){let l=this.allocateCursor(this.tail,null),p=i,d;for(;l.prev!==null;)d=l.prev,l.prev=d.prev,p=t.call(n,p,d.data,d,this);return this.releaseCursor(),p}some(t,i=this){for(let n=this.head;n!==null;n=n.next)if(t.call(i,n.data,n,this))return!0;return!1}map(t,i=this){let n=new e;for(let l=this.head;l!==null;l=l.next)n.appendData(t.call(i,l.data,l,this));return n}filter(t,i=this){let n=new e;for(let l=this.head;l!==null;l=l.next)t.call(i,l.data,l,this)&&n.appendData(l.data);return n}nextUntil(t,i,n=this){if(t===null)return;let l=this.allocateCursor(null,t);for(;l.next!==null;){let p=l.next;if(l.next=p.next,i.call(n,p.data,p,this))break}this.releaseCursor()}prevUntil(t,i,n=this){if(t===null)return;let l=this.allocateCursor(t,null);for(;l.prev!==null;){let p=l.prev;if(l.prev=p.prev,i.call(n,p.data,p,this))break}this.releaseCursor()}clear(){this.head=null,this.tail=null}copy(){let t=new e;for(let i of this)t.appendData(i);return t}prepend(t){return this.updateCursors(null,t,this.head,t),this.head!==null?(this.head.prev=t,t.next=this.head):this.tail=t,this.head=t,this}prependData(t){return this.prepend(e.createItem(t))}append(t){return this.insert(t)}appendData(t){return this.insert(e.createItem(t))}insert(t,i=null){if(i!==null)if(this.updateCursors(i.prev,t,i,t),i.prev===null){if(this.head!==i)throw new Error("before doesn't belong to list");this.head=t,i.prev=t,t.next=i,this.updateCursors(null,t)}else i.prev.next=t,t.prev=i.prev,i.prev=t,t.next=i;else this.updateCursors(this.tail,t,null,t),this.tail!==null?(this.tail.next=t,t.prev=this.tail):this.head=t,this.tail=t;return this}insertData(t,i){return this.insert(e.createItem(t),i)}remove(t){if(this.updateCursors(t,t.prev,t,t.next),t.prev!==null)t.prev.next=t.next;else{if(this.head!==t)throw new Error("item doesn't belong to list");this.head=t.next}if(t.next!==null)t.next.prev=t.prev;else{if(this.tail!==t)throw new Error("item doesn't belong to list");this.tail=t.prev}return t.prev=null,t.next=null,t}push(t){this.insert(e.createItem(t))}pop(){return this.tail!==null?this.remove(this.tail):null}unshift(t){this.prepend(e.createItem(t))}shift(){return this.head!==null?this.remove(this.head):null}prependList(t){return this.insertList(t,this.head)}appendList(t){return this.insertList(t)}insertList(t,i){return t.head===null?this:(i!=null?(this.updateCursors(i.prev,t.tail,i,t.head),i.prev!==null?(i.prev.next=t.head,t.head.prev=i.prev):this.head=t.head,i.prev=t.tail,t.tail.next=i):(this.updateCursors(this.tail,t.tail,null,t.head),this.tail!==null?(this.tail.next=t.head,t.head.prev=this.tail):this.head=t.head,this.tail=t.tail),t.head=null,t.tail=null,this)}replace(t,i){"head"in i?this.insertList(i,t):this.insert(i,t),this.remove(t)}};function tu(e,t){let i=Object.create(SyntaxError.prototype),n=new Error;return Object.assign(i,{name:e,message:t,get stack(){return(n.stack||"").replace(/^(.+\n){1,3}/,`${e}: ${t}
`)}})}var Fn=100,iu=60,ru="    ";function nu({source:e,line:t,column:i,baseLine:n,baseColumn:l},p){function d(_,K){return b.slice(_,K).map((te,Y)=>String(_+Y+1).padStart(C)+" |"+te).join(`
`)}let g=`
`.repeat(Math.max(n-1,0)),x=" ".repeat(Math.max(l-1,0)),b=(g+x+e).split(/\r\n?|\n|\f/),y=Math.max(1,t-p)-1,k=Math.min(t+p,b.length+1),C=Math.max(4,String(k).length)+1,u=0;i+=(ru.length-1)*(b[t-1].substr(0,i-1).match(/\t/g)||[]).length,i>Fn&&(u=i-iu+3,i=iu-2);for(let _=y;_<=k;_++)_>=0&&_<b.length&&(b[_]=b[_].replace(/\t/g,ru),b[_]=(u>0&&b[_].length>u?"\u2026":"")+b[_].substr(u,Fn-2)+(b[_].length>u+Fn-1?"\u2026":""));return[d(y,t),new Array(i+C+2).join("-")+"^",d(t,k)].filter(Boolean).join(`
`).replace(/^(\s+\d+\s+\|\n)+/,"").replace(/\n(\s+\d+\s+\|)+$/,"")}function Mn(e,t,i,n,l,p=1,d=1){return Object.assign(tu("SyntaxError",e),{source:t,offset:i,line:n,column:l,sourceFragment(x){return nu({source:t,line:n,column:l,baseLine:p,baseColumn:d},isNaN(x)?0:x)},get formattedMessage(){return`Parse error: ${e}
`+nu({source:t,line:n,column:l,baseLine:p,baseColumn:d},2)}})}function ye(e){return e>=48&&e<=57}function it(e){return ye(e)||e>=65&&e<=70||e>=97&&e<=102}function vr(e){return e>=65&&e<=90}function lm(e){return e>=97&&e<=122}function cm(e){return vr(e)||lm(e)}function um(e){return e>=128}function yr(e){return cm(e)||um(e)||e===95}function kr(e){return yr(e)||ye(e)||e===45}function pm(e){return e>=0&&e<=8||e===11||e>=14&&e<=31||e===127}function Ai(e){return e===10||e===13||e===12}function rt(e){return Ai(e)||e===32||e===9}function Ee(e,t){return!(e!==92||Ai(t)||t===0)}function Sr(e,t,i){return e===45?yr(t)||t===45||Ee(t,i):yr(e)?!0:e===92?Ee(e,t):!1}function wr(e,t,i){return e===43||e===45?ye(t)?2:t===46&&ye(i)?3:0:e===46?ye(t)?2:0:ye(e)?1:0}function Cr(e){return e===65279||e===65534?1:0}var On=new Array(128),hm=128,Ti=130,Dn=131,Er=132,Vn=133;for(let e=0;e<On.length;e++)On[e]=rt(e)&&Ti||ye(e)&&Dn||yr(e)&&Er||pm(e)&&Vn||e||hm;function Ar(e){return e<128?On[e]:Er}function Yt(e,t){return t<e.length?e.charCodeAt(t):0}function Tr(e,t,i){return i===13&&Yt(e,t+1)===10?2:1}function jn(e,t,i){let n=e.charCodeAt(t);return vr(n)&&(n=n|32),n===i}function Lt(e,t,i,n){if(i-t!==n.length||t<0||i>e.length)return!1;for(let l=t;l<i;l++){let p=n.charCodeAt(l-t),d=e.charCodeAt(l);if(vr(d)&&(d=d|32),d!==p)return!1}return!0}function au(e,t){for(;t>=0&&rt(e.charCodeAt(t));t--);return t+1}function _i(e,t){for(;t<e.length&&rt(e.charCodeAt(t));t++);return t}function Bn(e,t){for(;t<e.length&&ye(e.charCodeAt(t));t++);return t}function ht(e,t){if(t+=2,it(Yt(e,t-1))){for(let n=Math.min(e.length,t+5);t<n&&it(Yt(e,t));t++);let i=Yt(e,t);rt(i)&&(t+=Tr(e,t,i))}return t}function Ii(e,t){for(;t<e.length;t++){let i=e.charCodeAt(t);if(!kr(i)){if(Ee(i,Yt(e,t+1))){t=ht(e,t)-1;continue}break}}return t}function _r(e,t){let i=e.charCodeAt(t);if((i===43||i===45)&&(i=e.charCodeAt(t+=1)),ye(i)&&(t=Bn(e,t+1),i=e.charCodeAt(t)),i===46&&ye(e.charCodeAt(t+1))&&(t+=2,t=Bn(e,t)),jn(e,t,101)){let n=0;i=e.charCodeAt(t+1),(i===45||i===43)&&(n=1,i=e.charCodeAt(t+2)),ye(i)&&(t=Bn(e,t+1+n+1))}return t}function Ir(e,t){for(;t<e.length;t++){let i=e.charCodeAt(t);if(i===41){t++;break}Ee(i,Yt(e,t+1))&&(t=ht(e,t))}return t}function Lr(e){if(e.length===1&&!it(e.charCodeAt(0)))return e[0];let t=parseInt(e,16);return(t===0||t>=55296&&t<=57343||t>1114111)&&(t=65533),String.fromCodePoint(t)}var Qt=["EOF-token","ident-token","function-token","at-keyword-token","hash-token","string-token","bad-string-token","url-token","bad-url-token","delim-token","number-token","percentage-token","dimension-token","whitespace-token","CDO-token","CDC-token","colon-token","semicolon-token","comma-token","[-token","]-token","(-token",")-token","{-token","}-token","comment-token"];function Zt(e=null,t){return e===null||e.length<t?new Uint32Array(Math.max(t+1024,16384)):e}var su=10,dm=12,ou=13;function lu(e){let t=e.source,i=t.length,n=t.length>0?Cr(t.charCodeAt(0)):0,l=Zt(e.lines,i),p=Zt(e.columns,i),d=e.startLine,g=e.startColumn;for(let x=n;x<i;x++){let b=t.charCodeAt(x);l[x]=d,p[x]=g++,(b===su||b===ou||b===dm)&&(b===ou&&x+1<i&&t.charCodeAt(x+1)===su&&(x++,l[x]=d,p[x]=g),d++,g=1)}l[i]=d,p[i]=g,e.lines=l,e.columns=p,e.computed=!0}var $r=class{constructor(t,i,n,l){this.setSource(t,i,n,l),this.lines=null,this.columns=null}setSource(t="",i=0,n=1,l=1){this.source=t,this.startOffset=i,this.startLine=n,this.startColumn=l,this.computed=!1}getLocation(t,i){return this.computed||lu(this),{source:i,offset:this.startOffset+t,line:this.lines[t],column:this.columns[t]}}getLocationRange(t,i,n){return this.computed||lu(this),{source:n,start:{offset:this.startOffset+t,line:this.lines[t],column:this.columns[t]},end:{offset:this.startOffset+i,line:this.lines[i],column:this.columns[i]}}}};var Ke=16777215,Ye=24,$i=1,Nr=2,kt=new Uint8Array(32);kt[2]=22;kt[21]=22;kt[19]=20;kt[23]=24;var Qe=new Uint8Array(32);Qe[2]=$i;Qe[21]=$i;Qe[19]=$i;Qe[23]=$i;Qe[22]=Nr;Qe[20]=Nr;Qe[24]=Nr;function cu(e,t,i){return e<t?t:e>i?i:e}var Pr=class{constructor(t,i){this.setSource(t,i)}reset(){this.eof=!1,this.tokenIndex=-1,this.tokenType=0,this.tokenStart=this.firstCharOffset,this.tokenEnd=this.firstCharOffset}setSource(t="",i=()=>{}){t=String(t||"");let n=t.length,l=Zt(this.offsetAndType,t.length+1),p=Zt(this.balance,t.length+1),d=0,g=-1,x=0,b=t.length;this.offsetAndType=null,this.balance=null,p.fill(0),i(t,(y,k,C)=>{let u=d++;if(l[u]=y<<Ye|C,g===-1&&(g=k),p[u]=b,y===x){let _=p[b];p[b]=u,b=_,x=kt[l[_]>>Ye]}else this.isBlockOpenerTokenType(y)&&(b=u,x=kt[y])}),l[d]=0<<Ye|n,p[d]=d;for(let y=0;y<d;y++){let k=p[y];if(k<=y){let C=p[k];C!==y&&(p[y]=C)}else k>d&&(p[y]=d)}this.source=t,this.firstCharOffset=g===-1?0:g,this.tokenCount=d,this.offsetAndType=l,this.balance=p,this.reset(),this.next()}lookupType(t){return t+=this.tokenIndex,t<this.tokenCount?this.offsetAndType[t]>>Ye:0}lookupTypeNonSC(t){for(let i=this.tokenIndex;i<this.tokenCount;i++){let n=this.offsetAndType[i]>>Ye;if(n!==13&&n!==25&&t--===0)return n}return 0}lookupOffset(t){return t+=this.tokenIndex,t<this.tokenCount?this.offsetAndType[t-1]&Ke:this.source.length}lookupOffsetNonSC(t){for(let i=this.tokenIndex;i<this.tokenCount;i++){let n=this.offsetAndType[i]>>Ye;if(n!==13&&n!==25&&t--===0)return i-this.tokenIndex}return 0}lookupValue(t,i){return t+=this.tokenIndex,t<this.tokenCount?Lt(this.source,this.offsetAndType[t-1]&Ke,this.offsetAndType[t]&Ke,i):!1}getTokenStart(t){return t===this.tokenIndex?this.tokenStart:t>0?t<this.tokenCount?this.offsetAndType[t-1]&Ke:this.offsetAndType[this.tokenCount]&Ke:this.firstCharOffset}getTokenEnd(t){return t===this.tokenIndex?this.tokenEnd:this.offsetAndType[cu(t,0,this.tokenCount)]&Ke}getTokenType(t){return t===this.tokenIndex?this.tokenType:this.offsetAndType[cu(t,0,this.tokenCount)]>>Ye}substrToCursor(t){return this.source.substring(t,this.tokenStart)}isBlockOpenerTokenType(t){return Qe[t]===$i}isBlockCloserTokenType(t){return Qe[t]===Nr}getBlockTokenPairIndex(t){let i=this.getTokenType(t);if(Qe[i]===1){let n=this.balance[t],l=this.getTokenType(n);return kt[i]===l?n:-1}else if(Qe[i]===2){let n=this.balance[t],l=this.getTokenType(n);return kt[l]===i?n:-1}return-1}isBalanceEdge(t){return this.balance[this.tokenIndex]<t}isDelim(t,i){return i?this.lookupType(i)===9&&this.source.charCodeAt(this.lookupOffset(i))===t:this.tokenType===9&&this.source.charCodeAt(this.tokenStart)===t}skip(t){let i=this.tokenIndex+t;i<this.tokenCount?(this.tokenIndex=i,this.tokenStart=this.offsetAndType[i-1]&Ke,i=this.offsetAndType[i],this.tokenType=i>>Ye,this.tokenEnd=i&Ke):(this.tokenIndex=this.tokenCount,this.next())}next(){let t=this.tokenIndex+1;t<this.tokenCount?(this.tokenIndex=t,this.tokenStart=this.tokenEnd,t=this.offsetAndType[t],this.tokenType=t>>Ye,this.tokenEnd=t&Ke):(this.eof=!0,this.tokenIndex=this.tokenCount,this.tokenType=0,this.tokenStart=this.tokenEnd=this.source.length)}skipSC(){for(;this.tokenType===13||this.tokenType===25;)this.next()}skipUntilBalanced(t,i){let n=t,l=0,p=0;e:for(;n<this.tokenCount;n++){if(l=this.balance[n],l<t)break e;switch(p=n>0?this.offsetAndType[n-1]&Ke:this.firstCharOffset,i(this.source.charCodeAt(p))){case 1:break e;case 2:n++;break e;default:this.isBlockOpenerTokenType(this.offsetAndType[n]>>Ye)&&(n=l)}}this.skip(n-this.tokenIndex)}forEachToken(t){for(let i=0,n=this.firstCharOffset;i<this.tokenCount;i++){let l=n,p=this.offsetAndType[i],d=p&Ke,g=p>>Ye;n=d,t(g,l,d,i)}}dump(){let t=new Array(this.tokenCount);return this.forEachToken((i,n,l,p)=>{t[p]={idx:p,type:Qt[i],chunk:this.source.substring(n,l),balance:this.balance[p]}}),t}};function Rr(e,t){function i(k){return k<g?e.charCodeAt(k):0}function n(){if(b=_r(e,b),Sr(i(b),i(b+1),i(b+2))){y=12,b=Ii(e,b);return}if(i(b)===37){y=11,b++;return}y=10}function l(){let k=b;if(b=Ii(e,b),Lt(e,k,b,"url")&&i(b)===40){if(b=_i(e,b+1),i(b)===34||i(b)===39){y=2,b=k+4;return}d();return}if(i(b)===40){y=2,b++;return}y=1}function p(k){for(k||(k=i(b++)),y=5;b<e.length;b++){let C=e.charCodeAt(b);switch(Ar(C)){case k:b++;return;case Ti:if(Ai(C)){b+=Tr(e,b,C),y=6;return}break;case 92:if(b===e.length-1)break;let u=i(b+1);Ai(u)?b+=Tr(e,b+1,u):Ee(C,u)&&(b=ht(e,b)-1);break}}}function d(){for(y=7,b=_i(e,b);b<e.length;b++){let k=e.charCodeAt(b);switch(Ar(k)){case 41:b++;return;case Ti:if(b=_i(e,b),i(b)===41||b>=e.length){b<e.length&&b++;return}b=Ir(e,b),y=8;return;case 34:case 39:case 40:case Vn:b=Ir(e,b),y=8;return;case 92:if(Ee(k,i(b+1))){b=ht(e,b)-1;break}b=Ir(e,b),y=8;return}}}e=String(e||"");let g=e.length,x=Cr(i(0)),b=x,y;for(;b<g;){let k=e.charCodeAt(b);switch(Ar(k)){case Ti:y=13,b=_i(e,b+1);break;case 34:p();break;case 35:kr(i(b+1))||Ee(i(b+1),i(b+2))?(y=4,b=Ii(e,b+1)):(y=9,b++);break;case 39:p();break;case 40:y=21,b++;break;case 41:y=22,b++;break;case 43:wr(k,i(b+1),i(b+2))?n():(y=9,b++);break;case 44:y=18,b++;break;case 45:wr(k,i(b+1),i(b+2))?n():i(b+1)===45&&i(b+2)===62?(y=15,b=b+3):Sr(k,i(b+1),i(b+2))?l():(y=9,b++);break;case 46:wr(k,i(b+1),i(b+2))?n():(y=9,b++);break;case 47:i(b+1)===42?(y=25,b=e.indexOf("*/",b+2),b=b===-1?e.length:b+2):(y=9,b++);break;case 58:y=16,b++;break;case 59:y=17,b++;break;case 60:i(b+1)===33&&i(b+2)===45&&i(b+3)===45?(y=14,b=b+4):(y=9,b++);break;case 64:Sr(i(b+1),i(b+2),i(b+3))?(y=3,b=Ii(e,b+1)):(y=9,b++);break;case 91:y=19,b++;break;case 92:Ee(k,i(b+1))?l():(y=9,b++);break;case 93:y=20,b++;break;case 123:y=23,b++;break;case 125:y=24,b++;break;case Dn:n();break;case Er:l();break;default:y=9,b++}t(y,x,x=b)}}function uu(e){let t=this.createList(),i=!1,n={recognizer:e};for(;!this.eof;){switch(this.tokenType){case 25:this.next();continue;case 13:i=!0,this.next();continue}let l=e.getNode.call(this,n);if(l===void 0)break;i&&(e.onWhiteSpace&&e.onWhiteSpace.call(this,l,t,n),i=!1),t.push(l)}return i&&e.onWhiteSpace&&e.onWhiteSpace.call(this,null,t,n),t}var ei=()=>{},fm=33,mm=35,Hn=59,pu=123,hu=0,gm={createList(){return[]},createSingleNodeList(e){return[e]},getFirstListNode(e){return e&&e[0]||null},getLastListNode(e){return e&&e.length>0?e[e.length-1]:null}},bm={createList(){return new Ei},createSingleNodeList(e){return new Ei().appendData(e)},getFirstListNode(e){return e&&e.first},getLastListNode(e){return e&&e.last}};function xm(e){return function(){return this[e]()}}function zn(e){let t=Object.create(null);for(let i of Object.keys(e)){let n=e[i],l=n.parse||n;l&&(t[i]=l)}return t}function ym(e){let t={context:Object.create(null),features:Object.assign(Object.create(null),e.features),scope:Object.assign(Object.create(null),e.scope),atrule:zn(e.atrule),pseudo:zn(e.pseudo),node:zn(e.node)};for(let[i,n]of Object.entries(e.parseContext))switch(typeof n){case"function":t.context[i]=n;break;case"string":t.context[i]=xm(n);break}return{config:t,...t,...t.node}}function du(e){let t="",i="<unknown>",n=!1,l=ei,p=!1,d=new $r,g=Object.assign(new Pr,ym(e||{}),{parseAtrulePrelude:!0,parseRulePrelude:!0,parseValue:!0,parseCustomProperty:!1,readSequence:uu,consumeUntilBalanceEnd:()=>0,consumeUntilLeftCurlyBracket(y){return y===pu?1:0},consumeUntilLeftCurlyBracketOrSemicolon(y){return y===pu||y===Hn?1:0},consumeUntilExclamationMarkOrSemicolon(y){return y===fm||y===Hn?1:0},consumeUntilSemicolonIncluded(y){return y===Hn?2:0},createList:ei,createSingleNodeList:ei,getFirstListNode:ei,getLastListNode:ei,parseWithFallback(y,k){let C=this.tokenIndex;try{return y.call(this)}catch(u){if(p)throw u;this.skip(C-this.tokenIndex);let _=k.call(this);return p=!0,l(u,_),p=!1,_}},lookupNonWSType(y){let k;do if(k=this.lookupType(y++),k!==13&&k!==25)return k;while(k!==hu);return hu},charCodeAt(y){return y>=0&&y<t.length?t.charCodeAt(y):0},substring(y,k){return t.substring(y,k)},substrToCursor(y){return this.source.substring(y,this.tokenStart)},cmpChar(y,k){return jn(t,y,k)},cmpStr(y,k,C){return Lt(t,y,k,C)},consume(y){let k=this.tokenStart;return this.eat(y),this.substrToCursor(k)},consumeFunctionName(){let y=t.substring(this.tokenStart,this.tokenEnd-1);return this.eat(2),y},consumeNumber(y){let k=t.substring(this.tokenStart,_r(t,this.tokenStart));return this.eat(y),k},eat(y){if(this.tokenType!==y){let k=Qt[y].slice(0,-6).replace(/-/g," ").replace(/^./,_=>_.toUpperCase()),C=`${/[[\](){}]/.test(k)?`"${k}"`:k} is expected`,u=this.tokenStart;switch(y){case 1:this.tokenType===2||this.tokenType===7?(u=this.tokenEnd-1,C="Identifier is expected but function found"):C="Identifier is expected";break;case 4:this.isDelim(mm)&&(this.next(),u++,C="Name is expected");break;case 11:this.tokenType===10&&(u=this.tokenEnd,C="Percent sign is expected");break}this.error(C,u)}this.next()},eatIdent(y){(this.tokenType!==1||this.lookupValue(0,y)===!1)&&this.error(`Identifier "${y}" is expected`),this.next()},eatDelim(y){this.isDelim(y)||this.error(`Delim "${String.fromCharCode(y)}" is expected`),this.next()},getLocation(y,k){return n?d.getLocationRange(y,k,i):null},getLocationFromList(y){if(n){let k=this.getFirstListNode(y),C=this.getLastListNode(y);return d.getLocationRange(k!==null?k.loc.start.offset-d.startOffset:this.tokenStart,C!==null?C.loc.end.offset-d.startOffset:this.tokenStart,i)}return null},error(y,k){let C=typeof k<"u"&&k<t.length?d.getLocation(k):this.eof?d.getLocation(au(t,t.length-1)):d.getLocation(this.tokenStart);throw new Mn(y||"Unexpected input",t,C.offset,C.line,C.column,d.startLine,d.startColumn)}}),x=()=>({filename:i,source:t,tokenCount:g.tokenCount,getTokenType:y=>g.getTokenType(y),getTokenTypeName:y=>Qt[g.getTokenType(y)],getTokenStart:y=>g.getTokenStart(y),getTokenEnd:y=>g.getTokenEnd(y),getTokenValue:y=>g.source.substring(g.getTokenStart(y),g.getTokenEnd(y)),substring:(y,k)=>g.source.substring(y,k),balance:g.balance.subarray(0,g.tokenCount+1),isBlockOpenerTokenType:g.isBlockOpenerTokenType,isBlockCloserTokenType:g.isBlockCloserTokenType,getBlockTokenPairIndex:y=>g.getBlockTokenPairIndex(y),getLocation:y=>d.getLocation(y,i),getRangeLocation:(y,k)=>d.getLocationRange(y,k,i)});return Object.assign(function(y,k){t=y,k=k||{},g.setSource(t,Rr),d.setSource(t,k.offset,k.line,k.column),i=k.filename||"<unknown>",n=!!k.positions,l=typeof k.onParseError=="function"?k.onParseError:ei,p=!1,g.parseAtrulePrelude="parseAtrulePrelude"in k?!!k.parseAtrulePrelude:!0,g.parseRulePrelude="parseRulePrelude"in k?!!k.parseRulePrelude:!0,g.parseValue="parseValue"in k?!!k.parseValue:!0,g.parseCustomProperty="parseCustomProperty"in k?!!k.parseCustomProperty:!1;let{context:C="default",list:u=!0,onComment:_,onToken:K}=k;if(!(C in g.context))throw new Error("Unknown context `"+C+"`");Object.assign(g,u?bm:gm),Array.isArray(K)?g.forEachToken((Y,ge,oe)=>{K.push({type:Y,start:ge,end:oe})}):typeof K=="function"&&g.forEachToken(K.bind(x())),typeof _=="function"&&g.forEachToken((Y,ge,oe)=>{if(Y===25){let Pe=g.getLocation(ge,oe),Je=Lt(t,oe-2,oe,"*/")?t.slice(ge+2,oe-2):t.slice(ge+2,oe);_(Je,Pe)}});let te=g.context[C].call(g,k);return g.eof||g.error(),te},{SyntaxError:Mn,config:g.config})}var Wn={};N(Wn,{AtrulePrelude:()=>mu,Selector:()=>bu,Value:()=>ku});var vm=35,km=42,fu=43,Sm=45,wm=47,Cm=117;function Pi(e){switch(this.tokenType){case 4:return this.Hash();case 18:return this.Operator();case 21:return this.Parentheses(this.readSequence,e.recognizer);case 19:return this.Brackets(this.readSequence,e.recognizer);case 5:return this.String();case 12:return this.Dimension();case 11:return this.Percentage();case 10:return this.Number();case 2:return this.cmpStr(this.tokenStart,this.tokenEnd,"url(")?this.Url():this.Function(this.readSequence,e.recognizer);case 7:return this.Url();case 1:return this.cmpChar(this.tokenStart,Cm)&&this.cmpChar(this.tokenStart+1,fu)?this.UnicodeRange():this.Identifier();case 9:{let t=this.charCodeAt(this.tokenStart);if(t===wm||t===km||t===fu||t===Sm)return this.Operator();t===vm&&this.error("Hex or identifier is expected",this.tokenStart+1);break}}}var mu={getNode:Pi};var Em=35,Am=38,Tm=42,_m=43,Im=47,gu=46,Lm=62,$m=124,Pm=126;function Nm(e,t){t.last!==null&&t.last.type!=="Combinator"&&e!==null&&e.type!=="Combinator"&&t.push({type:"Combinator",loc:null,name:" "})}function Rm(){switch(this.tokenType){case 19:return this.AttributeSelector();case 4:return this.IdSelector();case 16:return this.lookupType(1)===16?this.PseudoElementSelector():this.PseudoClassSelector();case 1:return this.TypeSelector();case 10:case 11:return this.Percentage();case 12:this.charCodeAt(this.tokenStart)===gu&&this.error("Identifier is expected",this.tokenStart+1);break;case 9:{switch(this.charCodeAt(this.tokenStart)){case _m:case Lm:case Pm:case Im:return this.Combinator();case gu:return this.ClassSelector();case Tm:case $m:return this.TypeSelector();case Em:return this.IdSelector();case Am:return this.NestingSelector()}break}}}var bu={onWhiteSpace:Nm,getNode:Rm};function xu(){return this.createSingleNodeList(this.Raw(null,!1))}function yu(){let e=this.createList();if(this.skipSC(),e.push(this.Identifier()),this.skipSC(),this.tokenType===18){e.push(this.Operator());let t=this.tokenIndex,i=this.parseCustomProperty?this.Value(null):this.Raw(this.consumeUntilExclamationMarkOrSemicolon,!1);if(i.type==="Value"&&i.children.isEmpty){for(let n=t-this.tokenIndex;n<=0;n++)if(this.lookupType(n)===13){i.children.appendData({type:"WhiteSpace",loc:null,value:" "});break}}e.push(i)}return e}function vu(e){return e!==null&&e.type==="Operator"&&(e.value[e.value.length-1]==="-"||e.value[e.value.length-1]==="+")}var ku={getNode:Pi,onWhiteSpace(e,t){vu(e)&&(e.value=" "+e.value),vu(t.last)&&(t.last.value+=" ")},expression:xu,var:yu};var Fm=new Set(["none","and","not","or"]),Su={parse:{prelude(){let e=this.createList();if(this.tokenType===1){let t=this.substring(this.tokenStart,this.tokenEnd);Fm.has(t.toLowerCase())||e.push(this.Identifier())}return e.push(this.Condition("container")),e},block(e=!1){return this.Block(e)}}};var wu={parse:{prelude:null,block(){return this.Block(!0)}}};function Gn(e,t){return this.parseWithFallback(()=>{try{return e.call(this)}finally{this.skipSC(),this.lookupNonWSType(0)!==22&&this.error()}},t||(()=>this.Raw(null,!0)))}var Cu={layer(){this.skipSC();let e=this.createList(),t=Gn.call(this,this.Layer);return(t.type!=="Raw"||t.value!=="")&&e.push(t),e},supports(){this.skipSC();let e=this.createList(),t=Gn.call(this,this.Declaration,()=>Gn.call(this,()=>this.Condition("supports")));return(t.type!=="Raw"||t.value!=="")&&e.push(t),e}},Eu={parse:{prelude(){let e=this.createList();switch(this.tokenType){case 5:e.push(this.String());break;case 7:case 2:e.push(this.Url());break;default:this.error("String or url() is expected")}return this.skipSC(),this.tokenType===1&&this.cmpStr(this.tokenStart,this.tokenEnd,"layer")?e.push(this.Identifier()):this.tokenType===2&&this.cmpStr(this.tokenStart,this.tokenEnd,"layer(")&&e.push(this.Function(null,Cu)),this.skipSC(),this.tokenType===2&&this.cmpStr(this.tokenStart,this.tokenEnd,"supports(")&&e.push(this.Function(null,Cu)),(this.lookupNonWSType(0)===1||this.lookupNonWSType(0)===21)&&e.push(this.MediaQueryList()),e},block:null}};var Au={parse:{prelude(){return this.createSingleNodeList(this.LayerList())},block(){return this.Block(!1)}}};var Tu={parse:{prelude(){return this.createSingleNodeList(this.MediaQueryList())},block(e=!1){return this.Block(e)}}};var _u={parse:{prelude(){return this.createSingleNodeList(this.SelectorList())},block(){return this.Block(!0)}}};var Iu={parse:{prelude(){return this.createSingleNodeList(this.SelectorList())},block(){return this.Block(!0)}}};var Lu={parse:{prelude(){return this.createSingleNodeList(this.Scope())},block(e=!1){return this.Block(e)}}};var $u={parse:{prelude:null,block(e=!1){return this.Block(e)}}};var Pu={parse:{prelude(){return this.createSingleNodeList(this.Condition("supports"))},block(e=!1){return this.Block(e)}}};var Nu={container:Su,"font-face":wu,import:Eu,layer:Au,media:Tu,nest:_u,page:Iu,scope:Lu,"starting-style":$u,supports:Pu};function Ru(){let e=this.createList();this.skipSC();e:for(;!this.eof;){switch(this.tokenType){case 1:e.push(this.Identifier());break;case 5:e.push(this.String());break;case 18:e.push(this.Operator());break;case 22:break e;default:this.error("Identifier, string or comma is expected")}this.skipSC()}return e}var Pt={parse(){return this.createSingleNodeList(this.SelectorList())}},qn={parse(){return this.createSingleNodeList(this.Selector())}},Mm={parse(){return this.createSingleNodeList(this.Identifier())}},Om={parse:Ru},Fr={parse(){return this.createSingleNodeList(this.Nth())}},Fu={dir:Mm,has:Pt,lang:Om,matches:Pt,is:Pt,"-moz-any":Pt,"-webkit-any":Pt,where:Pt,not:Pt,"nth-child":Fr,"nth-last-child":Fr,"nth-last-of-type":Fr,"nth-of-type":Fr,slotted:qn,host:qn,"host-context":qn};var Uo={};N(Uo,{AnPlusB:()=>Yn,Atrule:()=>Jn,AtrulePrelude:()=>ta,AttributeSelector:()=>aa,Block:()=>la,Brackets:()=>pa,CDC:()=>fa,CDO:()=>ba,ClassSelector:()=>va,Combinator:()=>wa,Comment:()=>Aa,Condition:()=>Ia,Declaration:()=>Pa,DeclarationList:()=>Ma,Dimension:()=>Va,Feature:()=>Ua,FeatureFunction:()=>Wa,FeatureRange:()=>Ya,Function:()=>Ja,GeneralEnclosed:()=>ts,Hash:()=>ns,IdSelector:()=>us,Identifier:()=>os,Layer:()=>ds,LayerList:()=>gs,MediaQuery:()=>ys,MediaQueryList:()=>Ss,NestingSelector:()=>Es,Nth:()=>_s,Number:()=>$s,Operator:()=>Rs,Parentheses:()=>Os,Percentage:()=>Bs,PseudoClassSelector:()=>Hs,PseudoElementSelector:()=>Gs,Ratio:()=>Ys,Raw:()=>Js,Rule:()=>to,Scope:()=>no,Selector:()=>oo,SelectorList:()=>uo,String:()=>mo,StyleSheet:()=>xo,SupportsDeclaration:()=>ko,TypeSelector:()=>Eo,UnicodeRange:()=>Io,Url:()=>No,Value:()=>Mo,WhiteSpace:()=>Vo});var Zn={};N(Zn,{generate:()=>Qn,name:()=>Vm,parse:()=>Yn,structure:()=>Bm});var st=43,$e=45,Mr=110,Nt=!0,Dm=!1;function Or(e,t){let i=this.tokenStart+e,n=this.charCodeAt(i);for((n===st||n===$e)&&(t&&this.error("Number sign is not allowed"),i++);i<this.tokenEnd;i++)ye(this.charCodeAt(i))||this.error("Integer is expected",i)}function ti(e){return Or.call(this,0,e)}function wt(e,t){if(!this.cmpChar(this.tokenStart+e,t)){let i="";switch(t){case Mr:i="N is expected";break;case $e:i="HyphenMinus is expected";break}this.error(i,this.tokenStart+e)}}function Kn(){let e=0,t=0,i=this.tokenType;for(;i===13||i===25;)i=this.lookupType(++e);if(i!==10)if(this.isDelim(st,e)||this.isDelim($e,e)){t=this.isDelim(st,e)?st:$e;do i=this.lookupType(++e);while(i===13||i===25);i!==10&&(this.skip(e),ti.call(this,Nt))}else return null;return e>0&&this.skip(e),t===0&&(i=this.charCodeAt(this.tokenStart),i!==st&&i!==$e&&this.error("Number sign is expected")),ti.call(this,t!==0),t===$e?"-"+this.consume(10):this.consume(10)}var Vm="AnPlusB",Bm={a:[String,null],b:[String,null]};function Yn(){let e=this.tokenStart,t=null,i=null;if(this.tokenType===10)ti.call(this,Dm),i=this.consume(10);else if(this.tokenType===1&&this.cmpChar(this.tokenStart,$e))switch(t="-1",wt.call(this,1,Mr),this.tokenEnd-this.tokenStart){case 2:this.next(),i=Kn.call(this);break;case 3:wt.call(this,2,$e),this.next(),this.skipSC(),ti.call(this,Nt),i="-"+this.consume(10);break;default:wt.call(this,2,$e),Or.call(this,3,Nt),this.next(),i=this.substrToCursor(e+2)}else if(this.tokenType===1||this.isDelim(st)&&this.lookupType(1)===1){let n=0;switch(t="1",this.isDelim(st)&&(n=1,this.next()),wt.call(this,0,Mr),this.tokenEnd-this.tokenStart){case 1:this.next(),i=Kn.call(this);break;case 2:wt.call(this,1,$e),this.next(),this.skipSC(),ti.call(this,Nt),i="-"+this.consume(10);break;default:wt.call(this,1,$e),Or.call(this,2,Nt),this.next(),i=this.substrToCursor(e+n+1)}}else if(this.tokenType===12){let n=this.charCodeAt(this.tokenStart),l=n===st||n===$e,p=this.tokenStart+l;for(;p<this.tokenEnd&&ye(this.charCodeAt(p));p++);p===this.tokenStart+l&&this.error("Integer is expected",this.tokenStart+l),wt.call(this,p-this.tokenStart,Mr),t=this.substring(e,p),p+1===this.tokenEnd?(this.next(),i=Kn.call(this)):(wt.call(this,p-this.tokenStart+1,$e),p+2===this.tokenEnd?(this.next(),this.skipSC(),ti.call(this,Nt),i="-"+this.consume(10)):(Or.call(this,p-this.tokenStart+2,Nt),this.next(),i=this.substrToCursor(p+1)))}else this.error();return t!==null&&t.charCodeAt(0)===st&&(t=t.substr(1)),i!==null&&i.charCodeAt(0)===st&&(i=i.substr(1)),{type:"AnPlusB",loc:this.getLocation(e,this.tokenStart),a:t,b:i}}function Qn(e){if(e.a){let t=e.a==="+1"&&"n"||e.a==="1"&&"n"||e.a==="-1"&&"-n"||e.a+"n";if(e.b){let i=e.b[0]==="-"||e.b[0]==="+"?e.b:"+"+e.b;this.tokenize(t+i)}else this.tokenize(t)}else this.tokenize(e.b)}var ea={};N(ea,{generate:()=>Xn,name:()=>Um,parse:()=>Jn,structure:()=>zm,walkContext:()=>Hm});function Mu(){return this.Raw(this.consumeUntilLeftCurlyBracketOrSemicolon,!0)}function jm(){for(let e=1,t;t=this.lookupType(e);e++){if(t===24)return!0;if(t===23||t===3)return!1}return!1}var Um="Atrule",Hm="atrule",zm={name:String,prelude:["AtrulePrelude","Raw",null],block:["Block",null]};function Jn(e=!1){let t=this.tokenStart,i,n,l=null,p=null;switch(this.eat(3),i=this.substrToCursor(t+1),n=i.toLowerCase(),this.skipSC(),this.eof===!1&&this.tokenType!==23&&this.tokenType!==17&&(this.parseAtrulePrelude?l=this.parseWithFallback(this.AtrulePrelude.bind(this,i,e),Mu):l=Mu.call(this,this.tokenIndex),this.skipSC()),this.tokenType){case 17:this.next();break;case 23:hasOwnProperty.call(this.atrule,n)&&typeof this.atrule[n].block=="function"?p=this.atrule[n].block.call(this,e):p=this.Block(jm.call(this));break}return{type:"Atrule",loc:this.getLocation(t,this.tokenStart),name:i,prelude:l,block:p}}function Xn(e){this.token(3,"@"+e.name),e.prelude!==null&&this.node(e.prelude),e.block?this.node(e.block):this.token(17,";")}var ra={};N(ra,{generate:()=>ia,name:()=>Wm,parse:()=>ta,structure:()=>qm,walkContext:()=>Gm});var Wm="AtrulePrelude",Gm="atrulePrelude",qm={children:[[]]};function ta(e){let t=null;return e!==null&&(e=e.toLowerCase()),this.skipSC(),hasOwnProperty.call(this.atrule,e)&&typeof this.atrule[e].prelude=="function"?t=this.atrule[e].prelude.call(this):t=this.readSequence(this.scope.AtrulePrelude),this.skipSC(),this.eof!==!0&&this.tokenType!==23&&this.tokenType!==17&&this.error("Semicolon or block is expected"),{type:"AtrulePrelude",loc:this.getLocationFromList(t),children:t}}function ia(e){this.children(e)}var oa={};N(oa,{generate:()=>sa,name:()=>Xm,parse:()=>aa,structure:()=>eg});var Km=36,Ou=42,Dr=61,Ym=94,na=124,Qm=126;function Zm(){this.eof&&this.error("Unexpected end of input");let e=this.tokenStart,t=!1;return this.isDelim(Ou)?(t=!0,this.next()):this.isDelim(na)||this.eat(1),this.isDelim(na)?this.charCodeAt(this.tokenStart+1)!==Dr?(this.next(),this.eat(1)):t&&this.error("Identifier is expected",this.tokenEnd):t&&this.error("Vertical line is expected"),{type:"Identifier",loc:this.getLocation(e,this.tokenStart),name:this.substrToCursor(e)}}function Jm(){let e=this.tokenStart,t=this.charCodeAt(e);return t!==Dr&&t!==Qm&&t!==Ym&&t!==Km&&t!==Ou&&t!==na&&this.error("Attribute selector (=, ~=, ^=, $=, *=, |=) is expected"),this.next(),t!==Dr&&(this.isDelim(Dr)||this.error("Equal sign is expected"),this.next()),this.substrToCursor(e)}var Xm="AttributeSelector",eg={name:"Identifier",matcher:[String,null],value:["String","Identifier",null],flags:[String,null]};function aa(){let e=this.tokenStart,t,i=null,n=null,l=null;return this.eat(19),this.skipSC(),t=Zm.call(this),this.skipSC(),this.tokenType!==20&&(this.tokenType!==1&&(i=Jm.call(this),this.skipSC(),n=this.tokenType===5?this.String():this.Identifier(),this.skipSC()),this.tokenType===1&&(l=this.consume(1),this.skipSC())),this.eat(20),{type:"AttributeSelector",loc:this.getLocation(e,this.tokenStart),name:t,matcher:i,value:n,flags:l}}function sa(e){this.token(9,"["),this.node(e.name),e.matcher!==null&&(this.tokenize(e.matcher),this.node(e.value)),e.flags!==null&&this.token(1,e.flags),this.token(9,"]")}var ua={};N(ua,{generate:()=>ca,name:()=>rg,parse:()=>la,structure:()=>ag,walkContext:()=>ng});var tg=38;function Bu(){return this.Raw(null,!0)}function Du(){return this.parseWithFallback(this.Rule,Bu)}function Vu(){return this.Raw(this.consumeUntilSemicolonIncluded,!0)}function ig(){if(this.tokenType===17)return Vu.call(this,this.tokenIndex);let e=this.parseWithFallback(this.Declaration,Vu);return this.tokenType===17&&this.next(),e}var rg="Block",ng="block",ag={children:[["Atrule","Rule","Declaration"]]};function la(e){let t=e?ig:Du,i=this.tokenStart,n=this.createList();this.eat(23);e:for(;!this.eof;)switch(this.tokenType){case 24:break e;case 13:case 25:this.next();break;case 3:n.push(this.parseWithFallback(this.Atrule.bind(this,e),Bu));break;default:e&&this.isDelim(tg)?n.push(Du.call(this)):n.push(t.call(this))}return this.eof||this.eat(24),{type:"Block",loc:this.getLocation(i,this.tokenStart),children:n}}function ca(e){this.token(23,"{"),this.children(e,t=>{t.type==="Declaration"&&this.token(17,";")}),this.token(24,"}")}var da={};N(da,{generate:()=>ha,name:()=>sg,parse:()=>pa,structure:()=>og});var sg="Brackets",og={children:[[]]};function pa(e,t){let i=this.tokenStart,n=null;return this.eat(19),n=e.call(this,t),this.eof||this.eat(20),{type:"Brackets",loc:this.getLocation(i,this.tokenStart),children:n}}function ha(e){this.token(9,"["),this.children(e),this.token(9,"]")}var ga={};N(ga,{generate:()=>ma,name:()=>lg,parse:()=>fa,structure:()=>cg});var lg="CDC",cg=[];function fa(){let e=this.tokenStart;return this.eat(15),{type:"CDC",loc:this.getLocation(e,this.tokenStart)}}function ma(){this.token(15,"-->")}var ya={};N(ya,{generate:()=>xa,name:()=>ug,parse:()=>ba,structure:()=>pg});var ug="CDO",pg=[];function ba(){let e=this.tokenStart;return this.eat(14),{type:"CDO",loc:this.getLocation(e,this.tokenStart)}}function xa(){this.token(14,"<!--")}var Sa={};N(Sa,{generate:()=>ka,name:()=>dg,parse:()=>va,structure:()=>fg});var hg=46,dg="ClassSelector",fg={name:String};function va(){return this.eatDelim(hg),{type:"ClassSelector",loc:this.getLocation(this.tokenStart-1,this.tokenEnd),name:this.consume(1)}}function ka(e){this.token(9,"."),this.token(1,e.name)}var Ea={};N(Ea,{generate:()=>Ca,name:()=>xg,parse:()=>wa,structure:()=>yg});var mg=43,ju=47,gg=62,bg=126,xg="Combinator",yg={name:String};function wa(){let e=this.tokenStart,t;switch(this.tokenType){case 13:t=" ";break;case 9:switch(this.charCodeAt(this.tokenStart)){case gg:case mg:case bg:this.next();break;case ju:this.next(),this.eatIdent("deep"),this.eatDelim(ju);break;default:this.error("Combinator is expected")}t=this.substrToCursor(e);break}return{type:"Combinator",loc:this.getLocation(e,this.tokenStart),name:t}}function Ca(e){this.tokenize(e.name)}var _a={};N(_a,{generate:()=>Ta,name:()=>Sg,parse:()=>Aa,structure:()=>wg});var vg=42,kg=47,Sg="Comment",wg={value:String};function Aa(){let e=this.tokenStart,t=this.tokenEnd;return this.eat(25),t-e+2>=2&&this.charCodeAt(t-2)===vg&&this.charCodeAt(t-1)===kg&&(t-=2),{type:"Comment",loc:this.getLocation(e,this.tokenStart),value:this.substring(e+2,t)}}function Ta(e){this.token(25,"/*"+e.value+"*/")}var $a={};N($a,{generate:()=>La,name:()=>Eg,parse:()=>Ia,structure:()=>Ag});var Cg=new Set([16,22,0]),Eg="Condition",Ag={kind:String,children:[["Identifier","Feature","FeatureFunction","FeatureRange","SupportsDeclaration"]]};function Uu(e){return this.lookupTypeNonSC(1)===1&&Cg.has(this.lookupTypeNonSC(2))?this.Feature(e):this.FeatureRange(e)}var Tg={media:Uu,container:Uu,supports(){return this.SupportsDeclaration()}};function Ia(e="media"){let t=this.createList();e:for(;!this.eof;)switch(this.tokenType){case 25:case 13:this.next();continue;case 1:t.push(this.Identifier());break;case 21:{let i=this.parseWithFallback(()=>Tg[e].call(this,e),()=>null);i||(i=this.parseWithFallback(()=>{this.eat(21);let n=this.Condition(e);return this.eat(22),n},()=>this.GeneralEnclosed(e))),t.push(i);break}case 2:{let i=this.parseWithFallback(()=>this.FeatureFunction(e),()=>null);i||(i=this.GeneralEnclosed(e)),t.push(i);break}default:break e}return t.isEmpty&&this.error("Condition is expected"),{type:"Condition",loc:this.getLocationFromList(t),kind:e,children:t}}function La(e){e.children.forEach(t=>{t.type==="Condition"?(this.token(21,"("),this.node(t),this.token(22,")")):this.node(t)})}var Ra={};N(Ra,{generate:()=>Na,name:()=>Mg,parse:()=>Pa,structure:()=>Dg,walkContext:()=>Og});var Hu=45;function zu(e,t){return t=t||0,e.length-t>=2&&e.charCodeAt(t)===Hu&&e.charCodeAt(t+1)===Hu}var Gu=33,_g=35,Ig=36,Lg=38,$g=42,Pg=43,Wu=47;function Ng(){return this.Raw(this.consumeUntilExclamationMarkOrSemicolon,!0)}function Rg(){return this.Raw(this.consumeUntilExclamationMarkOrSemicolon,!1)}function Fg(){let e=this.tokenIndex,t=this.Value();return t.type!=="Raw"&&this.eof===!1&&this.tokenType!==17&&this.isDelim(Gu)===!1&&this.isBalanceEdge(e)===!1&&this.error(),t}var Mg="Declaration",Og="declaration",Dg={important:[Boolean,String],property:String,value:["Value","Raw"]};function Pa(){let e=this.tokenStart,t=this.tokenIndex,i=Vg.call(this),n=zu(i),l=n?this.parseCustomProperty:this.parseValue,p=n?Rg:Ng,d=!1,g;this.skipSC(),this.eat(16);let x=this.tokenIndex;if(n||this.skipSC(),l?g=this.parseWithFallback(Fg,p):g=p.call(this,this.tokenIndex),n&&g.type==="Value"&&g.children.isEmpty){for(let b=x-this.tokenIndex;b<=0;b++)if(this.lookupType(b)===13){g.children.appendData({type:"WhiteSpace",loc:null,value:" "});break}}return this.isDelim(Gu)&&(d=Bg.call(this),this.skipSC()),this.eof===!1&&this.tokenType!==17&&this.isBalanceEdge(t)===!1&&this.error(),{type:"Declaration",loc:this.getLocation(e,this.tokenStart),important:d,property:i,value:g}}function Na(e){this.token(1,e.property),this.token(16,":"),this.node(e.value),e.important&&(this.token(9,"!"),this.token(1,e.important===!0?"important":e.important))}function Vg(){let e=this.tokenStart;if(this.tokenType===9)switch(this.charCodeAt(this.tokenStart)){case $g:case Ig:case Pg:case _g:case Lg:this.next();break;case Wu:this.next(),this.isDelim(Wu)&&this.next();break}return this.tokenType===4?this.eat(4):this.eat(1),this.substrToCursor(e)}function Bg(){this.eat(9),this.skipSC();let e=this.consume(1);return e==="important"?!0:e}var Da={};N(Da,{generate:()=>Oa,name:()=>Ug,parse:()=>Ma,structure:()=>Hg});var jg=38;function Fa(){return this.Raw(this.consumeUntilSemicolonIncluded,!0)}var Ug="DeclarationList",Hg={children:[["Declaration","Atrule","Rule"]]};function Ma(){let e=this.createList();for(;!this.eof;)switch(this.tokenType){case 13:case 25:case 17:this.next();break;case 3:e.push(this.parseWithFallback(this.Atrule.bind(this,!0),Fa));break;default:this.isDelim(jg)?e.push(this.parseWithFallback(this.Rule,Fa)):e.push(this.parseWithFallback(this.Declaration,Fa))}return{type:"DeclarationList",loc:this.getLocationFromList(e),children:e}}function Oa(e){this.children(e,t=>{t.type==="Declaration"&&this.token(17,";")})}var ja={};N(ja,{generate:()=>Ba,name:()=>zg,parse:()=>Va,structure:()=>Wg});var zg="Dimension",Wg={value:String,unit:String};function Va(){let e=this.tokenStart,t=this.consumeNumber(12);return{type:"Dimension",loc:this.getLocation(e,this.tokenStart),value:t,unit:this.substring(e+t.length,this.tokenStart)}}function Ba(e){this.token(12,e.value+e.unit)}var za={};N(za,{generate:()=>Ha,name:()=>qg,parse:()=>Ua,structure:()=>Kg});var Gg=47,qg="Feature",Kg={kind:String,name:String,value:["Identifier","Number","Dimension","Ratio","Function",null]};function Ua(e){let t=this.tokenStart,i,n=null;if(this.eat(21),this.skipSC(),i=this.consume(1),this.skipSC(),this.tokenType!==22){switch(this.eat(16),this.skipSC(),this.tokenType){case 10:this.lookupNonWSType(1)===9?n=this.Ratio():n=this.Number();break;case 12:n=this.Dimension();break;case 1:n=this.Identifier();break;case 2:n=this.parseWithFallback(()=>{let l=this.Function(this.readSequence,this.scope.Value);return this.skipSC(),this.isDelim(Gg)&&this.error(),l},()=>this.Ratio());break;default:this.error("Number, dimension, ratio or identifier is expected")}this.skipSC()}return this.eof||this.eat(22),{type:"Feature",loc:this.getLocation(t,this.tokenStart),kind:e,name:i,value:n}}function Ha(e){this.token(21,"("),this.token(1,e.name),e.value!==null&&(this.token(16,":"),this.node(e.value)),this.token(22,")")}var qa={};N(qa,{generate:()=>Ga,name:()=>Yg,parse:()=>Wa,structure:()=>Qg});var Yg="FeatureFunction",Qg={kind:String,feature:String,value:["Declaration","Selector"]};function Zg(e,t){let n=(this.features[e]||{})[t];return typeof n!="function"&&this.error(`Unknown feature ${t}()`),n}function Wa(e="unknown"){let t=this.tokenStart,i=this.consumeFunctionName(),n=Zg.call(this,e,i.toLowerCase());this.skipSC();let l=this.parseWithFallback(()=>{let p=this.tokenIndex,d=n.call(this);return this.eof===!1&&this.isBalanceEdge(p)===!1&&this.error(),d},()=>this.Raw(null,!1));return this.eof||this.eat(22),{type:"FeatureFunction",loc:this.getLocation(t,this.tokenStart),kind:e,feature:i,value:l}}function Ga(e){this.token(2,e.feature+"("),this.node(e.value),this.token(22,")")}var Za={};N(Za,{generate:()=>Qa,name:()=>e0,parse:()=>Ya,structure:()=>t0});var qu=47,Jg=60,Ku=61,Xg=62,e0="FeatureRange",t0={kind:String,left:["Identifier","Number","Dimension","Ratio","Function"],leftComparison:String,middle:["Identifier","Number","Dimension","Ratio","Function"],rightComparison:[String,null],right:["Identifier","Number","Dimension","Ratio","Function",null]};function Ka(){switch(this.skipSC(),this.tokenType){case 10:return this.isDelim(qu,this.lookupOffsetNonSC(1))?this.Ratio():this.Number();case 12:return this.Dimension();case 1:return this.Identifier();case 2:return this.parseWithFallback(()=>{let e=this.Function(this.readSequence,this.scope.Value);return this.skipSC(),this.isDelim(qu)&&this.error(),e},()=>this.Ratio());default:this.error("Number, dimension, ratio or identifier is expected")}}function Yu(e){if(this.skipSC(),this.isDelim(Jg)||this.isDelim(Xg)){let t=this.source[this.tokenStart];return this.next(),this.isDelim(Ku)?(this.next(),t+"="):t}if(this.isDelim(Ku))return"=";this.error(`Expected ${e?'":", ':""}"<", ">", "=" or ")"`)}function Ya(e="unknown"){let t=this.tokenStart;this.skipSC(),this.eat(21);let i=Ka.call(this),n=Yu.call(this,i.type==="Identifier"),l=Ka.call(this),p=null,d=null;return this.lookupNonWSType(0)!==22&&(p=Yu.call(this),d=Ka.call(this)),this.skipSC(),this.eat(22),{type:"FeatureRange",loc:this.getLocation(t,this.tokenStart),kind:e,left:i,leftComparison:n,middle:l,rightComparison:p,right:d}}function Qa(e){this.token(21,"("),this.node(e.left),this.tokenize(e.leftComparison),this.node(e.middle),e.right&&(this.tokenize(e.rightComparison),this.node(e.right)),this.token(22,")")}var es={};N(es,{generate:()=>Xa,name:()=>i0,parse:()=>Ja,structure:()=>n0,walkContext:()=>r0});var i0="Function",r0="function",n0={name:String,children:[[]]};function Ja(e,t){let i=this.tokenStart,n=this.consumeFunctionName(),l=n.toLowerCase(),p;return p=t.hasOwnProperty(l)?t[l].call(this,t):e.call(this,t),this.eof||this.eat(22),{type:"Function",loc:this.getLocation(i,this.tokenStart),name:n,children:p}}function Xa(e){this.token(2,e.name+"("),this.children(e),this.token(22,")")}var rs={};N(rs,{generate:()=>is,name:()=>a0,parse:()=>ts,structure:()=>s0});var a0="GeneralEnclosed",s0={kind:String,function:[String,null],children:[[]]};function ts(e){let t=this.tokenStart,i=null;this.tokenType===2?i=this.consumeFunctionName():this.eat(21);let n=this.parseWithFallback(()=>{let l=this.tokenIndex,p=this.readSequence(this.scope.Value);return this.eof===!1&&this.isBalanceEdge(l)===!1&&this.error(),p},()=>this.createSingleNodeList(this.Raw(null,!1)));return this.eof||this.eat(22),{type:"GeneralEnclosed",loc:this.getLocation(t,this.tokenStart),kind:e,function:i,children:n}}function is(e){e.function?this.token(2,e.function+"("):this.token(21,"("),this.children(e),this.token(22,")")}var ss={};N(ss,{generate:()=>as,name:()=>l0,parse:()=>ns,structure:()=>c0,xxx:()=>o0});var o0="XXX",l0="Hash",c0={value:String};function ns(){let e=this.tokenStart;return this.eat(4),{type:"Hash",loc:this.getLocation(e,this.tokenStart),value:this.substrToCursor(e+1)}}function as(e){this.token(4,"#"+e.value)}var cs={};N(cs,{generate:()=>ls,name:()=>u0,parse:()=>os,structure:()=>p0});var u0="Identifier",p0={name:String};function os(){return{type:"Identifier",loc:this.getLocation(this.tokenStart,this.tokenEnd),name:this.consume(1)}}function ls(e){this.token(1,e.name)}var hs={};N(hs,{generate:()=>ps,name:()=>h0,parse:()=>us,structure:()=>d0});var h0="IdSelector",d0={name:String};function us(){let e=this.tokenStart;return this.eat(4),{type:"IdSelector",loc:this.getLocation(e,this.tokenStart),name:this.substrToCursor(e+1)}}function ps(e){this.token(9,"#"+e.name)}var ms={};N(ms,{generate:()=>fs,name:()=>m0,parse:()=>ds,structure:()=>g0});var f0=46,m0="Layer",g0={name:String};function ds(){let e=this.tokenStart,t=this.consume(1);for(;this.isDelim(f0);)this.eat(9),t+="."+this.consume(1);return{type:"Layer",loc:this.getLocation(e,this.tokenStart),name:t}}function fs(e){this.tokenize(e.name)}var xs={};N(xs,{generate:()=>bs,name:()=>b0,parse:()=>gs,structure:()=>x0});var b0="LayerList",x0={children:[["Layer"]]};function gs(){let e=this.createList();for(this.skipSC();!this.eof&&(e.push(this.Layer()),this.lookupTypeNonSC(0)===18);)this.skipSC(),this.next(),this.skipSC();return{type:"LayerList",loc:this.getLocationFromList(e),children:e}}function bs(e){this.children(e,()=>this.token(18,","))}var ks={};N(ks,{generate:()=>vs,name:()=>y0,parse:()=>ys,structure:()=>v0});var y0="MediaQuery",v0={modifier:[String,null],mediaType:[String,null],condition:["Condition",null]};function ys(){let e=this.tokenStart,t=null,i=null,n=null;if(this.skipSC(),this.tokenType===1&&this.lookupTypeNonSC(1)!==21){let l=this.consume(1),p=l.toLowerCase();switch(p==="not"||p==="only"?(this.skipSC(),t=p,i=this.consume(1)):i=l,this.lookupTypeNonSC(0)){case 1:{this.skipSC(),this.eatIdent("and"),n=this.Condition("media");break}case 23:case 17:case 18:case 0:break;default:this.error("Identifier or parenthesis is expected")}}else switch(this.tokenType){case 1:case 21:case 2:{n=this.Condition("media");break}case 23:case 17:case 0:break;default:this.error("Identifier or parenthesis is expected")}return{type:"MediaQuery",loc:this.getLocation(e,this.tokenStart),modifier:t,mediaType:i,condition:n}}function vs(e){e.mediaType?(e.modifier&&this.token(1,e.modifier),this.token(1,e.mediaType),e.condition&&(this.token(1,"and"),this.node(e.condition))):e.condition&&this.node(e.condition)}var Cs={};N(Cs,{generate:()=>ws,name:()=>k0,parse:()=>Ss,structure:()=>S0});var k0="MediaQueryList",S0={children:[["MediaQuery"]]};function Ss(){let e=this.createList();for(this.skipSC();!this.eof&&(e.push(this.MediaQuery()),this.tokenType===18);)this.next();return{type:"MediaQueryList",loc:this.getLocationFromList(e),children:e}}function ws(e){this.children(e,()=>this.token(18,","))}var Ts={};N(Ts,{generate:()=>As,name:()=>C0,parse:()=>Es,structure:()=>E0});var w0=38,C0="NestingSelector",E0={};function Es(){let e=this.tokenStart;return this.eatDelim(w0),{type:"NestingSelector",loc:this.getLocation(e,this.tokenStart)}}function As(){this.token(9,"&")}var Ls={};N(Ls,{generate:()=>Is,name:()=>A0,parse:()=>_s,structure:()=>T0});var A0="Nth",T0={nth:["AnPlusB","Identifier"],selector:["SelectorList",null]};function _s(){this.skipSC();let e=this.tokenStart,t=e,i=null,n;return this.lookupValue(0,"odd")||this.lookupValue(0,"even")?n=this.Identifier():n=this.AnPlusB(),t=this.tokenStart,this.skipSC(),this.lookupValue(0,"of")&&(this.next(),i=this.SelectorList(),t=this.tokenStart),{type:"Nth",loc:this.getLocation(e,t),nth:n,selector:i}}function Is(e){this.node(e.nth),e.selector!==null&&(this.token(1,"of"),this.node(e.selector))}var Ns={};N(Ns,{generate:()=>Ps,name:()=>_0,parse:()=>$s,structure:()=>I0});var _0="Number",I0={value:String};function $s(){return{type:"Number",loc:this.getLocation(this.tokenStart,this.tokenEnd),value:this.consume(10)}}function Ps(e){this.token(10,e.value)}var Ms={};N(Ms,{generate:()=>Fs,name:()=>L0,parse:()=>Rs,structure:()=>$0});var L0="Operator",$0={value:String};function Rs(){let e=this.tokenStart;return this.next(),{type:"Operator",loc:this.getLocation(e,this.tokenStart),value:this.substrToCursor(e)}}function Fs(e){this.tokenize(e.value)}var Vs={};N(Vs,{generate:()=>Ds,name:()=>P0,parse:()=>Os,structure:()=>N0});var P0="Parentheses",N0={children:[[]]};function Os(e,t){let i=this.tokenStart,n=null;return this.eat(21),n=e.call(this,t),this.eof||this.eat(22),{type:"Parentheses",loc:this.getLocation(i,this.tokenStart),children:n}}function Ds(e){this.token(21,"("),this.children(e),this.token(22,")")}var Us={};N(Us,{generate:()=>js,name:()=>R0,parse:()=>Bs,structure:()=>F0});var R0="Percentage",F0={value:String};function Bs(){return{type:"Percentage",loc:this.getLocation(this.tokenStart,this.tokenEnd),value:this.consumeNumber(11)}}function js(e){this.token(11,e.value+"%")}var Ws={};N(Ws,{generate:()=>zs,name:()=>M0,parse:()=>Hs,structure:()=>D0,walkContext:()=>O0});var M0="PseudoClassSelector",O0="function",D0={name:String,children:[["Raw"],null]};function Hs(){let e=this.tokenStart,t=null,i,n;return this.eat(16),this.tokenType===2?(i=this.consumeFunctionName(),n=i.toLowerCase(),this.lookupNonWSType(0)==22?t=this.createList():hasOwnProperty.call(this.pseudo,n)?(this.skipSC(),t=this.pseudo[n].call(this),this.skipSC()):(t=this.createList(),t.push(this.Raw(null,!1))),this.eat(22)):i=this.consume(1),{type:"PseudoClassSelector",loc:this.getLocation(e,this.tokenStart),name:i,children:t}}function zs(e){this.token(16,":"),e.children===null?this.token(1,e.name):(this.token(2,e.name+"("),this.children(e),this.token(22,")"))}var Ks={};N(Ks,{generate:()=>qs,name:()=>V0,parse:()=>Gs,structure:()=>j0,walkContext:()=>B0});var V0="PseudoElementSelector",B0="function",j0={name:String,children:[["Raw"],null]};function Gs(){let e=this.tokenStart,t=null,i,n;return this.eat(16),this.eat(16),this.tokenType===2?(i=this.consumeFunctionName(),n=i.toLowerCase(),this.lookupNonWSType(0)==22?t=this.createList():hasOwnProperty.call(this.pseudo,n)?(this.skipSC(),t=this.pseudo[n].call(this),this.skipSC()):(t=this.createList(),t.push(this.Raw(null,!1))),this.eat(22)):i=this.consume(1),{type:"PseudoElementSelector",loc:this.getLocation(e,this.tokenStart),name:i,children:t}}function qs(e){this.token(16,":"),this.token(16,":"),e.children===null?this.token(1,e.name):(this.token(2,e.name+"("),this.children(e),this.token(22,")"))}var Zs={};N(Zs,{generate:()=>Qs,name:()=>U0,parse:()=>Ys,structure:()=>H0});var Qu=47;function Zu(){switch(this.skipSC(),this.tokenType){case 10:return this.Number();case 2:return this.Function(this.readSequence,this.scope.Value);default:this.error("Number of function is expected")}}var U0="Ratio",H0={left:["Number","Function"],right:["Number","Function",null]};function Ys(){let e=this.tokenStart,t=Zu.call(this),i=null;return this.skipSC(),this.isDelim(Qu)&&(this.eatDelim(Qu),i=Zu.call(this)),{type:"Ratio",loc:this.getLocation(e,this.tokenStart),left:t,right:i}}function Qs(e){this.node(e.left),this.token(9,"/"),e.right?this.node(e.right):this.node(10,1)}var eo={};N(eo,{generate:()=>Xs,name:()=>W0,parse:()=>Js,structure:()=>G0});function z0(){return this.tokenIndex>0&&this.lookupType(-1)===13?this.tokenIndex>1?this.getTokenStart(this.tokenIndex-1):this.firstCharOffset:this.tokenStart}var W0="Raw",G0={value:String};function Js(e,t){let i=this.getTokenStart(this.tokenIndex),n;return this.skipUntilBalanced(this.tokenIndex,e||this.consumeUntilBalanceEnd),t&&this.tokenStart>i?n=z0.call(this):n=this.tokenStart,{type:"Raw",loc:this.getLocation(i,n),value:this.substring(i,n)}}function Xs(e){this.tokenize(e.value)}var ro={};N(ro,{generate:()=>io,name:()=>K0,parse:()=>to,structure:()=>Q0,walkContext:()=>Y0});function Ju(){return this.Raw(this.consumeUntilLeftCurlyBracket,!0)}function q0(){let e=this.SelectorList();return e.type!=="Raw"&&this.eof===!1&&this.tokenType!==23&&this.error(),e}var K0="Rule",Y0="rule",Q0={prelude:["SelectorList","Raw"],block:["Block"]};function to(){let e=this.tokenIndex,t=this.tokenStart,i,n;return this.parseRulePrelude?i=this.parseWithFallback(q0,Ju):i=Ju.call(this,e),n=this.Block(!0),{type:"Rule",loc:this.getLocation(t,this.tokenStart),prelude:i,block:n}}function io(e){this.node(e.prelude),this.node(e.block)}var so={};N(so,{generate:()=>ao,name:()=>Z0,parse:()=>no,structure:()=>J0});var Z0="Scope",J0={root:["SelectorList","Raw",null],limit:["SelectorList","Raw",null]};function no(){let e=null,t=null;this.skipSC();let i=this.tokenStart;return this.tokenType===21&&(this.next(),this.skipSC(),e=this.parseWithFallback(this.SelectorList,()=>this.Raw(!1,!0)),this.skipSC(),this.eat(22)),this.lookupNonWSType(0)===1&&(this.skipSC(),this.eatIdent("to"),this.skipSC(),this.eat(21),this.skipSC(),t=this.parseWithFallback(this.SelectorList,()=>this.Raw(!1,!0)),this.skipSC(),this.eat(22)),{type:"Scope",loc:this.getLocation(i,this.tokenStart),root:e,limit:t}}function ao(e){e.root&&(this.token(21,"("),this.node(e.root),this.token(22,")")),e.limit&&(this.token(1,"to"),this.token(21,"("),this.node(e.limit),this.token(22,")"))}var co={};N(co,{generate:()=>lo,name:()=>X0,parse:()=>oo,structure:()=>eb});var X0="Selector",eb={children:[["TypeSelector","IdSelector","ClassSelector","AttributeSelector","PseudoClassSelector","PseudoElementSelector","Combinator"]]};function oo(){let e=this.readSequence(this.scope.Selector);return this.getFirstListNode(e)===null&&this.error("Selector is expected"),{type:"Selector",loc:this.getLocationFromList(e),children:e}}function lo(e){this.children(e)}var ho={};N(ho,{generate:()=>po,name:()=>tb,parse:()=>uo,structure:()=>rb,walkContext:()=>ib});var tb="SelectorList",ib="selector",rb={children:[["Selector","Raw"]]};function uo(){let e=this.createList();for(;!this.eof;){if(e.push(this.Selector()),this.tokenType===18){this.next();continue}break}return{type:"SelectorList",loc:this.getLocationFromList(e),children:e}}function po(e){this.children(e,()=>this.token(18,","))}var bo={};N(bo,{generate:()=>go,name:()=>ab,parse:()=>mo,structure:()=>sb});var fo=92,Xu=34,ep=39;function Vr(e){let t=e.length,i=e.charCodeAt(0),n=i===Xu||i===ep?1:0,l=n===1&&t>1&&e.charCodeAt(t-1)===i?t-2:t-1,p="";for(let d=n;d<=l;d++){let g=e.charCodeAt(d);if(g===fo){if(d===l){d!==t-1&&(p=e.substr(d+1));break}if(g=e.charCodeAt(++d),Ee(fo,g)){let x=d-1,b=ht(e,x);d=b-1,p+=Lr(e.substring(x+1,b))}else g===13&&e.charCodeAt(d+1)===10&&d++}else p+=e[d]}return p}function tp(e,t){let i=t?"'":'"',n=t?ep:Xu,l="",p=!1;for(let d=0;d<e.length;d++){let g=e.charCodeAt(d);if(g===0){l+="\uFFFD";continue}if(g<=31||g===127){l+="\\"+g.toString(16),p=!0;continue}g===n||g===fo?(l+="\\"+e.charAt(d),p=!1):(p&&(it(g)||rt(g))&&(l+=" "),l+=e.charAt(d),p=!1)}return i+l+i}var ab="String",sb={value:String};function mo(){return{type:"String",loc:this.getLocation(this.tokenStart,this.tokenEnd),value:Vr(this.consume(5))}}function go(e){this.token(5,tp(e.value))}var vo={};N(vo,{generate:()=>yo,name:()=>lb,parse:()=>xo,structure:()=>ub,walkContext:()=>cb});var ob=33;function ip(){return this.Raw(null,!1)}var lb="StyleSheet",cb="stylesheet",ub={children:[["Comment","CDO","CDC","Atrule","Rule","Raw"]]};function xo(){let e=this.tokenStart,t=this.createList(),i;for(;!this.eof;){switch(this.tokenType){case 13:this.next();continue;case 25:if(this.charCodeAt(this.tokenStart+2)!==ob){this.next();continue}i=this.Comment();break;case 14:i=this.CDO();break;case 15:i=this.CDC();break;case 3:i=this.parseWithFallback(this.Atrule,ip);break;default:i=this.parseWithFallback(this.Rule,ip)}t.push(i)}return{type:"StyleSheet",loc:this.getLocation(e,this.tokenStart),children:t}}function yo(e){this.children(e)}var wo={};N(wo,{generate:()=>So,name:()=>pb,parse:()=>ko,structure:()=>hb});var pb="SupportsDeclaration",hb={declaration:"Declaration"};function ko(){let e=this.tokenStart;this.eat(21),this.skipSC();let t=this.Declaration();return this.eof||this.eat(22),{type:"SupportsDeclaration",loc:this.getLocation(e,this.tokenStart),declaration:t}}function So(e){this.token(21,"("),this.node(e.declaration),this.token(22,")")}var To={};N(To,{generate:()=>Ao,name:()=>fb,parse:()=>Eo,structure:()=>mb});var db=42,rp=124;function Co(){this.tokenType!==1&&this.isDelim(db)===!1&&this.error("Identifier or asterisk is expected"),this.next()}var fb="TypeSelector",mb={name:String};function Eo(){let e=this.tokenStart;return this.isDelim(rp)?(this.next(),Co.call(this)):(Co.call(this),this.isDelim(rp)&&(this.next(),Co.call(this))),{type:"TypeSelector",loc:this.getLocation(e,this.tokenStart),name:this.substrToCursor(e)}}function Ao(e){this.tokenize(e.name)}var $o={};N($o,{generate:()=>Lo,name:()=>xb,parse:()=>Io,structure:()=>yb});var np=43,ap=45,_o=63;function Ni(e,t){let i=0;for(let n=this.tokenStart+e;n<this.tokenEnd;n++){let l=this.charCodeAt(n);if(l===ap&&t&&i!==0)return Ni.call(this,e+i+1,!1),-1;it(l)||this.error(t&&i!==0?"Hyphen minus"+(i<6?" or hex digit":"")+" is expected":i<6?"Hex digit is expected":"Unexpected input",n),++i>6&&this.error("Too many hex digits",n)}return this.next(),i}function Br(e){let t=0;for(;this.isDelim(_o);)++t>e&&this.error("Too many question marks"),this.next()}function gb(e){this.charCodeAt(this.tokenStart)!==e&&this.error((e===np?"Plus sign":"Hyphen minus")+" is expected")}function bb(){let e=0;switch(this.tokenType){case 10:if(e=Ni.call(this,1,!0),this.isDelim(_o)){Br.call(this,6-e);break}if(this.tokenType===12||this.tokenType===10){gb.call(this,ap),Ni.call(this,1,!1);break}break;case 12:e=Ni.call(this,1,!0),e>0&&Br.call(this,6-e);break;default:if(this.eatDelim(np),this.tokenType===1){e=Ni.call(this,0,!0),e>0&&Br.call(this,6-e);break}if(this.isDelim(_o)){this.next(),Br.call(this,5);break}this.error("Hex digit or question mark is expected")}}var xb="UnicodeRange",yb={value:String};function Io(){let e=this.tokenStart;return this.eatIdent("u"),bb.call(this),{type:"UnicodeRange",loc:this.getLocation(e,this.tokenStart),value:this.substrToCursor(e)}}function Lo(e){this.tokenize(e.value)}var Fo={};N(Fo,{generate:()=>Ro,name:()=>Eb,parse:()=>No,structure:()=>Ab});var vb=32,Po=92,kb=34,Sb=39,wb=40,sp=41;function op(e){let t=e.length,i=4,n=e.charCodeAt(t-1)===sp?t-2:t-1,l="";for(;i<n&&rt(e.charCodeAt(i));)i++;for(;i<n&&rt(e.charCodeAt(n));)n--;for(let p=i;p<=n;p++){let d=e.charCodeAt(p);if(d===Po){if(p===n){p!==t-1&&(l=e.substr(p+1));break}if(d=e.charCodeAt(++p),Ee(Po,d)){let g=p-1,x=ht(e,g);p=x-1,l+=Lr(e.substring(g+1,x))}else d===13&&e.charCodeAt(p+1)===10&&p++}else l+=e[p]}return l}function lp(e){let t="",i=!1;for(let n=0;n<e.length;n++){let l=e.charCodeAt(n);if(l===0){t+="\uFFFD";continue}if(l<=31||l===127){t+="\\"+l.toString(16),i=!0;continue}l===vb||l===Po||l===kb||l===Sb||l===wb||l===sp?(t+="\\"+e.charAt(n),i=!1):(i&&it(l)&&(t+=" "),t+=e.charAt(n),i=!1)}return"url("+t+")"}var Eb="Url",Ab={value:String};function No(){let e=this.tokenStart,t;switch(this.tokenType){case 7:t=op(this.consume(7));break;case 2:this.cmpStr(this.tokenStart,this.tokenEnd,"url(")||this.error("Function name must be `url`"),this.eat(2),this.skipSC(),t=Vr(this.consume(5)),this.skipSC(),this.eof||this.eat(22);break;default:this.error("Url or Function is expected")}return{type:"Url",loc:this.getLocation(e,this.tokenStart),value:t}}function Ro(e){this.token(7,lp(e.value))}var Do={};N(Do,{generate:()=>Oo,name:()=>Tb,parse:()=>Mo,structure:()=>_b});var Tb="Value",_b={children:[[]]};function Mo(){let e=this.tokenStart,t=this.readSequence(this.scope.Value);return{type:"Value",loc:this.getLocation(e,this.tokenStart),children:t}}function Oo(e){this.children(e)}var jo={};N(jo,{generate:()=>Bo,name:()=>Lb,parse:()=>Vo,structure:()=>$b});var Ib=Object.freeze({type:"WhiteSpace",loc:null,value:" "}),Lb="WhiteSpace",$b={value:String};function Vo(){return this.eat(13),Ib}function Bo(e){this.token(13,e.value)}var cp={parseContext:{default:"StyleSheet",stylesheet:"StyleSheet",atrule:"Atrule",atrulePrelude(e){return this.AtrulePrelude(e.atrule?String(e.atrule):null)},mediaQueryList:"MediaQueryList",mediaQuery:"MediaQuery",condition(e){return this.Condition(e.kind)},rule:"Rule",selectorList:"SelectorList",selector:"Selector",block(){return this.Block(!0)},declarationList:"DeclarationList",declaration:"Declaration",value:"Value"},features:{supports:{selector(){return this.Selector()}},container:{style(){return this.Declaration()}}},scope:Wn,atrule:Nu,pseudo:Fu,node:Uo};var up=du(cp);var{hasOwnProperty:Ho}=Object.prototype,Ri=function(){};function pp(e){return typeof e=="function"?e:Ri}function hp(e,t){return function(i,n,l){i.type===t&&e.call(this,i,n,l)}}function Pb(e,t){let i=t.structure,n=[];for(let l in i){if(Ho.call(i,l)===!1)continue;let p=i[l],d={name:l,type:!1,nullable:!1};Array.isArray(p)||(p=[p]);for(let g of p)g===null?d.nullable=!0:typeof g=="string"?d.type="node":Array.isArray(g)&&(d.type="list");d.type&&n.push(d)}return n.length?{context:t.walkContext,fields:n}:null}function Nb(e){let t={};for(let i in e.node)if(Ho.call(e.node,i)){let n=e.node[i];if(!n.structure)throw new Error("Missed `structure` field in `"+i+"` node type definition");t[i]=Pb(i,n)}return t}function dp(e,t){let i=e.fields.slice(),n=e.context,l=typeof n=="string";return t&&i.reverse(),function(p,d,g,x){let b;l&&(b=d[n],d[n]=p);for(let y of i){let k=p[y.name];if(!y.nullable||k){if(y.type==="list"){if(t?k.reduceRight(x,!1):k.reduce(x,!1))return!0}else if(g(k))return!0}}l&&(d[n]=b)}}function fp({StyleSheet:e,Atrule:t,Rule:i,Block:n,DeclarationList:l}){return{Atrule:{StyleSheet:e,Atrule:t,Rule:i,Block:n},Rule:{StyleSheet:e,Atrule:t,Rule:i,Block:n},Declaration:{StyleSheet:e,Atrule:t,Rule:i,Block:n,DeclarationList:l}}}function mp(e){let t=Nb(e),i={},n={},l=Symbol("break-walk"),p=Symbol("skip-node");for(let b in t)Ho.call(t,b)&&t[b]!==null&&(i[b]=dp(t[b],!1),n[b]=dp(t[b],!0));let d=fp(i),g=fp(n),x=function(b,y){function k(Y,ge,oe){let Pe=C.call(te,Y,ge,oe);return Pe===l?!0:Pe===p?!1:!!(_.hasOwnProperty(Y.type)&&_[Y.type](Y,te,k,K)||u.call(te,Y,ge,oe)===l)}let C=Ri,u=Ri,_=i,K=(Y,ge,oe,Pe)=>Y||k(ge,oe,Pe),te={break:l,skip:p,root:b,stylesheet:null,atrule:null,atrulePrelude:null,rule:null,selector:null,block:null,declaration:null,function:null};if(typeof y=="function")C=y;else if(y&&(C=pp(y.enter),u=pp(y.leave),y.reverse&&(_=n),y.visit)){if(d.hasOwnProperty(y.visit))_=y.reverse?g[y.visit]:d[y.visit];else if(!t.hasOwnProperty(y.visit))throw new Error("Bad value `"+y.visit+"` for `visit` option (should be: "+Object.keys(t).sort().join(", ")+")");C=hp(C,y.visit),u=hp(u,y.visit)}if(C===Ri&&u===Ri)throw new Error("Neither `enter` nor `leave` walker handler is set or both aren't a function");k(b)};return x.break=l,x.skip=p,x.find=function(b,y){let k=null;return x(b,function(C,u,_){if(y.call(this,C,u,_))return k=C,l}),k},x.findLast=function(b,y){let k=null;return x(b,{reverse:!0,enter(C,u,_){if(y.call(this,C,u,_))return k=C,l}}),k},x.findAll=function(b,y){let k=[];return x(b,function(C,u,_){y.call(this,C,u,_)&&k.push(C)}),k},x}var zo={};N(zo,{AnPlusB:()=>Zn,Atrule:()=>ea,AtrulePrelude:()=>ra,AttributeSelector:()=>oa,Block:()=>ua,Brackets:()=>da,CDC:()=>ga,CDO:()=>ya,ClassSelector:()=>Sa,Combinator:()=>Ea,Comment:()=>_a,Condition:()=>$a,Declaration:()=>Ra,DeclarationList:()=>Da,Dimension:()=>ja,Feature:()=>za,FeatureFunction:()=>qa,FeatureRange:()=>Za,Function:()=>es,GeneralEnclosed:()=>rs,Hash:()=>ss,IdSelector:()=>hs,Identifier:()=>cs,Layer:()=>ms,LayerList:()=>xs,MediaQuery:()=>ks,MediaQueryList:()=>Cs,NestingSelector:()=>Ts,Nth:()=>Ls,Number:()=>Ns,Operator:()=>Ms,Parentheses:()=>Vs,Percentage:()=>Us,PseudoClassSelector:()=>Ws,PseudoElementSelector:()=>Ks,Ratio:()=>Zs,Raw:()=>eo,Rule:()=>ro,Scope:()=>so,Selector:()=>co,SelectorList:()=>ho,String:()=>bo,StyleSheet:()=>vo,SupportsDeclaration:()=>wo,TypeSelector:()=>To,UnicodeRange:()=>$o,Url:()=>Fo,Value:()=>Do,WhiteSpace:()=>jo});var gp={node:zo};var bp=mp(gp);var Dp=Cf(Mp(),1),Op=new Set(["Atrule","Selector","Declaration"]);function Vp(e){let t=new Dp.SourceMapGenerator,i={line:1,column:0},n={line:0,column:0},l={line:1,column:0},p={generated:l},d=1,g=0,x=!1,b=e.node;e.node=function(C){if(C.loc&&C.loc.start&&Op.has(C.type)){let u=C.loc.start.line,_=C.loc.start.column-1;(n.line!==u||n.column!==_)&&(n.line=u,n.column=_,i.line=d,i.column=g,x&&(x=!1,(i.line!==l.line||i.column!==l.column)&&t.addMapping(p)),x=!0,t.addMapping({source:C.loc.source,original:n,generated:i}))}b.call(this,C),x&&Op.has(C.type)&&(l.line=d,l.column=g)};let y=e.emit;e.emit=function(C,u,_){for(let K=0;K<C.length;K++)C.charCodeAt(K)===10?(d++,g=0):g++;y(C,u,_)};let k=e.result;return e.result=function(){return x&&t.addMapping(p),{css:k(),map:t}},e}var zr={};N(zr,{safe:()=>Jo,spec:()=>tx});var Jb=43,Xb=45,Zo=(e,t)=>(e===9&&(e=t),typeof e=="string"&&(e=Math.min(e.charCodeAt(0),128)<<6),e<<1),Bp=[[1,1],[1,2],[1,7],[1,8],[1,"-"],[1,10],[1,11],[1,12],[1,15],[1,21],[3,1],[3,2],[3,7],[3,8],[3,"-"],[3,10],[3,11],[3,12],[3,15],[4,1],[4,2],[4,7],[4,8],[4,"-"],[4,10],[4,11],[4,12],[4,15],[12,1],[12,2],[12,7],[12,8],[12,"-"],[12,10],[12,11],[12,12],[12,15],["#",1],["#",2],["#",7],["#",8],["#","-"],["#",10],["#",11],["#",12],["#",15],["-",1],["-",2],["-",7],["-",8],["-","-"],["-",10],["-",11],["-",12],["-",15],[10,1],[10,2],[10,7],[10,8],[10,10],[10,11],[10,12],[10,"%"],[10,15],["@",1],["@",2],["@",7],["@",8],["@","-"],["@",15],[".",10],[".",11],[".",12],["+",10],["+",11],["+",12],["/","*"]],ex=Bp.concat([[1,4],[12,4],[4,4],[3,21],[3,5],[3,16],[11,11],[11,12],[11,2],[11,"-"],[22,1],[22,2],[22,11],[22,12],[22,4],[22,"-"]]);function jp(e){let t=new Set(e.map(([i,n])=>Zo(i)<<16|Zo(n)));return function(i,n,l){let p=Zo(n,l),d=l.charCodeAt(0),g=d===Xb&&n!==1&&n!==2&&n!==15||d===Jb?t.has((i&65534)<<16|d<<7):t.has((i&65534)<<16|p);return p|g}}var tx=jp(Bp),Jo=jp(ex);var ix=92;function rx(e,t){if(typeof t=="function"){let i=null;e.children.forEach(n=>{i!==null&&t.call(this,i),this.node(n),i=n});return}e.children.forEach(this.node,this)}function Up(e){let t=new Map;for(let[i,n]of Object.entries(e.node))typeof(n.generate||n)=="function"&&t.set(i,n.generate||n);return function(i,n){let l="",p=0,d={node(x){if(t.has(x.type))t.get(x.type).call(g,x);else throw new Error("Unknown node type: "+x.type)},tokenBefore:Jo,token(x,b,y){p=this.tokenBefore(p,x,b),!y&&p&1&&this.emit(" ",13,!0),this.emit(b,x,!1),x===9&&b.charCodeAt(0)===ix&&this.emit(`
`,13,!0)},emit(x){l+=x},result(){return l}};n&&(typeof n.decorator=="function"&&(d=n.decorator(d)),n.sourceMap&&(d=Vp(d)),n.mode in zr&&(d.tokenBefore=zr[n.mode]));let g={node:x=>d.node(x),children:rx,token:(x,b)=>d.token(x,b),tokenize:x=>Rr(x,(b,y,k)=>{d.token(b,x.slice(y,k),y!==0)})};return d.node(i),d.result()}}var Xo={};N(Xo,{AnPlusB:()=>Qn,Atrule:()=>Xn,AtrulePrelude:()=>ia,AttributeSelector:()=>sa,Block:()=>ca,Brackets:()=>ha,CDC:()=>ma,CDO:()=>xa,ClassSelector:()=>ka,Combinator:()=>Ca,Comment:()=>Ta,Condition:()=>La,Declaration:()=>Na,DeclarationList:()=>Oa,Dimension:()=>Ba,Feature:()=>Ha,FeatureFunction:()=>Ga,FeatureRange:()=>Qa,Function:()=>Xa,GeneralEnclosed:()=>is,Hash:()=>as,IdSelector:()=>ps,Identifier:()=>ls,Layer:()=>fs,LayerList:()=>bs,MediaQuery:()=>vs,MediaQueryList:()=>ws,NestingSelector:()=>As,Nth:()=>Is,Number:()=>Ps,Operator:()=>Fs,Parentheses:()=>Ds,Percentage:()=>js,PseudoClassSelector:()=>zs,PseudoElementSelector:()=>qs,Ratio:()=>Qs,Raw:()=>Xs,Rule:()=>io,Scope:()=>ao,Selector:()=>lo,SelectorList:()=>po,String:()=>go,StyleSheet:()=>yo,SupportsDeclaration:()=>So,TypeSelector:()=>Ao,UnicodeRange:()=>Lo,Url:()=>Ro,Value:()=>Oo,WhiteSpace:()=>Bo});var Hp={node:Xo};var el=Up(Hp);var Oi="cover opening quote couple stories savedate countdown gallery videos events dress rundown rsvp live filter gifts adab families closing footer".split(" "),nx=new Set("text textarea url email tel number date time datetime color select boolean image repeater repeater-image".split(" ")),Wp=new Set(["__proto__","prototype","constructor"]);function Wr(e,t){if(!(!e||typeof e!="object")){e.type&&t(e);for(let i of Object.values(e))Array.isArray(i)?i.forEach(n=>Wr(n,t)):i&&typeof i=="object"&&Wr(i,t)}}function ri(e){return e?e.computed?e.property?.value:e.property?.name:""}function ni(e){if(!e)throw new Error("Nilai static tidak ditemukan");if(e.type==="Literal"&&!e.regex&&!e.bigint)return e.value;if(e.type==="UnaryExpression"&&e.operator==="!")return!ni(e.argument);if(e.type==="UnaryExpression"&&["+","-"].includes(e.operator)){let t=ni(e.argument);if(typeof t=="number")return e.operator==="-"?-t:t}if(e.type==="ArrayExpression")return e.elements.map(ni);if(e.type==="ObjectExpression"){let t={};for(let i of e.properties){let n=i.key?.name??i.key?.value;if(i.type!=="Property"||i.computed||i.method||i.kind!=="init"||Wp.has(String(n)))throw new Error("Property static tidak aman");t[n]=ni(i.value)}return t}throw new Error("CONFIG dan SVE_SCHEMA harus berisi nilai static")}function zp(e,t){let i=null;return Wr(e,n=>{if(i)return;let l=n.type==="VariableDeclarator"&&n.id.name===t,p=n.type==="AssignmentExpression"&&n.left.type==="MemberExpression"&&["window","globalThis"].includes(n.left.object.name)&&ri(n.left)===t;if(l||p)try{i=ni(l?n.init:n.right)}catch{}}),i&&!Array.isArray(i)&&typeof i=="object"?i:null}function ax(e){let t=new WeakMap,i=(l,p,d=null)=>{l&&(l.type==="Identifier"?p.bindings.set(l.name,d):l.type==="RestElement"?i(l.argument,p):l.type==="AssignmentPattern"?i(l.left,p):l.type==="ArrayPattern"?l.elements.forEach(g=>i(g,p)):l.type==="ObjectPattern"&&l.properties.forEach(g=>i(g.value||g.argument,p)))},n=(l,p)=>{if(!l||typeof l!="object")return;let d=["FunctionDeclaration","FunctionExpression","ArrowFunctionExpression"].includes(l.type);l.type==="FunctionDeclaration"&&i(l.id,p);let g=d||["Program","BlockStatement","CatchClause","ForStatement","ForOfStatement","ForInStatement"].includes(l.type),x=g?{parent:p,bindings:new Map,functionScope:null}:p;g&&(x.functionScope=d||l.type==="Program"?x:p.functionScope),t.set(l,x),d&&(l.id&&i(l.id,x),l.params.forEach(b=>i(b,x))),l.type==="CatchClause"&&i(l.param,x),l.type==="VariableDeclaration"&&l.declarations.forEach(b=>i(b.id,l.kind==="var"?x.functionScope:x,b.init));for(let b of Object.values(l))Array.isArray(b)?b.forEach(y=>n(y,x)):b&&typeof b=="object"&&n(b,x)};return n(e,null),t}function sx(e){let t=[],i=ax(e),n=(g,x=new Set)=>{if(g?.type!=="Identifier"||x.has(g))return g;x.add(g);for(let b=i.get(g);b;b=b.parent)if(b.bindings.has(g.name))return n(b.bindings.get(g.name),x);return g},l=g=>(g=n(g),g?.name==="document"||g?.type==="MemberExpression"&&["window","globalThis"].includes(g.object.name)&&ri(g)==="document"),p=g=>(g=n(g),g?.type==="MemberExpression"?l(g.object)&&ri(g)==="body":g?.type==="CallExpression"&&l(g.callee.object)&&ri(g.callee)==="querySelector"&&g.arguments[0]?.value==="body"),d=g=>(g=n(g),g?.type==="NewExpression"&&(g.callee.name==="MutationObserver"||ri(g.callee)==="MutationObserver"));return Wr(e,g=>{if(g.type==="CallExpression"&&g.callee.name==="eval"&&t.push("eval() terdeteksi"),["NewExpression","CallExpression"].includes(g.type)&&g.callee.name==="Function"&&t.push("Function constructor terdeteksi"),g.type!=="CallExpression"||ri(g.callee)!=="observe"||!d(g.callee.object)||!p(g.arguments[0]))return;let x;try{x=ni(n(g.arguments[1]))}catch{}let b=x?.attributes??(x?.attributeFilter!==void 0||x?.attributeOldValue!==void 0);(!x||b&&(!Array.isArray(x.attributeFilter)||x.attributeFilter.includes("style")))&&t.push("MutationObserver pada style document.body dilarang (risiko infinite loop & Page Unresponsive)")}),t}function Gp(e){let t=[...e.children],i=t.slice(t.findLastIndex(n=>n.type==="Combinator")+1);return i.some(n=>n.type==="PseudoElementSelector")?[]:i.flatMap(n=>n.type==="TypeSelector"&&["html","body"].includes(n.name.toLowerCase())?[n.name.toLowerCase()]:n.type==="PseudoClassSelector"&&n.name==="root"?["html"]:n.type==="PseudoClassSelector"&&["is","where"].includes(n.name)&&n.children?[...n.children].flatMap(l=>l.type==="SelectorList"?[...l.children].flatMap(Gp):[]):[])}function ox(e){let t=[],i;try{i=up(e)}catch(p){return["CSS tidak terbaca: "+p.message]}let n=[!0],l={html:{},body:{}};return bp(i,{enter(p){if(p.type==="Atrule"){p.name.toLowerCase()==="import"&&t.push("@import di dalam <style> dilarang; gunakan tag <link> di <head>");let g=p.prelude?el(p.prelude):"",x=p.name.toLowerCase()==="media"&&g.split(",").every(b=>{let y=b.match(/min-width\s*:\s*([\d.]+)px/i)||b.match(/width\s*>=?\s*([\d.]+)px/i);return/\bprint\b/i.test(b)||y&&Number(y[1])>960});n.push(n.at(-1)&&!x)}if(p.type!=="Rule"||!n.at(-1))return;let d=new Set(p.prelude?.type==="SelectorList"?[...p.prelude.children].flatMap(Gp):[]);p.block.children.forEach(g=>{if(g.type!=="Declaration")return;let x=el(g.value).trim().toLowerCase();for(let b of d)["overflow","overflow-y"].includes(g.property)&&/\bhidden\b/.test(x)&&(l[b].overflow=!0),g.property==="height"&&x==="100dvh"&&(l[b].height=!0)})},leave(p){p.type==="Atrule"&&n.pop()}}),Object.values(l).some(p=>p.height&&p.overflow)&&t.push("html/body dengan overflow:hidden dan height:100dvh dilarang pada mobile"),t}function tl({doc:e,scripts:t=[],css:i="",config:n,schema:l,requireObjects:p=!0}){let d=[],g=[];for(let C of t)try{let u=eu(C,{ecmaVersion:"latest",sourceType:"script"});g.push(u),d.push(...sx(u))}catch(u){d.push("Sintaks JavaScript gagal kompilasi: "+u.message)}n??(n=g.map(C=>zp(C,"CONFIG")).find(Boolean)),l??(l=g.map(C=>zp(C,"SVE_SCHEMA")).find(Boolean)),p&&!n&&d.push("CONFIG static tidak terbaca"),p&&!l&&d.push("SVE_SCHEMA static tidak terbaca");let x=l?.template?.type==="custom-page";if(l){Array.isArray(l.sections)||d.push("SVE_SCHEMA.sections wajib array");let C=Array.isArray(l.sections)?l.sections:[],u=C.map(_=>_?.id);new Set(u).size!==u.length&&d.push("SVE_SCHEMA memiliki duplicate section id"),x||(Oi.forEach(_=>{u.includes(_)||d.push("Canonical section hilang: "+_)}),u.forEach(_=>{Oi.includes(_)||d.push("Section bukan canonical: "+_)}));for(let _ of C){if(_?.fields!==void 0&&!Array.isArray(_.fields)){d.push("Section fields wajib array");continue}for(let K of _?.fields||[])if(nx.has(K?.type||"text")||d.push("Field type tidak didukung: "+K?.type),!!["repeater","repeater-image"].includes(K?.type)){if(!Array.isArray(K.fields)){d.push("Repeater tanpa fields[]");continue}for(let te of K.fields)(!te?.key||Wp.has(te.key))&&d.push("Repeater subfield tanpa stable key yang aman"),["repeater","repeater-image"].includes(te?.type)&&d.push("Nested repeater tidak diizinkan")}}}if(n&&!x){let C=n.sectionOrder;(!Array.isArray(C)||C.length!==Oi.length||!Oi.every(u=>C.includes(u))||C[0]!=="cover")&&d.push("CONFIG.sectionOrder belum lengkap atau cover bukan pertama")}let y=[e?.documentElement?.outerHTML||"",i,...t].join(`
`);/javascript\s*:/i.test(y)&&d.push("javascript: URL terdeteksi"),/(service[_-]?role|database[_-]?password|private[_-]?api[_-]?key|secret[_-]?token)\s*[:=]/i.test(y)&&d.push("Kemungkinan credential rahasia terdeteksi"),/data:image\/(?!svg\+xml)[a-z0-9.+-]+;base64,/i.test(y)&&d.push("Gambar base64 terdeteksi; gunakan URL https");let k=["html","body"].map(C=>`${C}{${e?.querySelector(C)?.getAttribute("style")||""}}`).join("");d.push(...ox(i+k));for(let C of e?.querySelectorAll("audio")||[])C.getAttribute("preload")?.toLowerCase()!=="none"&&d.push('Audio wajib menggunakan preload="none"');for(let C of e?.querySelectorAll("iframe")||[]){let u="";try{u=new URL(C.getAttribute("src")||"","https://template.invalid").hostname}catch{}/(^|\.)youtube(?:-nocookie)?\.com$/i.test(u)&&C.getAttribute("loading")?.toLowerCase()!=="lazy"&&d.push('Iframe YouTube wajib memiliki loading="lazy"')}return e?.getElementById("smartLoaderOverlay")&&d.push("smartLoaderOverlay dilarang; gunakan cover undangan langsung"),{blockers:[...new Set(d)],config:n,schema:l}}var lx="sve-background-primary sve-background-secondary sve-background-tertiary sve-text-primary sve-text-secondary sve-text-tertiary sve-button-background-primary sve-button-text-primary sve-button-background-secondary sve-button-text-secondary".split(" "),cx=["display","heading","subheading","body","small","button"].flatMap(e=>["size","weight"].map(t=>`sve-${e}-${t}`));function ux(e){let t=String(e||""),i=new Set([...t.matchAll(/--([a-z0-9-]+)\s*:/gi)].map(n=>n[1]));return i.size?[...lx,...cx].filter(n=>i.has(n)&&!new RegExp(`var\\(\\s*--${n}\\s*[,)]`).test(t)).map(n=>`Token ${n} dideklarasikan tetapi tidak pernah dipakai; panel Color/Style SVE tidak akan berpengaruh`):[]}function px(e){let t=[];for(let i of e?.querySelectorAll?.("[style]")||[]){if(i.hasAttribute?.("data-sve-literal-color"))continue;let p=(i.getAttribute("style")||"").replace(/var\([^)]*\)/g,"").match(/#[0-9a-f]{3,8}\b/gi);if(!p)continue;let d=i.getAttribute("data-pencil-id"),g=i.getAttribute("data-pencil-name"),x=d?` pada node ${d}${g?" ("+g+")":""}`:"";t.push(`Warna belum tertoken: ${[...new Set(p)].join(", ")}${x}. Panel Color SVE tidak akan mengubahnya`)}return t}function qp(e,t){let i=String(e||"").replace(/^\uFEFF/,""),n=t(i),l=[...n.querySelectorAll("style")],p=[...n.querySelectorAll("script")],d=tl({doc:n,css:l.map(b=>b.textContent).join(`
`),scripts:p.map(b=>b.textContent)}),g=d.blockers;if(/^\s*<!doctype\s+html\b/i.test(i)||g.push("DOCTYPE HTML wajib ada"),n.documentElement?.getAttribute("lang")!=="id"&&g.push('html lang wajib "id"'),(!/<head[\s>]/i.test(i)||!n.head)&&g.push("Elemen head wajib ada"),(!/<body[\s>]/i.test(i)||!n.body)&&g.push("Elemen body wajib ada"),n.head?.querySelector("title")||g.push("Title wajib ada di head"),n.querySelector("[data-sve-template]")||g.push("Root data-sve-template tidak ditemukan"),(l.length!==1||!n.head?.contains(l[0]))&&g.push("Wajib tepat satu style di head"),(p.length!==1||!n.body?.contains(p[0]))&&g.push("Wajib tepat satu script di body"),p[0]&&p[0]!==n.body?.lastElementChild&&g.push("Script wajib menjadi elemen terakhir di body"),p.some(b=>b.hasAttribute("src"))&&g.push("Script template harus inline"),d.schema?.template?.type!=="custom-page"){let b=new Set([...n.querySelectorAll("[data-section-id]")].map(y=>y.getAttribute("data-section-id")));Oi.forEach(y=>{b.has(y)||g.push("Markup section hilang: "+y)})}g.push(...ux(d.html??i));let x=px(n);return{...d,blockers:[...new Set(g)],warnings:x,html:i}}var hx="sve-config",dx="sve-config-ack";function Kp({document:e,window:t,getConfig:i,syncImages:n,metrics:l}){let p=null,d=null,g=!1,x=null,b=null,y=0,k=null,C=null,u=!1,_=null,K=null;function te(){if(p?.isConnected)return p;let z=[...e.querySelectorAll("iframe")];return p=z.find(Q=>Q.getAttribute("title")==="HTML Mode preview")||z.find(Q=>Q.id==="preview")||z.find(Q=>(Q.getAttribute("srcdoc")||"").length>0)||null,p}function Y(z){if(!z)return null;try{let Q=z.contentWindow;return Q&&typeof Q.SVE_REFRESH=="function"?Q:null}catch{return null}}function ge(){u||(u=!0,t.addEventListener("message",z=>{let Q=z.data;!Q||Q.type!==dx||z.origin!=="null"&&z.origin!==t.location?.origin||k!==null&&Q.id!==k||(k=null,C!==null&&(t.clearTimeout(C),C=null),_===null&&(_=!0),l.previewAckCount=(l.previewAckCount||0)+1,Q.error&&console.warn("[SVE] Preview menolak CONFIG:",Q.error))}))}function oe(){if(_===null){_=!1,l.previewUnsupported=!0;try{K?.()}catch(z){console.warn("[SVE] onUnsupported gagal",z)}}}function Pe(z,Q){ge();let Xe=JSON.parse(Q),Ne=++y;k=Ne,z.contentWindow.postMessage({type:hx,id:Ne,config:Xe},"*"),l.previewMessageCount=(l.previewMessageCount||0)+1,_===null&&C===null&&(C=t.setTimeout(()=>{C=null,k!==null&&oe()},400))}function Je(z,Q,Xe){let Ne=JSON.parse(Xe);if(Q.CONFIG=Ne,Q.SVE_REFRESH?.(Ne),_=!0,l.previewDirectCount=(l.previewDirectCount||0)+1,g)try{z.contentDocument&&n(z.contentDocument)}catch{}}function ai(){d!==null&&t.cancelAnimationFrame(d),d=null;let z=te(),Q=i();if(!z||!Q)return;let Xe=JSON.stringify(Q);if(!(Xe===x&&z===b&&!g)){try{let Ne=Y(z);Ne?Je(z,Ne,Xe):Pe(z,Xe),x=Xe,b=z,l.previewRefreshCount=(l.previewRefreshCount||0)+1}catch(Ne){console.warn("[SVE] Preview refresh gagal",Ne)}g=!1}}return{request({images:z=!1,force:Q=!1}={}){g||(g=z),Q&&(x=null,b=null),d===null&&(d=t.requestAnimationFrame(ai))},document(){try{return te()?.contentDocument||null}catch{return null}},supported(){return _},onUnsupported(z){K=z},invalidate(){p=null,x=null,b=null},flush:ai}}(function(){"use strict";let e="sve77",t="0.32.5",n=Object.freeze({endpoint:"https://template-library.nikahin.workers.dev/",timeoutMs:9e3}),l="https://nikahin.myscalev.com/home#paket",p="6282175274118",d="~halooo mas Hasya, aku kreator undangan Nikahin dari Scalev panel...",g="https://raw.githubusercontent.com/hasyaapp/visual-editor/main/scripts/scalev-visual-editor.user.js",x=g;function b(){if(location.hostname!=="app.scalev.com")return!1;let r=location.pathname.replace(/\/+$/,"")||"/";return r==="/pages/new"?new URLSearchParams(location.search).get("mode")==="html_mode":/^\/pages\/[^/]+$/.test(r)}if(!b()||new URLSearchParams(location.search).get("sve-draft")==="1"!==!1||document.getElementById(e))return;let k=(r,a=document)=>a.querySelector(r),C=(r,a=document)=>Array.from(a.querySelectorAll(r)),u={open:!1,tab:"content",search:"",editors:{html:null,css:null,js:null,head:null},allEditors:[],doc:null,rootSelector:":root",config:null,configRange:null,configSourceText:"",configOwnerSource:"",commitError:"",managedSources:null,schema:null,defaults:null,defaultConfig:null,scalevSlug:"",pendingWeddingIdSlug:"",dashboardPin:{status:"idle",slug:"",pin:"",version:0,message:"",busy:!1},templateLibrary:{status:"idle",templates:[],error:"",search:"",importedId:"",importedName:"",previousSource:null,loadedAt:0},internalEditorWrite:0,editorChangeBound:new WeakSet,freshBaselineTimer:null,baselineFingerprint:"",lastManagedFingerprint:"",contentOpenSections:new Set,contentCommitTimer:null,contentCommitMessage:"",contentStateDirty:!1,lastSerializedConfig:"",contentSearchIndex:null,contentFieldCache:new WeakMap,repeaterContentFieldCache:new WeakMap,fallbackSchemaCache:null,fallbackSchemaReady:!1,contentSectionHtmlCache:new Map,contentSectionUseTick:0,contentMaxMountedSections:6,contentPrewarmScheduled:!1,contentPrewarmHandle:null,contentPrewarmCursor:0,canvasPickMessageBound:!1,canvasPickSources:new WeakMap,sourceDirty:!0,uiPrepared:!1,renderedTab:"",renderedSearch:"",performance:{renderCount:0,skippedTabRenders:0,lastRenderMs:0,lastRenderTab:"",slowRenders:0,firstPaintMarks:[]},previewRefreshTimer:null,previewRefreshImages:!1,prewarmScheduled:!1,prewarmHandle:null,nativeCache:{save:null,publish:null,toolbarHost:null,globalHeader:null,workspaceRoot:null,topToolbar:null}};window.__SVE77_PERF=u.performance;let _=[["Background","Primary","--sve-background-primary","#f7f0e8"],["Background","Secondary","--sve-background-secondary","#ffffff"],["Background","Tertiary","--sve-background-tertiary","#e8ddd0"],["Body Teks","Primary","--sve-text-primary","#332a24"],["Body Teks","Secondary","--sve-text-secondary","#74675f"],["Body Teks","Tertiary","--sve-text-tertiary","#a09185"],["Button Primary","Background","--sve-button-background-primary","#332a24"],["Button Primary","Text","--sve-button-text-primary","#ffffff"],["Button Secondary","Background","--sve-button-background-secondary","#ffffff"],["Button Secondary","Text","--sve-button-text-secondary","#332a24"]],K=Array.from({length:31},(r,a)=>12+a*2+"px"),te=["1.0","1.2","1.5","1.6","1.8","2.0","2.4","2.8","3.0","4.0","5.0"],Y=["100","200","300","400","500","600","700","800","900"],ge=[{key:"display",label:"Display / Hero",size:"56px",weight:"400",lineheight:"1.0"},{key:"heading",label:"Heading",size:"40px",weight:"400",lineheight:"1.2"},{key:"subheading",label:"Subheading / Card Title",size:"26px",weight:"500",lineheight:"1.3"},{key:"body",label:"Body",size:"16px",weight:"400",lineheight:"1.5"},{key:"small",label:"Small / Meta / Label",size:"12px",weight:"500",lineheight:"1.4"},{key:"button",label:"Button / CTA",size:"14px",weight:"700",lineheight:"1.2"}],oe=ge.flatMap(r=>[{role:r.key,roleLabel:r.label,label:"Size",variable:"--sve-"+r.key+"-size",fallback:r.size,type:"size"},{role:r.key,roleLabel:r.label,label:"Weight",variable:"--sve-"+r.key+"-weight",fallback:r.weight,type:"weight"},{role:r.key,roleLabel:r.label,label:"Line Height",variable:"--sve-"+r.key+"-line-height",fallback:r.lineheight,type:"lineheight"}]),Pe=[{target:"heading",variable:"--sve-font-heading"},{target:"body",variable:"--sve-font-body"}],Je=["cover","opening","quote","couple","stories","savedate","countdown","gallery","videos","events","dress","rundown","rsvp","live","filter","gifts","adab","families","closing","footer"],ai=new Set(["text","textarea","url","email","tel","number","date","time","datetime","color","select","boolean","image","repeater","repeater-image"]),z=new Set(["__proto__","prototype","constructor"]),Q=12,Xe=240,Ne=1e4;function mt(r){let a=String(r||"").trim();if(!a||a.length>Xe||a.includes("..")||a.startsWith(".")||a.endsWith("."))return null;let s=a.split(".");if(!s.length||s.length>Q)return null;for(let o of s){if(!o||z.has(o))return null;if(/^\d+$/.test(o)){let c=Number(o);if(!Number.isSafeInteger(c)||c<0||c>Ne)return null;continue}if(!/^[A-Za-z_$][A-Za-z0-9_$-]*$/.test(o))return null}return s}let Di=/data:image\/(?!svg\+xml)[a-z0-9.+-]+;base64,/gi,il=/data:[a-z0-9.+-]+\/[a-z0-9.+-]+[;,][^\s"'`)<>]*/gi,Yp=4096;function Gr(r){return Di.lastIndex=0,Di.test(String(r||""))}function Qp(r){let a=[];return Object.entries(r||{}).forEach(([s,o])=>{let c=String(o||"");if(!c)return;Di.lastIndex=0;let h=0,m=0,v;for(;v=Di.exec(c);){h+=1;let S=v.index+v[0].length,w=S;for(;w<c.length&&/[A-Za-z0-9+/=]/.test(c[w]);)w+=1;m+=w-S}h&&a.push({where:s,count:h,approxKb:Math.max(1,Math.round(m*.75/1024))})}),a}function Zp(r){let a=[];return Object.entries(r||{}).forEach(([s,o])=>{let c=String(o||"");if(!c)return;il.lastIndex=0;let h=0,m=0,v;for(;v=il.exec(c);){let S=v[0].length;S<=Yp||Gr(v[0])||(h+=1,m=Math.max(m,S))}h&&a.push({where:s,count:h,approxKb:Math.max(1,Math.round(m/1024))})}),a}function rl(r){return r.map(a=>a.where+" ("+a.count+"x, \xB1"+a.approxKb+" KB)").join(", ")}let qr=["default","center center","center left","center right","top center","top left","top right","bottom center","bottom left","bottom right"],Jp={default:"","center center":"center center","center left":"left center","center right":"right center","top center":"center top","top left":"left top","top right":"right top","bottom center":"center bottom","bottom left":"left bottom","bottom right":"right bottom"},nl=["auto","cover","contain"];function Xp(r){return r==="fill"?"cover":r==="fit"?"contain":nl.includes(r)?r:"auto"}function al(r=""){return`
      <svg
        width="1em"
        height="1em"
        viewBox="0 0 24 24"
    ...
    `}function E(r){return String(r??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#039;")}function si(r,a=180){let s;return(...o)=>{clearTimeout(s),s=setTimeout(()=>r(...o),a)}}function Ft(r,a=900){return typeof window.requestIdleCallback=="function"?window.requestIdleCallback(r,{timeout:a}):window.setTimeout(()=>r({didTimeout:!0,timeRemaining:()=>0}),120)}function ol(r){r!=null&&(typeof window.cancelIdleCallback=="function"?window.cancelIdleCallback(r):clearTimeout(r))}function Ue(r){return!!(r&&r.isConnected)}function Mt(){let r=u.nativeCache;Object.keys(r).forEach(a=>{r[a]&&!Ue(r[a])&&(r[a]=null)})}function gt(r){return r==null?r:JSON.parse(JSON.stringify(r))}function Ot(r){return String(r||"").replace(/[._-]+/g," ").replace(/([a-z])([A-Z])/g,"$1 $2").replace(/\b\w/g,a=>a.toUpperCase()).trim()}function fx(){}function B(r,a){if(r==null||!a)return;let s=mt(a);if(!s)return;let o=r;for(let c of s){if(o==null)return;let h=/^\d+$/.test(c)?Number(c):c;if(!Object.prototype.hasOwnProperty.call(o,h))return;o=o[h]}return o}function He(r,a,s){let o=mt(a);if(!r||!o)return!1;let c=r;for(let v=0;v<o.length-1;v++){let S=o[v],w=/^\d+$/.test(S)?Number(S):S;if((!Object.prototype.hasOwnProperty.call(c,w)||c[w]===null||c[w]===void 0)&&(c[w]=/^\d+$/.test(o[v+1])?[]:Object.create(null)),typeof c[w]!="object")return!1;c=c[w]}let h=o.at(-1),m=/^\d+$/.test(h)?Number(h):h;return c[m]=s,!0}function Ct(r){let a=String(r||"").trim();if(!a)return"";try{/^https?:\/\//i.test(a)&&(a=new URL(a).pathname.split("/").filter(Boolean).at(-1)||"")}catch{}try{a=decodeURIComponent(a)}catch{}return a.normalize("NFD").replace(/[\u0300-\u036f]/g,"").toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/-+/g,"-").replace(/^-+|-+$/g,"").slice(0,64)}function Kr(r){if(!r||!(r instanceof HTMLInputElement)||r.closest("#"+e))return!1;if(String(r.getAttribute("placeholder")||"").trim().toLowerCase()==="nama-halaman")return!0;let s=r;for(let o=0;o<5&&s;o+=1){if(String(s.textContent||"").replace(/\s+/g," ").trim().toLowerCase().includes("slug url"))return!0;s=s.parentElement}return!1}function th(){let r=C('input[type="text"], input:not([type])').filter(a=>Kr(a));return r.length?r.find(a=>String(a.getAttribute("placeholder")||"").trim().toLowerCase()==="nama-halaman")||r[0]:null}function ih(){let r=C("a[href]").filter(a=>!a.closest("#"+e));for(let a of r){let s=a,o="";for(let c=0;c<4&&s;c+=1)o+=" "+String(s.textContent||""),s=s.parentElement;if(/saat\s*ini/i.test(o))try{let c=new URL(a.href,location.href);if(!/\.scalev\.(?:com|id)$/i.test(c.hostname)&&!/scalev\.(?:com|id)$/i.test(c.hostname))continue;let h=c.pathname.split("/").filter(Boolean),m=Ct(h.at(-1)||"");if(m)return m}catch{}}return""}function Et(){let r=th(),a=Ct(r?.value);if(a)return u.scalevSlug=a,a;let s=ih();return s?(u.scalevSlug=s,s):u.scalevSlug||""}function Yr(r,a){let s=String(a||r?.path||"").trim().toLowerCase(),o=String(r?.label||"").trim().toLowerCase(),c=s.replace(/[^a-z0-9]/g,"");return(s.includes("guestbook")||s.includes("rsvp"))&&c.endsWith("weddingid")||/wedding\s*id/.test(o)}function rh(){let r=new Set;try{ke().forEach(a=>{(a.fields||[]).forEach(s=>{s.type!=="repeater"&&Yr(s,s.path)&&s.path&&r.add(s.path)})})}catch{}return u.config&&B(u.config,"rsvp.weddingId")!==void 0&&r.add("rsvp.weddingId"),u.config&&B(u.config,"guestbook.weddingId")!==void 0&&r.add("guestbook.weddingId"),Array.from(r)}function Qr(r){C('[data-auto-wedding-id="1"]').forEach(a=>{a.value!==r&&(a.value=r),a.setAttribute("readonly","")})}function oi(r,a={}){let s=Ct(r||Et());if(!s)return!1;u.scalevSlug=s;let o=rh();if(!u.config||!o.length)return u.pendingWeddingIdSlug=s,Qr(s),!1;let c=!1;if(o.forEach(m=>{B(u.config,m)!==s&&(He(u.config,m,s),c=!0)}),Qr(s),!c)return u.pendingWeddingIdSlug="",!1;let h=Xr().length>0;return a.commit!==!1&&h&&u.configRange?.editor?(u.pendingWeddingIdSlug="",Te(a.silent?void 0:"Wedding ID mengikuti Slug URL"),Qr(s),!0):(u.pendingWeddingIdSlug=s,!0)}function ll(){let r=Ct(u.pendingWeddingIdSlug||u.scalevSlug||Et());return r?oi(r,{commit:!0,silent:!0}):!1}let nh=si(()=>{let r=Et();r&&oi(r,{commit:!0})},450);function Vi(){if(Mt(),Ue(u.nativeCache.save)||Ue(u.nativeCache.publish))return{save:Ue(u.nativeCache.save)?u.nativeCache.save:null,publish:Ue(u.nativeCache.publish)?u.nativeCache.publish:null};let r=C("button").filter(c=>!c.closest("#"+e)),a=c=>(c.textContent||"").replace(/\s+/g," ").trim().toLowerCase(),s=r.find(c=>{let h=a(c);return h==="simpan"||h==="save"})||null,o=r.find(c=>{let h=a(c);return h.includes("simpan & terbitkan")||h.includes("simpan dan terbitkan")||h==="publish"})||null;return u.nativeCache.save=s,u.nativeCache.publish=o,{save:s,publish:o}}function ah(r,a){if(!r)return a?.parentElement||null;if(!a)return r?.parentElement||null;let s=new Set,o=r;for(;o;)s.add(o),o=o.parentElement;for(o=a;o;){if(s.has(o))return o;o=o.parentElement}return null}function cl(r,a){if(Mt(),Ue(u.nativeCache.toolbarHost))return u.nativeCache.toolbarHost;if(r&&a&&r.parentElement===a.parentElement)return u.nativeCache.toolbarHost=r.parentElement,r.parentElement;let s=ah(r,a);if(!s)return r?.parentElement||a?.parentElement||null;let o=s;for(let c=0;c<4&&o;c++,o=o.parentElement){let h=o.getBoundingClientRect?.();if(h&&h.top>=0&&h.top<180&&h.height<110)return u.nativeCache.toolbarHost=o,o}return u.nativeCache.toolbarHost=s,s}function Zr(){let r=document.getElementById(e+"-toolbar-toggle");if(!r)return;let a=!!u.open;r.style.setProperty("display",a?"none":"",a?"important":""),r.setAttribute("aria-hidden",a?"true":"false"),r.tabIndex=a?-1:0}function ul(){let{save:r,publish:a}=Vi(),s=a||r;if(!s)return!1;let o=cl(r,a);if(!o)return!1;o.setAttribute("data-sve77-toolbar-host","1"),o.style.columnGap="8px",o.style.rowGap="8px";let c=document.getElementById(e+"-toolbar-toggle");return c||(c=s.cloneNode(!1),c.id=e+"-toolbar-toggle",c.type="button",c.disabled=!1,c.removeAttribute("disabled"),c.setAttribute("aria-controls",e+"-dock"),c.setAttribute("aria-label","Tampilkan atau sembunyikan Visual Editor"),c.setAttribute("aria-pressed","false"),c.textContent="Visual Editor",c.addEventListener("click",h=>{h.preventDefault(),h.stopPropagation(),u.open?dh():Dt(!0)})),c.parentElement!==o&&(a&&a.parentElement===o?a.insertAdjacentElement("afterend",c):r&&r.parentElement===o?r.insertAdjacentElement("afterend",c):o.appendChild(c)),c.classList.toggle("sve-toolbar-active",u.open),c.setAttribute("aria-pressed",u.open?"true":"false"),Zr(),u.open&&requestAnimationFrame(()=>dl(!0)),!0}function Jr(){let a=[document.querySelector("#app"),document.querySelector("#__nuxt"),document.querySelector("[data-v-app]")].filter(Boolean).find(s=>!s.closest("#"+e));return a||Array.from(document.body.children).find(s=>!(!(s instanceof HTMLElement)||s.id===e||s.id===e+"-font-portal"||["SCRIPT","STYLE","LINK"].includes(s.tagName)))||null}function sh(){if(Mt(),Ue(u.nativeCache.globalHeader))return u.nativeCache.globalHeader;let r=C("div").filter(s=>{if(!(s instanceof HTMLElement)||s.closest("#"+e))return!1;let o=getComputedStyle(s),c=s.getBoundingClientRect(),h=(s.textContent||"").replace(/\s+/g," ").trim().toLowerCase();return o.position==="fixed"&&c.top>=-2&&c.top<=4&&c.height>=36&&c.height<=64&&c.width>=window.innerWidth*.7&&h.includes("landing page studio")});if(!r.length)return null;let a=r.sort((s,o)=>{let c=s.getBoundingClientRect(),h=o.getBoundingClientRect();return c.height-h.height||c.top-h.top})[0];return u.nativeCache.globalHeader=a||null,a||null}function Bi(){let r=sh(),s=r?.getBoundingClientRect?.()?.bottom||44;(!Number.isFinite(s)||s<36||s>72)&&(s=44),document.documentElement.style.setProperty("--sve77-global-header-height",Math.round(s)+"px"),r&&r.setAttribute("data-sve77-global-header","1")}function oh(){if(Mt(),Ue(u.nativeCache.workspaceRoot))return u.nativeCache.workspaceRoot;let{save:r,publish:a}=Vi(),s=a||r;if(!s)return Jr();let o=s,c=null;for(;o&&o!==document.body;){if(o instanceof HTMLElement){let m=o.getBoundingClientRect();m.top>=36&&m.top<=130&&m.width>=window.innerWidth*.68&&m.height>=window.innerHeight*.62&&(c=o)}o=o.parentElement}let h=c||Jr();return u.nativeCache.workspaceRoot=h||null,h}function lh(){let a=document.getElementById(e+"-dock")?.getBoundingClientRect?.().width||0;return a>0?a:Math.min(400,window.innerWidth*.32)}function pl(r){r&&(r.removeAttribute("data-sve77-page-root"),r.removeAttribute("data-sve77-layout"))}function ji(r){let a=document.querySelector('[data-sve77-page-root="1"]'),s=oh();if(a&&a!==s&&pl(a),s)if(r){let o=getComputedStyle(s),c=(o.position==="fixed"||o.position==="absolute")&&o.left!=="auto";s.setAttribute("data-sve77-page-root","1"),s.setAttribute("data-sve77-layout",c?"positioned":"flow")}else pl(s);document.documentElement.classList.toggle("sve77-panel-open",!!r),requestAnimationFrame(()=>dl(r))}function ch(){if(Mt(),Ue(u.nativeCache.topToolbar))return u.nativeCache.topToolbar;let{save:r,publish:a}=Vi(),s=a||r;if(!s)return null;let o=s,c=null;for(;o&&o!==document.body;){if(o instanceof HTMLElement){let h=getComputedStyle(o),m=o.getBoundingClientRect();if(h.position==="fixed"&&m.top>=36&&m.top<=70&&m.height>=48&&m.height<=92&&m.width>=Math.min(520,window.innerWidth*.42)){c=o;break}}o=o.parentElement}return u.nativeCache.topToolbar=c||null,c}function hl(r){r&&(r.removeAttribute("data-sve77-top-toolbar"),r.style.removeProperty("right"),r.style.removeProperty("transition"),r.style.removeProperty("box-sizing"))}function dl(r){let{save:a,publish:s}=Vi(),o=document.querySelector('[data-sve77-toolbar-host="1"]')||cl(a,s);o&&(o.setAttribute("data-sve77-toolbar-host","1"),o.style.columnGap="8px",o.style.rowGap="8px",o.style.removeProperty("transform"),o.style.removeProperty("transition"));let c=document.querySelector('[data-sve77-top-toolbar="1"]'),h=ch();if(c&&c!==h&&hl(c),!h)return;if(!r){hl(h);return}let m=Math.ceil(lh());h.setAttribute("data-sve77-top-toolbar","1"),h.style.setProperty("right",m+"px","important"),h.style.setProperty("box-sizing","border-box","important"),h.style.setProperty("transition","right .16s ease","important")}function fl(){Ft(()=>{if(u.open)try{let r=Et();r&&oi(r,{commit:!0,silent:!0}),ll()}catch{}},1200)}function ml(){let r=!1;try{(u.sourceDirty||!u.doc)&&(r=Se())}catch{}if(!(u.uiPrepared&&u.renderedTab===(u.tab||"content")&&u.renderedSearch===(u.search||""))||r)try{ce()}catch{}fl()}function uh(){performance.mark("sve-panel-paint-start"),requestAnimationFrame(()=>{requestAnimationFrame(()=>{if(u.open){try{Bi(),ji(!0)}catch{}performance.mark("sve-panel-paint-laid-out"),ml(),performance.mark("sve-panel-paint-end"),hh()}})})}function ph(){if(u.prewarmScheduled=!1,u.prewarmHandle=null,u.open){ml();return}performance.mark("sve-prewarm-start");try{(u.sourceDirty||!u.doc)&&Se(),!(u.uiPrepared&&u.renderedTab===(u.tab||"content")&&u.renderedSearch===(u.search||""))&&u.doc&&ce()}catch{}performance.mark("sve-prewarm-end"),fl()}function hh(){try{let r=performance.getEntriesByType("mark");u.performance.firstPaintMarks=r.filter(a=>String(a.name).startsWith("sve-")).map(a=>({name:a.name,startTime:Math.round(a.startTime*100)/100}))}catch{}}function Ui(){u.prewarmScheduled||(u.prewarmScheduled=!0,u.prewarmHandle=Ft(ph,1200))}function Dt(r){if(!r&&!xe())return;u.open=!!r;let a=document.getElementById(e),s=document.getElementById(e+"-toolbar-toggle");if(a?.classList.toggle("open",u.open),s?.classList.toggle("sve-toolbar-active",u.open),s?.setAttribute("aria-pressed",u.open?"true":"false"),Zr(),u.open){u.prewarmScheduled&&(ol(u.prewarmHandle),u.prewarmScheduled=!1,u.prewarmHandle=null),uh();return}requestAnimationFrame(()=>{try{ji(!1)}catch{}}),Ui()}function dh(){Dt(!1)}function Xr(){return[...new Set(C(".CodeMirror").map(r=>r.CodeMirror).filter(Boolean))]}function Hi(){let r=Xr();if(u.allEditors=r,!r.length)return!1;let a={html:null,css:null,js:null,head:null};return C("label").forEach(s=>{let o=s.querySelector(".CodeMirror")?.CodeMirror;if(!o)return;let c=(s.querySelector(":scope > span")?.textContent||s.querySelector("span")?.textContent||"").replace(/\s+/g," ").trim().toLowerCase();c==="body html"?a.html=o:c==="css"?a.css=o:c==="javascript"?a.js=o:c.includes("additional head")&&(a.head=o)}),r.forEach(s=>{let o=s.getValue?.()||"";!a.js&&(o.includes("SVE_SCHEMA")||/\b(?:var|let|const)\s+CONFIG\s*=/.test(o))&&(a.js=s),!a.html&&(o.includes("data-sve-section")||/<section[\s>]/i.test(o))&&(a.html=s),!a.css&&(o.includes("--sve-background-primary")||o.includes("--sve-font-heading"))&&(a.css=s)}),a.html=a.html||r[0]||null,a.css=a.css||r[1]||null,a.js=a.js||r[2]||null,a.head=a.head||r[3]||null,u.editors=a,Vh(),!0}function D(r){return u.editors[r]?.getValue?.()||""}function zi(r,a=!1){if(r)try{r.save?.();let s=r.getTextArea?.();if(s){s.dispatchEvent(new Event("input",{bubbles:!0})),a&&s.dispatchEvent(new Event("change",{bubbles:!0}));return}let o=r._handlers?.change;if(!Array.isArray(o))return;let c={from:{line:0,ch:0},to:{line:0,ch:0},text:[],removed:[],origin:"sve-wake"};o.forEach(h=>{if(!(typeof h!="function"||h.__sve))try{h(r,c)}catch{}})}catch{}}function fh(r,a,s=!1){if(r){u.internalEditorWrite+=1;try{r.operation(()=>{r.setValue(a),r.save?.()}),zi(r,s),r.refresh?.()}finally{u.internalEditorWrite=Math.max(0,u.internalEditorWrite-1)}Yi(),Tl()}}function ot(r,a){fh(u.editors[r],a)}function mh(){return new URL(n.endpoint)}function gh(r,a=!1){try{let s=new URL(String(r||""));return s.protocol!=="https:"||!a&&s.origin!==mh().origin?"":s.href}catch{return""}}function bh(r){if(!r||typeof r!="object")return null;let a=String(r.id||"").trim(),s=String(r.name||"").trim();return!/^[a-z0-9][a-z0-9-]{1,63}$/.test(a)||!s?null:{id:a,name:s.slice(0,120),version:String(r.version||"").trim().slice(0,32),commissionRate:Number.isFinite(Number(r.commission_rate))?Number(r.commission_rate):60,sourceUrl:gh(r.source_url||r.sourceUrl)}}function xh(r){return(Array.isArray(r)?r:Array.isArray(r?.templates)?r.templates:[]).map(bh).filter(Boolean)}async function yh(r,a={}){let s=new AbortController,o=window.setTimeout(()=>s.abort(),n.timeoutMs);try{return await fetch(r,{...a,signal:s.signal,credentials:"omit",cache:"no-store"})}finally{window.clearTimeout(o)}}function vh(r,a={}){if(typeof GM_xmlhttpRequest!="function")return null;let s=a.method||"GET";return new Promise((o,c)=>{GM_xmlhttpRequest({method:s,url:r,data:a.body,headers:a.headers||{},timeout:n.timeoutMs,onload:h=>{let m=Number(h.status),v=Number.isInteger(m)&&m>=200&&m<=599?m:200,S=String(h.statusText||"").replace(/[\r\n]+/g," ").slice(0,100),w=String(h.responseHeaders||"").match(/content-type:\s*([^\r\n]+)/i)?.[1]?.trim()||"text/plain";o(new Response(h.responseText||"",{status:v,statusText:S,headers:{"Content-Type":w}}))},ontimeout:()=>c(new DOMException("The operation timed out","AbortError")),onerror:()=>c(new TypeError("Userscript request failed"))})})}async function en(r,a={}){if(typeof GM_xmlhttpRequest=="function")try{return await vh(r,a)}catch{}return await yh(r,a)}async function gl(r=!1){let a=u.templateLibrary;if(!r&&a.status==="ready"&&a.loadedAt&&Date.now()-a.loadedAt<3e5)return a.templates;a.status="loading",a.error="";try{let s=await en(n.endpoint,{headers:{Accept:"application/json"}}),o=await s.json().catch(()=>null);if(!s.ok)throw new Error(o?.error||"HTTP "+s.status);let c=xh(o);if(!c.length)throw new Error("Library belum memiliki template aktif");return a.templates=c,a.loadedAt=Date.now(),a.status="ready",c}catch(s){return a.templates=[],a.status="error",a.error=s?.name==="AbortError"?"Library timeout":String(s?.message||"Library belum bisa dimuat"),a.templates}}function kh(){return C('button, [role="tab"]').find(r=>{if(r.closest("#"+e))return!1;let a=String(r.textContent||"").replace(/\s+/g," ").trim().toLowerCase();return a==="kode"||a==="code"||a.includes("kode html")})||null}async function Sh(){if(Hi()&&u.editors.html)return!0;kh()?.click();let r=Date.now();for(;Date.now()-r<2200;)if(await new Promise(a=>window.setTimeout(a,120)),Hi()&&u.editors.html)return!0;return!1}function wh(r){return qp(r,a=>new DOMParser().parseFromString(a,"text/html"))}function mx(r,a){let s=String(a||"").replace(/[.*+?^${}()|[\]\\]/g,"\\$&"),o=new RegExp("(?:var|let|const)\\s+"+s+"\\s*=\\s*\\{").exec(r);if(!o)return null;let c=bl(r,r.indexOf("{",o.index));if(!c)return null;try{return xl(c.text)}catch{return null}}function Ch(){let r=C('input[type="file"]').filter(s=>{if(s.closest("#"+e))return!1;let o=String(s.getAttribute("accept")||"").toLowerCase();return!(!o.includes("html")&&!o.includes("text/html"))});return r.filter(s=>{let o=s,c="";for(let h=0;h<5&&o;h+=1,o=o.parentElement)c+=" "+String(o.textContent||"");return/upload\s+file|import\s+html|unggah\s+file/i.test(c)})[0]||r[0]||null}function Eh(r){let a=Ch();if(!a)throw new Error("Input native Upload File belum terlihat");if(typeof DataTransfer!="function")throw new Error("Browser tidak mendukung file handoff native");let s=new DataTransfer;s.items.add(r),a.files=s.files,a.dispatchEvent(new Event("input",{bubbles:!0})),a.dispatchEvent(new Event("change",{bubbles:!0}))}function Vt(r){let a=["style","audio","compatibility"],s=r||"content",o=u.uiPrepared&&u.tab===s&&u.renderedSearch===(u.search||"");u.tab=s,u.uiPrepared=!1;let c=document.getElementById(e);if(C(".tab",c).forEach(h=>{h.classList.toggle("active",h.dataset.tab===r)}),o){u.uiPrepared=!0,u.performance.skippedTabRenders+=1;return}ce()}async function Ah(r,a,s){if(!xe())throw new Error(u.commitError||"Selesaikan perubahan konten terlebih dahulu");let o=u.templateLibrary,c=wh(await r.text());if(c.blockers.length)throw console.error("[SVE] Template library validation failed",c.blockers),new Error(c.blockers[0]);if(!await Sh())throw new Error("Buka tab Kode terlebih dahulu");let h={html:D("html"),css:D("css"),js:D("js"),head:D("head")};Eh(r);let m=Date.now(),v=!1;for(;Date.now()-m<4500;){await new Promise(A=>window.setTimeout(A,140)),Hi();let S=D("html"),w=D("js");if(S!==h.html||w!==h.js){v=!0;break}}if(!v)throw new Error("Scalev belum menyelesaikan import file");o.previousSource=h,o.importedId=a||"local-import",o.importedName=s||r.name||"Template lokal",Se(),ze(),Vt("content")}async function Th(r){let a=u.templateLibrary,s=a.templates.find(c=>c.id===r),o=c=>{a.previousSource=null,a.importedId="",a.importedName="",a.status="error",a.error=c,u.uiPrepared=!1,ce()};if(!s){o("Template tidak ditemukan");return}if(!s.sourceUrl){o("Source template belum tersedia");return}a.status="loading",a.error="",u.uiPrepared=!1,ce();try{console.log("[SVE] Import template:",s.id,s.sourceUrl);let c=await en(s.sourceUrl,{headers:{Accept:"text/html"}});if(console.log("[SVE] Fetch response:",c.status),!c.ok)throw new Error("HTTP "+c.status);let h=await c.text();console.log("[SVE] Source length:",h.length);let m=s.id.replace(/[^a-z0-9-]+/gi,"-")+".html",v=new File([h],m,{type:"text/html"});await Ah(v,s.id,s.name),a.error="",a.status="ready",Vt("content")}catch(c){console.error("[SVE] Import gagal:",c),o("Import gagal: "+String(c?.message||"source tidak terbaca"))}}function gx(){let r=u.templateLibrary.previousSource;r&&xe()&&(ot("html",r.html),ot("css",r.css),ot("js",r.js),ot("head",r.head),u.templateLibrary.previousSource=null,u.templateLibrary.importedId="",u.templateLibrary.importedName="",Se(),ze(),Vt("library"))}function _h(){let r=u.templateLibrary;clearTimeout(u.contentCommitTimer),u.contentCommitTimer=null,u.contentStateDirty=!1,["html","css","js","head"].forEach(a=>{ot(a,"")}),r.previousSource=null,r.importedId="",r.importedName="",u.sourceDirty=!0,Se(),ze(),u.uiPrepared=!1,ce()}function bl(r,a){let s=0,o=null,c=!1,h=!1,m=!1;for(let v=a;v<r.length;v++){let S=r[v],w=r[v+1];if(h){S===`
`&&(h=!1);continue}if(m){S==="*"&&w==="/"&&(m=!1,v++);continue}if(o){if(c){c=!1;continue}if(S==="\\"){c=!0;continue}S===o&&(o=null);continue}if(S==="/"&&w==="/"){h=!0,v++;continue}if(S==="/"&&w==="*"){m=!0,v++;continue}if(S==='"'||S==="'"||S==="`"){o=S;continue}if(S==="{")s++;else if(S==="}"&&(s--,s===0))return{start:a,end:v+1,text:r.slice(a,v+1)}}return null}function xl(r){let a=0,s=T=>{throw new Error(T+" @"+a)};function o(){for(;a<r.length;){let T=r[a],L=r[a+1];if(/\s/.test(T)){a++;continue}if(T==="/"&&L==="/"){for(a+=2;a<r.length&&r[a]!==`
`;)a++;continue}if(T==="/"&&L==="*"){for(a+=2;a<r.length&&!(r[a]==="*"&&r[a+1]==="/");)a++;a+=2;continue}break}}function c(){let T=r[a++],L="";for(;a<r.length;){let U=r[a++];if(U===T)return L;if(U!=="\\"){L+=U;continue}let ne=r[a++],At={n:`
`,r:"\r",t:"	","\\":"\\","'":"'",'"':'"',"`":"`"};L+=Object.prototype.hasOwnProperty.call(At,ne)?At[ne]:ne}s("String belum ditutup")}function h(){o();let T=a;for(/[A-Za-z_$]/.test(r[a]||"")||s("Identifier invalid"),a++;a<r.length&&/[A-Za-z0-9_$]/.test(r[a]);)a++;return r.slice(T,a)}function m(){let T=r.slice(a).match(/^-?(?:0|[1-9]\d*)(?:\.\d+)?(?:[eE][+-]?\d+)?/);return T||s("Number invalid"),a+=T[0].length,Number(T[0])}function v(){let T=[];if(a++,o(),r[a]==="]")return a++,T;for(;a<r.length;)if(T.push(w()),o(),r[a]==="]"||(r[a]!==","&&s("Koma array hilang"),a++,o(),r[a]==="]"))return a++,T;s("Array belum selesai")}function S(){let T=Object.create(null);if(a++,o(),r[a]==="}")return a++,T;for(;a<r.length;){o();let L=['"',"'","`"].includes(r[a])?c():h();if(o(),z.has(L)&&s("Object key terlarang: "+L),Object.prototype.hasOwnProperty.call(T,L)&&s("Duplicate object key: "+L),r[a]!==":"&&s("Titik dua hilang"),a++,T[L]=w(),o(),r[a]==="}"||(r[a]!==","&&s("Koma object hilang"),a++,o(),r[a]==="}"))return a++,T}s("Object belum selesai")}function w(){o();let T=r[a];if(T==="{")return S();if(T==="[")return v();if(['"',"'","`"].includes(T))return c();if(T==="-"||/\d/.test(T||""))return m();let L=h();if(L==="true")return!0;if(L==="false")return!1;if(L==="null")return null;L==="undefined"&&s("undefined tidak diizinkan pada strict object"),s("Value non-static: "+L)}let A=w();return o(),A}function tn(r){let a=r.replace(/[.*+?^${}()|[\]\\]/g,"\\$&"),s=new RegExp("(?:(?:var|let|const)\\s+"+a+"|(?:window|globalThis)\\."+a+")\\s*=\\s*\\{"),o=[];function c(h,m){!h||o.some(v=>v.editor===h)||o.push({editor:h,kind:m})}c(u.editors.js,"js"),c(u.editors.html,"html"),c(u.editors.head,"head"),u.allEditors.forEach(h=>c(h,"unknown"));for(let h of o){let m=h.editor.getValue?.()||"",v=s.exec(m);if(!v)continue;let S=m.indexOf("{",v.index),w=bl(m,S);if(w)try{return{kind:h.kind,editor:h.editor,obj:xl(w.text),start:w.start,end:w.end}}catch(A){console.error("[SVE] parse "+r+" gagal",A)}}return null}function Ih(){if(!u.doc)return null;let r=[];return C("[data-sve-section]",u.doc).forEach((a,s)=>{let o=[],c=new Set;C("[data-sve-field]",a).forEach(m=>{let v=m.getAttribute("data-sve-field");!v||c.has(v)||(c.add(v),o.push({type:m.getAttribute("data-sve-type")||"text",label:m.getAttribute("data-sve-label")||Ot(v),path:v}))});let h=a.getAttribute("data-sve-countdown-path");h&&!c.has(h)&&o.push({type:"datetime",label:"Waktu Tujuan",path:h}),r.push({id:a.id||"section-"+s,label:a.getAttribute("data-sve-section")||Ot(a.id)||"Section "+(s+1),visiblePath:a.getAttribute("data-sve-visible-path")||null,canHide:!!a.getAttribute("data-sve-visible-path"),reorderable:(a.getAttribute("data-section-id")||a.id||"")!=="cover",locked:!1,fields:o})}),r.length?{template:{name:"HTML Schema Fallback"},sections:r,music:{label:"Background Music",path:"assets.music"}}:null}function Wi(){return u.schema?u.schema:(u.fallbackSchemaReady||(u.fallbackSchemaCache=Ih(),u.fallbackSchemaReady=!0),u.fallbackSchemaCache)}function ke(){let r=Wi();return Array.isArray(r?.sections)?r.sections:[]}function Z(r){return String(r?.id||"").trim()}function Bt(r){let a=Z(r);return!(!a||a==="cover"||r?.locked===!0||r?.reorderable===!1)}function Gi(){let a=ke().map(Z).filter(Boolean);if(!a.length)return[];let s=new Set(a),o=Array.isArray(u.config?.sectionOrder)?u.config.sectionOrder.map(h=>String(h||"").trim()).filter(h=>h&&s.has(h)):[],c=[];return s.has("cover")&&c.push("cover"),o.forEach(h=>{h!=="cover"&&!c.includes(h)&&c.push(h)}),a.forEach(h=>{c.includes(h)||c.push(h)}),c}function li(){let r=ke(),a=new Map(r.map(s=>[Z(s),s]));return Gi().map(s=>a.get(s)).filter(Boolean)}function qi(r,a){let s=String(r||"").trim(),o=ke().find(v=>Z(v)===s);if(!o||!Bt(o))return!1;let c=Gi(),h=c.indexOf(s);if(h<0)return!1;let m=h+a;for(;m>=0&&m<c.length;){let v=c[m],S=ke().find(w=>Z(w)===v);if(v!=="cover"&&!S?.locked)return!0;m+=a}return!1}function yl(r){if(!u.config)return!1;let a=ke(),s=new Set(a.map(Z).filter(Boolean)),o=[];return s.has("cover")&&o.push("cover"),(Array.isArray(r)?r:[]).map(c=>String(c||"").trim()).filter(c=>c&&s.has(c)&&c!=="cover").forEach(c=>{o.includes(c)||o.push(c)}),a.map(Z).filter(Boolean).forEach(c=>{o.includes(c)||o.push(c)}),u.config.sectionOrder=o,!0}function Lh(r=document){C("[data-section-card]",r).forEach(a=>{let s=a.dataset.sectionCard,o=k("[data-section-up]",a),c=k("[data-section-down]",a);o&&(o.disabled=!qi(s,-1)),c&&(c.disabled=!qi(s,1))})}function $h(r,a){if(!r)return;r.classList.remove("section-reordered","section-reordered-up","section-reordered-down"),r.offsetWidth,r.classList.add("section-reordered",a==="up"?"section-reordered-up":"section-reordered-down");let s=()=>{r.classList.remove("section-reordered","section-reordered-up","section-reordered-down")};r.addEventListener("animationend",s,{once:!0}),setTimeout(s,420)}function vl(r,a,s){let o=k("#"+e+"-body");if(!o)return;let c=k(".reset-zone",o),h=new Map(C("[data-section-card]",o).map(m=>[m.dataset.sectionCard,m]));r.forEach(m=>{let v=h.get(m);v&&(c?o.insertBefore(v,c):o.appendChild(v))}),Lh(o),$h(h.get(a),s)}function kl(r,a){let s=String(r||"").trim(),o=ke().find(S=>Z(S)===s);if(!o||!Bt(o))return;let c=Gi(),h=c.indexOf(s);if(h<0)return;let m=h+a;for(;m>=0&&m<c.length;){let S=c[m],w=ke().find(A=>Z(A)===S);if(S!=="cover"&&!w?.locked)break;m+=a}if(m<0||m>=c.length||c[m]==="cover")return;let[v]=c.splice(h,1);c.splice(m,0,v),yl(c),Te("Urutan section diperbarui"),vl(c,s,a<0?"up":"down")}function Ph(r,a,s){let o=String(r||"").trim(),c=String(a||"").trim();if(!o||!c||o===c)return;let h=ke(),m=h.find(ne=>Z(ne)===o),v=h.find(ne=>Z(ne)===c);if(!m||!v||!Bt(m))return;let S=s==="after"?"after":"before";if(c==="cover")S="after";else if(!Bt(v))return;let w=Gi(),A=w.indexOf(o);if(A<0)return;w.splice(A,1);let T=w.indexOf(c);if(T<0)return;let L=T+(S==="after"?1:0);w[0]==="cover"&&(L=Math.max(1,L)),L=Math.min(w.length,L),w.splice(L,0,o);let U=w.indexOf(o);yl(w),Te("Urutan section diperbarui"),vl(w,o,U<A?"up":"down")}function Sl(){let r=Wi();return r?.audio?r.audio:r?.music?r.music:{label:"Audio Undangan",path:"assets.audio"}}function Se(){if(u.contentStateDirty&&!xe())return!1;if(u.lastSerializedConfig="",!Hi())return u.sourceDirty=!0,!1;Ft(()=>{try{fd()&&(u.sourceDirty=!0)}catch{}},200),u.doc=new DOMParser().parseFromString(D("html"),"text/html");let r=u.doc.querySelector("[data-sve-template]")||u.doc.querySelector("main[id]")||u.doc.body.firstElementChild;u.rootSelector=r?.id?"#"+r.id:":root";let a=tn("CONFIG");u.config=a?.obj||null,u.configRange=a||null,u.configSourceText=a?a.editor.getValue().slice(a.start,a.end):"",u.configOwnerSource=a?a.editor.getValue():"";let s=tn("SVE_SCHEMA");return u.schema=s?.obj||null,u.contentSearchIndex=null,u.contentFieldCache=new WeakMap,u.repeaterContentFieldCache=new WeakMap,u.fallbackSchemaCache=null,u.fallbackSchemaReady=!1,u.contentSectionHtmlCache.clear(),u.contentPrewarmCursor=0,u.contentPrewarmScheduled&&(ol(u.contentPrewarmHandle),u.contentPrewarmScheduled=!1,u.contentPrewarmHandle=null),Mh(),u.sourceDirty=!1,u.uiPrepared=!1,!0}function Te(r){return ci(r,{deferPreview:!0,syncImages:!0})?(Se(),!0):!1}function Ki(r){return ci(r,{deferPreview:!0,syncImages:!0})}function Nh(r,a){let s=r._handlers?.change;if(!Array.isArray(s))return a();let o=[];s.forEach((c,h)=>{c?.__sve||(o.push([h,c]),s[h]=()=>{})});try{return a()}finally{o.forEach(([c,h])=>{Array.isArray(s)&&(s[c]=h)})}}function ci(r,a={}){if(!u.config||!u.configRange?.editor)return!1;let s=Gd(u.config);if(s.length)return ui(s[0]),!1;let c=u.configRange.editor.getValue()===u.configOwnerSource?u.configRange:tn("CONFIG");if(!c||c.editor!==u.configRange.editor)return ui("CONFIG berpindah atau tidak terbaca. Periksa source sebelum melanjutkan."),!1;let h=c.editor,m=typeof h.getTextArea=="function"?h.getTextArea():null;if(m&&!Ue(m)){let T=u.config,L=Se(),U=u.configRange?.editor,ne=U&&typeof U.getTextArea=="function"?U.getTextArea():null;return!L||!ne||!Ue(ne)?(ui("Editor Scalev sudah dimuat ulang. Muat ulang panel (tombol Muat ulang source) lalu ulangi perubahan."),!1):(u.config=T,ci(r,a))}let v=h.getValue();if(v.slice(c.start,c.end)!==u.configSourceText)return ui("CONFIG berubah di editor kode. Muat ulang panel setelah menyelesaikan perubahan source."),!1;let S=JSON.stringify(u.config,null,2).replace(/</g,"\\u003c");if(S===u.configSourceText)return u.contentStateDirty=!1,u.commitError="",document.getElementById(e+"-commit-notice")?.setAttribute("hidden",""),!0;let w=null,A=a.wakeScalev!==!0&&pi.supported()===!0;try{u.internalEditorWrite+=1;let T=()=>h.operation(()=>{if(typeof h.replaceRange=="function"&&typeof h.posFromIndex=="function")h.replaceRange(S,h.posFromIndex(c.start),h.posFromIndex(c.end));else{let L=h.getValue?.()||"",U=L.slice(0,c.start)+S+L.slice(c.end);h.setValue(U)}h.save?.()});A?Nh(h,T):T(),(a.wakeScalev||!A)&&zi(h,!1)}catch(T){w=T}finally{u.internalEditorWrite=Math.max(0,u.internalEditorWrite-1)}if(w){u.internalEditorWrite+=1;try{h.getValue()!==v&&h.setValue(v),zi(h,!1)}catch{}finally{u.internalEditorWrite-=1}return ui("Perubahan belum tersimpan: "+w.message),!1}return c.end=c.start+S.length,c.obj=u.config,u.configRange=c,u.configSourceText=S,u.configOwnerSource=h.getValue(),u.lastSerializedConfig=S,u.sourceDirty=!1,u.contentStateDirty=!1,u.commitError="",document.getElementById(e+"-commit-notice")?.setAttribute("hidden",""),Yi(),u.performance.configCommitCount=(u.performance.configCommitCount||0)+1,Oh(),a.deferPreview?Yh({syncImages:!!a.syncImages}):ze({syncImages:!!a.syncImages}),!0}function ui(r){u.commitError=r,u.contentStateDirty=!0;let a=document.getElementById(e+"-commit-notice");a&&(a.hidden=!1,a.querySelector("p").textContent=r);let s=document.getElementById(e+"-update-status");s&&(s.textContent=r)}function Yi(){u.managedSources=Object.fromEntries(["html","css","js","head"].map(r=>[r,D(r)]))}function wl(){return e+":fresh-default:"+location.origin+location.pathname}function rn(){let r=["html",D("html"),"css",D("css"),"js",D("js"),"head",D("head")].join("\u241E"),a=2166136261;for(let s=0;s<r.length;s++)a^=r.charCodeAt(s),a=Math.imul(a,16777619);return(a>>>0).toString(16).padStart(8,"0")}function Rh(){let r={};return _.forEach(([,,a])=>{let s=be(a);s&&(r[a]=s)}),oe.forEach(a=>{r[a.variable]=be(a.variable)||a.fallback}),Pe.forEach(({variable:a})=>{let s=be(a);s&&(r[a]=s)}),{version:t,config:u.config?gt(u.config):null,cssTokens:r,googleFonts:gt(B(u.config,"editorStyle.googleFonts")||{})}}function Cl(){try{let r=JSON.parse(localStorage.getItem(wl())||"null");return r&&typeof r=="object"?r:null}catch{return null}}function El(r){try{localStorage.setItem(wl(),JSON.stringify(r))}catch{}}function Al(){if(!u.config)return!1;let r=rn(),a=Rh();return u.defaults=a,u.defaultConfig=gt(a.config||u.config),u.baselineFingerprint=r,u.lastManagedFingerprint=r,Yi(),El({version:t,defaults:a,baselineFingerprint:r,lastManagedFingerprint:r}),!0}function Fh(r){let a=r?.cssTokens;return!a||typeof a!="object"?!1:Pe.every(({variable:s})=>typeof a[s]=="string"&&a[s].trim()!=="")}function Mh(){if(!u.config||u.defaults&&u.managedSources&&Object.entries(u.managedSources).every(([s,o])=>D(s)===o))return;let r=rn(),a=Cl();if(a?.defaults&&a.lastManagedFingerprint===r&&Fh(a.defaults)){u.defaults=a.defaults,u.defaultConfig=gt(a.defaults.config||u.config),u.baselineFingerprint=a.baselineFingerprint||r,u.lastManagedFingerprint=r,Yi();return}Al()}function Tl(){if(!u.defaults||u.managedSources&&!Object.entries(u.managedSources).every(([s,o])=>D(s)===o))return;let r=rn(),a=Cl()||{};u.lastManagedFingerprint=r,El({version:t,defaults:a.defaults||u.defaults,baselineFingerprint:a.baselineFingerprint||u.baselineFingerprint||r,lastManagedFingerprint:r})}let Oh=si(Tl,700);function Dh(){clearTimeout(u.freshBaselineTimer),u.freshBaselineTimer=setTimeout(()=>{if(!u.internalEditorWrite)try{Se(),Al(),u.open?ce():Ui()}catch{}},420)}function Vh(){u.allEditors.forEach(r=>{if(!r||u.editorChangeBound.has(r)||typeof r.on!="function")return;u.editorChangeBound.add(r);let a=()=>{u.internalEditorWrite||(u.sourceDirty=!0,u.uiPrepared=!1,Dh())};a.__sve=!0,r.on("change",a)})}function bx(r){u.defaultConfig&&(He(u.config,r,gt(B(u.defaultConfig,r))),Te("Berhasil direset"),ce())}let Bh="https://wedding-guestbook.nikahin.workers.dev/admin/reveal",jh="https://nikahin.myscalev.com/dashboard",nn="nikahin_team_key";function Uh(){try{return typeof GM_getValue!="function"?"":String(GM_getValue(nn,"")||"").trim()}catch{return""}}function Hh(r){try{return typeof GM_setValue!="function"?!1:(GM_setValue(nn,String(r||"").trim()),!0)}catch{return!1}}function zh(){try{return typeof GM_setValue!="function"?!1:(GM_setValue(nn,""),!0)}catch{return!1}}let Wh={unauthorized:"Kunci tim salah. Perbaiki lalu coba lagi.",team_key_not_configured:"Worker belum punya TEAM_KEY.",pin_secret_not_configured:"Worker belum punya PIN_SECRET.",pin_set_manually:"PIN undangan ini diatur manual. Pakai Buat PIN baru kalau memang ingin menggantinya.",invalid_wedding_id:"Slug undangan tidak valid.",rate_limited:"Terlalu sering. Tunggu beberapa menit."};function an(){return Ct(u.scalevSlug||Et())||""}async function sn(r){let a=u.dashboardPin;if(a.busy)return;let s=an();if(!s){a.status="error",a.message="Slug URL belum diisi di Pengaturan Scalev.",lt();return}let o=Uh();if(!o){a.status="needkey",a.message="",lt();return}if(!(r==="generate"&&a.pin&&!window.confirm("Buat PIN baru untuk "+s+`?

PIN lama langsung tidak berlaku. Kalau sudah dikirim ke klien, PIN baru ini harus dikirim ulang.`))){a.busy=!0,a.status="loading",a.message="",lt();try{let h=await(await en(Bh,{method:"POST",headers:{"Content-Type":"application/json","x-team-key":o},body:JSON.stringify({weddingId:s,mode:r==="generate"?"generate":"peek"})})).json();!h||h.ok!==!0?(a.status="error",a.pin="",a.message=Wh[h&&h.error]||"Gagal mengambil PIN."):(a.status="ready",a.slug=s,a.pin=String(h.pin||""),a.version=Number(h.version)||0,a.message=h.regenerated?"PIN baru dibuat. Kirim ulang ke klien.":"")}catch{a.status="error",a.pin="",a.message="Tidak bisa menghubungi server."}a.busy=!1,lt()}}function Gh(){let r=k("#"+e+"-team-key"),a=r?r.value.trim():"",s=u.dashboardPin;if(!a){s.message="Kunci tim belum diisi.",lt();return}if(!Hh(a)){s.message="Tampermonkey menolak menyimpan kunci.",lt();return}s.status="idle",s.message="",sn("peek")}function qh(){let r=u.dashboardPin;if(!zh()){r.message="Tampermonkey menolak menghapus kunci.",lt();return}r.status="needkey",r.pin="",r.version=0,r.message="",lt()}async function Kh(){let r=u.dashboardPin;if(r.pin){try{await navigator.clipboard.writeText(r.pin),r.message="PIN tersalin."}catch{r.message="Gagal menyalin. Salin manual dari kolom PIN."}lt()}}function lt(){let r=document.activeElement?.id,a=k("#"+e+"-pin-panel");a&&(a.innerHTML=_l());let s=k("#"+e+"-pin-pill");s&&(s.outerHTML=Bl()),r?.startsWith(e+"-pin-")&&document.getElementById(r)?.focus({preventScroll:!0})}function _l(){let r=u.dashboardPin,a=an(),s=m=>m?`<small class="auto-wedding-id-note">${E(m)}</small>`:"";if(!a)return`
        <input
    ...
    `}function Il(){u.defaults&&(u.defaults.config&&(u.config=gt(u.defaults.config),Te()),Object.entries(u.defaults.cssTokens||{}).forEach(([r,a])=>{a&&Re(r,a)}),Ql(),Te(),ir(),Se(),ce(),ze())}function Yh({syncImages:r=!1,delay:a=100}={}){ze({syncImages:r})}let pi=Kp({document,window,getConfig:()=>u.config,syncImages:md,metrics:u.performance});function ze({syncImages:r=!1,force:a=!1}={}){pi.request({images:r,force:a})}function Qh(r){if(!r)return"";let a=new Date(r);if(Number.isNaN(a.getTime()))return"";let s=o=>String(o).padStart(2,"0");return a.getFullYear()+"-"+s(a.getMonth()+1)+"-"+s(a.getDate())+"T"+s(a.getHours())+":"+s(a.getMinutes())}function Zh(r){if(!r)return"";let a=new Date(r),s=h=>String(h).padStart(2,"0"),o=-a.getTimezoneOffset(),c=o>=0?"+":"-";return r+":00"+c+s(Math.floor(Math.abs(o)/60))+":"+s(Math.abs(o)%60)}function be(r,a){let s=a?[a]:[on()],o=r.replace(/[.*+?^${}()|[\]\\]/g,"\\$&"),c=new RegExp(o+"\\s*:\\s*([^;{}]+);");for(let h of s){let m=c.exec(h||"");if(m)return m[1].trim()}return""}function hi(r,a){let s=a.replace(/[.*+?^${}()|[\]\\]/g,"\\$&");return new RegExp(s+"\\s*:\\s*[^;{}]+;").test(r||"")}function on(){let r=[],a=D("css");return a&&r.push(a),[D("html"),D("head")].forEach(s=>{let o=String(s||""),c=/<style\b[^>]*>([\s\S]*?)<\/style>/gi,h;for(;h=c.exec(o);)h[1]&&r.push(h[1])}),r.join(`
`)}function Jh(r){let a=String(r||"").trim(),s=a.match(/^#([0-9a-f]{3}|[0-9a-f]{6})$/i);if(s){let c=s[1];c.length===3&&(c=c.split("").map(m=>m+m).join(""));let h=parseInt(c,16);return[h>>16&255,h>>8&255,h&255].join(", ")}let o=a.match(/^rgba?\(\s*(\d{1,3})\s*[,\s]\s*(\d{1,3})\s*[,\s]\s*(\d{1,3})/i);return o?[o[1],o[2],o[3]].join(", "):""}function Ll(r,a,s){let o=a.replace(/[.*+?^${}()|[\]\\]/g,"\\$&"),c=new RegExp("("+o+"\\s*:\\s*)([^;{}]+)(;)","g");return String(r||"").replace(c,"$1"+s+"$3")}function $l(r,a){let s=o=>{if(o)try{o.documentElement?.style?.setProperty(r,a),o.body?.style?.setProperty(r,a),o.querySelector("[data-sve-template]")?.style?.setProperty(r,a)}catch{}};C("iframe").forEach(o=>{try{s(o.contentDocument)}catch{}})}function Re(r,a){let s=["css","head","html"],o=null;for(let S of s)if(hi(D(S),r)){o=S;break}if(!o)return!1;let c=D(o),h=Ll(c,r,a),m=r+"-rgb",v=Jh(a);return v&&hi(c,m)&&(h=Ll(h,m,v)),h===c?!1:(ot(o,h),$l(r,a),v&&hi(c,m)&&$l(m,v),ze(),!0)}function Qi(r){return String(u.defaults?.cssTokens?.[r]||"").trim()}function le(r){let a=String(r?.type||"text").trim().toLowerCase();return a==="datetime-local"?"datetime":a==="checkbox"?"boolean":a}function Xh(r,a){return r?.readOnly===!0||r?.readonly===!0||r?.locked===!0||Yr(r,a)}function Pl(r){if(r&&Object.prototype.hasOwnProperty.call(r,"default"))return gt(r.default);let a=le(r);return a==="boolean"?!1:""}function ed(r){return(Array.isArray(r?.options)?r.options:[]).map(s=>{if(s&&typeof s=="object"&&!Array.isArray(s)){let o=s.value??s.id??s.key??"";return{value:String(o),label:String(s.label??s.name??o)}}return{value:String(s??""),label:String(s??"")}})}function td(r){let a=[];return["min","max","step","maxlength","minlength","pattern"].forEach(s=>{r?.[s]!==void 0&&r?.[s]!==null&&String(r[s])!==""&&a.push(`${s}="${E(r[s])}"`)}),r?.placeholder&&a.push(`placeholder="${E(r.placeholder)}"`),a.join(" ")}function id(r){let a=String(r?.help||r?.description||"").trim();return a?`
        <small class="field-help">
          ${E(a)}
        </small>
      `:""}function rd(r,a){let s=B(u.config,a),o=le(r),c=Yr(r,a),h=Xh(r,a),m=c?Et()||s||"":s??"",v=`data-field-path="${E(a)}" data-field-type="${E(o)}" aria-label="${E(r?.label||a)}" `+(h?'data-field-readonly="1" ':""),S=td(r);if(o==="textarea")return`
        <textarea
      ...
      ${c?`
          ...
          `:""}
    `}function Nl(r,a){let s=a||r.path,o=E(r.label||s);return`
      <div class="field">
    ...
    `}function di(r){if(!r)return!1;if(r.type==="image"||r.type==="repeater-image"||r.media==="image"||r.kind==="image")return!0;let a=String(r.key||(r.path?r.path.split(".").pop():"")).trim().toLowerCase();if(new Set(["image","img","photo","foto","picture","gambar","art","avatar","logo","thumbnail","thumb","poster","coverphoto","covercard","qr","qris","src"]).has(a))return!0;let o=String(r.label||"").trim().toLowerCase();return/(?:^|\s)(?:foto|photo|image|gambar|logo|thumbnail|poster|qr|qris|ilustrasi)(?:\s|$)/i.test(o)}function Rl(r){if(!r||typeof r!="object")return[];let a=u.repeaterContentFieldCache.get(r);if(a)return a;let s=(r?.fields||[]).filter(o=>le(o)!=="repeater"&&le(o)!=="repeater-image");return u.repeaterContentFieldCache.set(r,s),s}function nd(r){if(Fl(r,B(u.config,r.path)))return Pl(r.fields[0]);let a={};return(r.fields||[]).forEach(s=>{s?.key&&(a[s.key]=Pl(s))}),a}function Fl(r,a){if(r?.fields?.length!==1)return!1;if(r.itemType==="primitive")return!0;let s=Array.isArray(a)&&a.length?a:B(u.defaultConfig,r.path);return Array.isArray(s)&&s.length>0&&s.every(o=>typeof o=="string"||typeof o=="number")}function ad(r,a,s){let o=String(r?.itemLabelKey||"").trim(),h=[o?a?.[o]:"",a?.title,a?.name,a?.label,a?.event,a?.provider].find(m=>String(m??"").trim());return String(h??"").trim()||(r.label||"Item")+" "+(s+1)}function sd(r){return(r?.fields||[]).some(s=>le(s)==="repeater"||le(s)==="repeater-image")?`
      <div class="notice repeater-warning">
        Nested repeater tidak didukung.
        Flat-kan data menjadi repeater satu level.
      </div>
    `:""}function od(r,a=null){let s=B(u.config,r.path),o=Array.isArray(s)?s:[],c=Number.isFinite(r.max)?r.max:999;return sd(r)+o.map((h,m)=>`
          <div class="repeat-item">
            ...
            ${Rl(r).map(v=>{let S=Fl(r,o)?r.path+"."+m:r.path+"."+m+"."+v.key;if(di(v)){let w=a?.get(S);return w?dn(w):""}return Nl({...v,type:v.type||"text"},S)}).join("")}
          </div>
    ...
    `}function Zi(r){if(!r||typeof r!="object")return[];let a=u.contentFieldCache.get(r);if(a)return a;let s=(r.fields||[]).filter(o=>!(o.type==="repeater"&&Rl(o).length===0));return u.contentFieldCache.set(r,s),s}function cd(){if(u.contentSearchIndex)return u.contentSearchIndex;let r=new Map;return li().forEach(a=>{let s=Z(a),o="";try{o=JSON.stringify(a).toLowerCase()}catch{o=[s,a?.label||"",...Zi(a).flatMap(h=>[h?.label||"",h?.path||"",...(h?.fields||[]).flatMap(m=>[m?.label||"",m?.key||""])])].join(" ").toLowerCase()}r.set(s,o)}),u.contentSearchIndex=r,r}function Ji(r){r&&u.contentSectionHtmlCache.delete(String(r))}function Xi(r){let a=Z(r);if(!a)return Ml(r);if(u.contentSectionHtmlCache.has(a))return u.contentSectionHtmlCache.get(a);let s=Ml(r);return u.contentSectionHtmlCache.set(a,s),s}function jt(r){r&&(u.contentSectionUseTick+=1,r.dataset.contentUse=String(u.contentSectionUseTick))}function ln(r){if(!r)return;let a=C("[data-section-card]",r).filter(o=>k("[data-section-body]",o)?.dataset.loaded==="1"),s=a.length-u.contentMaxMountedSections;s<=0||a.filter(o=>!o.classList.contains("open")).sort((o,c)=>Number(o.dataset.contentUse||0)-Number(c.dataset.contentUse||0)).slice(0,s).forEach(o=>{let c=k("[data-section-body]",o);c&&(c.replaceChildren(),c.dataset.loaded="0")})}function ud(){if(u.contentPrewarmScheduled||!u.config||!Wi())return;let r=li();if(!r.length)return;u.contentPrewarmScheduled=!0;let a=s=>{u.contentPrewarmScheduled=!1,u.contentPrewarmHandle=null;let o=2;for(;u.contentPrewarmCursor<r.length&&o>0;){let c=r[u.contentPrewarmCursor++],h=Z(c);if(h&&!u.contentSectionHtmlCache.has(h)&&Xi(c),o-=1,s&&!s.didTimeout&&typeof s.timeRemaining=="function"&&s.timeRemaining()<5)break}u.contentPrewarmCursor<r.length&&(u.contentPrewarmScheduled=!0,u.contentPrewarmHandle=Ft(a,1200))};u.contentPrewarmHandle=Ft(a,1200)}function Ml(r){let a=Zi(r),s=new Map(hn(r).map(m=>[m.path,m])),o=[],c="",h=m=>{let v=String(m||"").trim();return!v||v===c?"":(c=v,`
        <div class="sv-category" data-sv-category="${E(v)}">
          ${E(v)}
        </div>
      `)};return a.forEach(m=>{let v=String(m.category||"").trim();if(v||(c=""),di(m)&&le(m)!=="repeater-image"){let S=s.get(m.path);S&&o.push(h(v)+dn(S));return}if(le(m)==="repeater-image"){let S=Array.isArray(B(u.config,m.path))?B(u.config,m.path):[],w=Number.isFinite(m.max)?m.max:999,A=[...s.values()].filter(L=>L.rootPath===m.path).map(dn).join(""),T=m.canAdd!==!1&&S.length<w?`
              <button
                type="button"
                class="button full"
          ...
          <div class="group">
            ...
            <div class="group-body">
              ${Nl({...m,hideVisibleLabel:!0})}
            </div>
          </div>
        `)}),o.join("")}function Ol(r){return li().find(a=>Z(a)===r)||null}function pd(r){if(!r)return;let a=k("[data-section-body]",r);if(!a||a.dataset.loaded==="1")return;let s=Ol(r.dataset.sectionCard);s&&(a.innerHTML=Xi(s),a.dataset.loaded="1",jt(r),ln(r.closest("#"+e+"-body")))}function cn(r){if(!r)return;let a=r.closest("#"+e+"-body");a&&(C("[data-section-card].open",a).forEach(s=>{s!==r&&(s.classList.remove("open"),k(".chev",s)?.setAttribute("aria-expanded","false"),jt(s))}),u.contentOpenSections.clear(),u.contentOpenSections.add(r.dataset.sectionCard),r.classList.add("open"),k(".chev",r)?.setAttribute("aria-expanded","true"),pd(r),jt(r),ln(a))}function Dl(r){if(!r)return;let a=k("[data-section-body]",r),s=Ol(r.dataset.sectionCard);!a||!s||(Ji(r.dataset.sectionCard),a.innerHTML=Xi(s),a.dataset.loaded="1",jt(r))}function Vl(r=""){u.contentStateDirty=!0,r&&(u.contentCommitMessage=r),clearTimeout(u.contentCommitTimer),u.contentCommitTimer=setTimeout(()=>{u.contentCommitTimer=null;let a=u.contentCommitMessage;u.contentCommitMessage="",ci(a||void 0,{validate:!1,deferPreview:!0})},100)}function xe(r=""){let a=!!u.contentCommitTimer||!!u.contentCommitMessage||u.contentStateDirty;clearTimeout(u.contentCommitTimer),u.contentCommitTimer=null;let s=r||u.contentCommitMessage;return u.contentCommitMessage="",!a&&!r?!0:ci(s||void 0,{validate:!0,deferPreview:!0})}function Bl(){let r=u.dashboardPin,a=an(),s=r.status==="ready"&&r.pin&&r.slug===a,o="Belum diambil",c="idle";return a?r.busy||r.status==="loading"?(o="Memuat\u2026",c="loading"):r.status==="needkey"?(o="Perlu kunci",c="warn"):r.status==="error"?(o="Gagal",c="error"):s&&(o="Aktif",c="ok"):o="Slug kosong",`<span id="${e}-pin-pill" class="pin-pill ${c}">${o}</span>`}function jl(){if(!u.config)return fi();if(!Wi())return ld();let r=li(),a=cd(),s=r.filter(o=>u.search?(a.get(Z(o))||"").includes(u.search):!0);return`
      <div class="pin-zone">
        <div class="pin-zone-head">
          <span class="pin-zone-title">PIN Dashboard</span>
          ${Bl()}
        </div>
        <div id="${e}-pin-panel" aria-live="polite">${_l()}</div>
      </div>
    ...
    `}function un(){return ke().flatMap(r=>r.fields||[]).filter(r=>le(r)==="repeater-image"&&r?.path)}function xx(){return un()[0]||null}function hd(r){let a=String(r||"").trim();return a&&un().find(s=>String(s.path||"").trim()===a)||null}function pn(r){let a=Array.isArray(r?.fields)?r.fields:[];return a.find(s=>s?.key&&di(s))||a.find(s=>s?.key&&String(s.key).toLowerCase()==="src")||{key:"src",label:"Foto",type:"image"}}function Ul(r){let a=String(r||"").trim();if(!a)return null;for(let s of un()){let o=String(s.path||"").trim(),c=o+".";if(!o||!a.startsWith(c))continue;let h=a.slice(c.length).split(".");if(h.length!==2)continue;let m=Number(h[0]);if(!Number.isInteger(m)||m<0)continue;let v=pn(s),S=String(v?.key||"src");if(h[1]===S)return{field:s,imageField:v,imageKey:S,rootPath:o,index:m}}return null}function Hl(r){return u.doc?!!C('[data-sve-type="image"][data-sve-field]',u.doc).find(s=>s.getAttribute("data-sve-field")===r)?.closest("[data-sve-image-wrapper]"):!1}function hn(r){let a=[],s=new Set;return(r?[r]:ke()).forEach(o=>{(o.fields||[]).forEach(c=>{if(di(c)&&c.type!=="repeater-image"&&c.path&&!s.has(c.path)&&(a.push({label:c.label||Ot(c.path),path:c.path,gallery:!1,wrapped:Hl(c.path)}),s.add(c.path)),c.type==="repeater"&&c.path){let h=B(u.config,c.path),m=(c.fields||[]).filter(v=>di(v)&&v.key);Array.isArray(h)&&m.length&&h.forEach((v,S)=>{m.forEach(w=>{let A=c.path+"."+S+"."+w.key;s.has(A)||(a.push({label:(o.label||c.label||Ot(c.path))+" "+(S+1)+" \xB7 "+(w.label||Ot(w.key)),path:A,gallery:!1,wrapped:Hl(A)}),s.add(A))})})}if(le(c)==="repeater-image"&&c.path){let h=B(u.config,c.path),m=pn(c),v=String(m?.key||"src");Array.isArray(h)&&h.forEach((S,w)=>{let A=c.path+"."+w+"."+v;s.has(A)||(a.push({label:(c.label||"Foto Gallery")+" "+(w+1),path:A,gallery:!0,index:w,rootPath:c.path,imageKey:v,wrapped:!0}),s.add(A))})}})}),u.doc&&C('[data-sve-type="image"][data-sve-field]',u.doc).forEach(o=>{let c=o.getAttribute("data-sve-field");if(!c||s.has(c))return;let h=Ul(c),m=!!h;a.push({label:o.getAttribute("data-sve-label")||Ot(c),path:c,gallery:m,index:h?h.index:null,rootPath:h?h.rootPath:null,imageKey:h?h.imageKey:null,wrapped:!!o.closest("[data-sve-image-wrapper]")}),s.add(c)}),a}function zl(){return(!u.config.imageSettings||typeof u.config.imageSettings!="object"||Array.isArray(u.config.imageSettings))&&(u.config.imageSettings={}),u.config.imageSettings}function Ut(r){let a=u.config?.imageSettings,s=a&&typeof a=="object"?a[r]:null,o=Ul(r);return{width:Math.max(0,Math.min(100,Number(s?.width??100)||0)),align:["left","center","right"].includes(s?.align)?s.align:"center",fit:Xp(s?.fit),alignPos:qr.includes(s?.alignPos)?s.alignPos:"default",hidden:s?.hidden===!0}}function Ht(r,a){let s=zl();s[r]={...Ut(r),...a}}function dd(){let r=u.config?.imageSettings;if(!r||typeof r!="object")return;let a=new Set(hn().map(s=>s.path));Object.keys(r).forEach(s=>{a.has(s)||delete r[s]})}function fd(){let r=D("css");if(!r)return;let a=r.replace(/(?:\r?\n)*\/\*\s*SVE\d+\s+IMAGE DESIGN START\s*\*\/[\s\S]*?\/\*\s*SVE\d+\s+IMAGE DESIGN END\s*\*\/(?:\r?\n)*/g,`
`).replace(/\n{3,}/g,`

`).trim();return a!==r.trim()?(ot("css",a),!0):!1}function md(r){if(!r||!u.config)return;Array.from(r.querySelectorAll('[data-sve-type="image"][data-sve-field]')).forEach(s=>{let o=s.getAttribute("data-sve-field");if(!o)return;let c=Ut(o),h=s.closest("[data-sve-image-wrapper]"),m=h||s,v=c.align==="left"?"0":"auto",S=c.align==="right"?"0":"auto";h?(h.style.display=c.hidden?"none":"",h.style.width=c.width+"%",h.style.maxWidth="100%",h.style.marginLeft=v,h.style.marginRight=S,s.style.width="100%"):(s.style.display=c.hidden?"none":"",s.style.width=c.width+"%",s.style.maxWidth="100%",s.style.marginLeft=v,s.style.marginRight=S),c.fit==="auto"?s.style.removeProperty("object-fit"):s.style.objectFit=c.fit;let w=Jp[c.alignPos]||"";w?s.style.objectPosition=w:s.style.removeProperty("object-position"),s.style.height="100%"})}function yx(){pi.request({images:!0})}function gd(r){let a={"top left":`
    ...
    `}function bd(r){let a=Ut(r.path),s=c=>c==="left"?`
          <svg
            width="1em"
            height="1em"
            viewBox="0 0 21 20"
    ...
    `}function Sd(r,a){let s=B(u.config,r);if(!Array.isArray(s)||a<0||a>=s.length)return;let o=hd(r),c=pn(o),h=String(c?.key||"src"),m=zl(),v={};for(let S=0;S<s.length;S++){let w=r+"."+S+"."+h;Object.prototype.hasOwnProperty.call(m,w)&&(v[S]=gt(m[w]))}s.splice(a,1),Object.keys(m).forEach(S=>{S.startsWith(r+".")&&S.endsWith("."+h)&&delete m[S]});for(let S=0;S<s.length;S++){let w=S<a?S:S+1,A=v[w];A&&(m[r+"."+S+"."+h]=A)}dd(),Te("Foto gallery dihapus"),ce()}function wd(r){u.config&&(He(u.config,r,""),Ht(r,{hidden:!0}),Te("Gambar dihapus"),ce())}function dn(r){let a=B(u.config,r.path)||"",s=Ut(r.path),c=`
    ...
    `}function Td(){return u.config?Ed()?["Background","Body Teks","Button Primary","Button Secondary"].map(a=>`
            <div class="group">
              <div class="group-title">
                ${a}
              </div>

              ${_.filter(s=>s[0]===a).map(([,s,o])=>Ad(s,o)).join("")}
            </div>
          `).join("")+`
        <button
          type="button"
...
`+c+`
`,ot("head",m)}let h=document.getElementById(e+"-font-link");h||(h=document.createElement("link"),h.id=e+"-font-link",h.rel="stylesheet",document.head.appendChild(h)),h.href=r,Gl()}async function rr(r){let a=k("#"+e+"-"+r+"-font");if(!a)return;let s=Id(a.value);if(!s.valid||!s.family)return;let o=s.family;a.value=o;let c=await $d(o,r);if(!c.ok){c.reason==="stylesheet"||c.reason==="font-file"||c.reason;return}let h=r==="heading"?"--sve-font-heading":"--sve-font-body",m=r==="heading"?"--sve-heading-weight":"--sve-body-weight";c.normalizedWeight&&c.weight&&Re(m,c.weight),He(u.config,"editorStyle.googleFonts."+r,o),Te(),Re(h,`"${o}", ${Pd(o,r)}`),Md(r,!1),ir(),Gl(),ze()}function nr(r,a,s=!0,o=!1){let c=String(r||"").trim(),h=s&&c&&!a.includes(c)?[c,...a]:[...a];return o&&(h=[...new Set(h)].sort((m,v)=>{let S=Number.parseFloat(m),w=Number.parseFloat(v);return Number.isFinite(S)&&Number.isFinite(w)?S-w:String(m).localeCompare(String(v))})),h.map((m,v)=>{let S=a.includes(c)||s?m===c:v===0;return`
            <option
              value="${E(m)}"
              ${S?"selected":""}
            >
          ...
          `}).join("")}function Od(r){let a=be(r.variable)||r.fallback;if(r.type==="size")return`
        <select
          class="style-select"
      ...
      `;if(r.type==="weight"){let s=Nd(r.variable),o=s?Fd(s):Y,c=s?tr(s,a):a;return`
        <select
          class="style-select"
          data-style-var="${E(r.variable)}"
        >
      ...
      `}return""}function Ql(){if(!u.config)return!1;let r=u.defaults?.cssTokens||{},a=!1;return Pe.forEach(({target:s,variable:o})=>{let c=typeof r[o]=="string"?r[o].trim():"",h=B(u.config,"editorStyle.googleFonts."+s),m=typeof h=="string"&&h.trim()!=="";c&&(Re(o,c),a=!0),m&&(He(u.config,"editorStyle.googleFonts."+s,""),a=!0)}),a}function Dd(){u.config&&(Ql(),oe.forEach(r=>{let a=Qi(r.variable)||r.fallback;Re(r.variable,a)}),Te(),ir(),ce())}function Vd(){return u.config?`
      <div class="group">
        <div class="group-title">
          Font Heading
        </div>
      ...
      <details class="group typography-dropdown">
        ...
        <div class="typography-body">
          ${ge.map(r=>{let a=oe.filter(s=>s.role===r.key);return`
    ...
    `}function sr(r,a){(Array.isArray(r)?r:[]).forEach(s=>{a(s),le(s)==="repeater"&&sr(s.fields,a),le(s)==="repeater-image"&&sr(s.fields,a)})}function Xl(){let r={connect_src:new Set,img_src:new Set,media_src:new Set,font_src:new Set,script_src:new Set,style_src:new Set,frame_src:new Set,worker_src:new Set,manifest_src:new Set},a={html:D("html"),css:D("css"),js:D("js"),head:D("head")},s=(S,w)=>{try{let A=new URL(w,location.origin);if(A.protocol!=="https:"&&A.protocol!=="http:")return;let T=A.origin;if(T===location.origin)return;r[S]?.add(T)}catch{}},o=(S,w)=>{let A=/https?:\/\/[^\s"'<>`)\\]+/g;(String(S||"").match(A)||[]).forEach(T=>s(w,T))};try{let S=new DOMParser().parseFromString(a.html||"","text/html");S.querySelectorAll("img[src], source[src], source[srcset]").forEach(w=>{s("img_src",w.getAttribute("src")||w.getAttribute("srcset")||"")}),S.querySelectorAll("audio[src], video[src]").forEach(w=>s("media_src",w.getAttribute("src")||"")),S.querySelectorAll("iframe[src]").forEach(w=>s("frame_src",w.getAttribute("src")||"")),S.querySelectorAll("script[src]").forEach(w=>s("script_src",w.getAttribute("src")||"")),S.querySelectorAll('link[rel="stylesheet"][href]').forEach(w=>s("style_src",w.getAttribute("href")||"")),S.querySelectorAll('link[rel="manifest"][href]').forEach(w=>s("manifest_src",w.getAttribute("href")||""))}catch{}let c=/url\(\s*["']?(https?:\/\/[^)"']+)["']?\s*\)/g,h;for(;h=c.exec((a.css||"")+`
`+(a.head||""));){let S=h[1];/fonts\.gstatic\.com/i.test(S)?s("font_src",S):s("img_src",S)}o(a.head,"style_src");let m=JSON.stringify(u.config||{}),v=B(u.config,"guestbook.endpoint");return v&&s("connect_src",v),["rsvp.endpoint","extensions.rsvpBackend.endpoint"].forEach(S=>{let w=B(u.config,S);w&&s("connect_src",w)}),(m.match(/https?:\/\/[^"\\]+/g)||[]).forEach(S=>{/youtube\.com|youtu\.be/i.test(S)?s("frame_src",S):/\.(?:mp3|m4a|wav|ogg|mp4|webm)(?:\?|$)/i.test(S)?s("media_src",S):/\.(?:woff2?|ttf|otf)(?:\?|$)/i.test(S)?s("font_src",S):/\.(?:png|jpe?g|webp|gif|svg|avif)(?:\?|$)/i.test(S)&&s("img_src",S)}),/fonts\.googleapis\.com/i.test(a.head||"")&&(r.style_src.add("https://fonts.googleapis.com"),r.font_src.add("https://fonts.gstatic.com")),Object.fromEntries(Object.entries(r).map(([S,w])=>[S,Array.from(w).sort()]))}function Ud(){return{"Body HTML":D("html"),CSS:D("css"),JavaScript:D("js"),"Additional Head":D("head"),CONFIG:JSON.stringify(u.config||{})}}function ec(r,a,s){let o=Ud(),c=Qp(o);c.length?r("Gambar base64 terdeteksi di "+rl(c)+"; upload gambar ke hosting lalu pakai URL https"):s("Tidak ada gambar base64");let h=Zp(o);h.length&&a("Data URI berukuran besar di "+rl(h)+"; pertimbangkan pindah ke file hosting")}function Hd(){let r=[],a=[],s=[],o=X=>r.push(X),c=X=>a.push(X),h=X=>s.push(X);if(u.config?h("CONFIG terbaca sebagai static object"):o("CONFIG tidak terbaca"),u.schema?h("SVE_SCHEMA custom page tersedia"):o("SVE_SCHEMA wajib eksplisit"),u.config)try{JSON.stringify(u.config),h("CONFIG JSON-compatible")}catch{o("CONFIG tidak dapat diserialisasi dengan aman")}let m=Array.isArray(u.schema?.sections)?u.schema.sections:[],v=m.map(Z).filter(Boolean),S=new Set(v);m.length||o("SVE_SCHEMA custom page belum memiliki section"),v.length!==S.size&&o("SVE_SCHEMA memiliki duplicate section id");let w=Array.isArray(u.config?.sectionOrder)?u.config.sectionOrder:[],A=new Set(w);w.length!==A.size&&o("CONFIG.sectionOrder memiliki duplicate id"),v.forEach(X=>{A.has(X)||o("sectionOrder belum memuat: "+X)}),m.forEach(X=>{let We=Z(X);X.visiblePath&&(mt(X.visiblePath)||o("Unsafe visiblePath pada section "+We),u.config&&typeof B(u.config,X.visiblePath)!="boolean"&&o("Visibility path harus boolean pada section "+We)),sr(X.fields,_e=>{let bt=le(_e);ai.has(bt)||o("Field type tidak didukung: "+bt+" ("+(_e.path||_e.key||We)+")"),_e.path&&!mt(_e.path)&&o("Unsafe field path: "+_e.path),(bt==="repeater"||bt==="repeater-image")&&!Array.isArray(_e.fields)&&o("Repeater tanpa fields[]: "+(_e.path||We)),bt==="repeater"&&(_e.fields||[]).forEach(yi=>{let yn=le(yi);(yn==="repeater"||yn==="repeater-image")&&o("Nested repeater tidak diizinkan: "+(_e.path||We)),yi.key||o("Repeater subfield tanpa stable key: "+(_e.path||We))})})});let T=["html","css","js","head"].map(D).join(`
`);/\beval\s*\(/.test(T)&&o("eval() terdeteksi"),/\bnew\s+Function\s*\(/.test(T)&&o("new Function() terdeteksi"),/javascript\s*:/i.test(T)&&o("javascript: URL terdeteksi"),/https?:\/\/[^\s"']*scalev\.(?:com|id)\/api\//i.test(T)&&o("Private Scalev API URL terdeteksi"),/(service[_-]?role|database[_-]?password|private[_-]?api[_-]?key|secret[_-]?token)\s*[:=]/i.test(T)&&o("Kemungkinan secret/private credential terdeteksi"),ec(o,c,h);let L=on(),U=oe.map(X=>X.variable).filter(X=>!hi(L,X));U.length?o("Typography role tokens belum lengkap: "+U.join(", ")):h("Semua typography role tokens tersedia");let ne=Xl();return Object.values(ne).reduce((X,We)=>X+We.length,0)&&c("External origin terdeteksi; salin CSP manifest ke Scalev Security"),h("Custom page aktif; validasi "+Je.length+" section wedding dilewati"),{status:r.length?"BLOCKER":a.length?"WARNING":"PASS",blockers:r,warnings:a,passes:s,csp:ne}}let or=null;function tc(){let r=["html","css","js","head"].map(D);if(or&&r.every((o,c)=>o===or.sources[c]))return or.report;let a=new DOMParser().parseFromString(r[0],"text/html");a.head.insertAdjacentHTML("beforeend",r[3]);let s=tl({doc:a,scripts:[r[2],...Array.from(a.querySelectorAll("script"),o=>o.textContent)].filter(Boolean),css:r[1]+`
`+Array.from(a.querySelectorAll("style"),o=>o.textContent).join(`
`)});return or={sources:r,report:s},s}function ic(){let r=tc();if(u.schema?.template?.type==="custom-page"){let F=Hd();return F.blockers=[...new Set([...r.blockers,...F.blockers])],F.blockers.length&&(F.status="BLOCKER"),F}let a=[...r.blockers],s=[],o=[],c=F=>a.push(F),h=F=>s.push(F),m=F=>o.push(F);if(u.config?m("CONFIG terbaca sebagai static object"):c("CONFIG tidak terbaca"),u.schema?m("SVE_SCHEMA eksplisit tersedia"):c("SVE_SCHEMA wajib eksplisit; HTML fallback bukan Strict PASS"),u.config)try{JSON.stringify(u.config),m("CONFIG JSON-compatible")}catch{c("CONFIG tidak dapat diserialisasi dengan aman")}let v=Array.isArray(u.schema?.sections)?u.schema.sections:[],S=v.map(Z).filter(Boolean),w=new Set(S);S.length!==w.size&&c("SVE_SCHEMA memiliki duplicate section id"),Je.forEach(F=>{w.has(F)||c("Canonical section hilang: "+F)}),Je.every(F=>w.has(F))&&m(Je.length+" canonical sections tersedia");let A=Array.isArray(u.config?.sectionOrder)?u.config.sectionOrder:[],T=new Set(A);A.length!==T.size&&c("CONFIG.sectionOrder memiliki duplicate id"),Je.forEach(F=>{T.has(F)||c("sectionOrder belum memuat: "+F)}),A[0]&&A[0]!=="cover"&&c("Cover wajib menjadi section pertama"),Je.filter(F=>F!=="cover").forEach(F=>{typeof B(u.config,"sections."+F)!="boolean"&&c("Boolean visibility tidak valid: sections."+F)}),v.forEach(F=>{let Ie=Z(F);Ie==="cover"?(F.locked!==!0||F.canHide!==!1)&&c("Cover harus locked dan canHide:false"):F.visiblePath&&!mt(F.visiblePath)&&c("Unsafe visiblePath pada section "+Ie),sr(F.fields,Ge=>{let vi=le(Ge);ai.has(vi)||c("Field type tidak didukung: "+vi+" ("+(Ge.path||Ge.key||Ie)+")"),Ge.path&&!mt(Ge.path)&&c("Unsafe field path: "+Ge.path),(vi==="repeater"||vi==="repeater-image")&&!Array.isArray(Ge.fields)&&c("Repeater tanpa fields[]: "+(Ge.path||Ie)),vi==="repeater"&&(Ge.fields||[]).forEach(uc=>{let pc=le(uc);(pc==="repeater"||pc==="repeater-image")&&c("Nested repeater tidak diizinkan: "+(Ge.path||Ie)),uc.key||c("Repeater subfield tanpa stable key: "+(Ge.path||Ie))})})});let L=["html","css","js","head"].map(D).join(`
`);/\beval\s*\(/.test(L)&&c("eval() terdeteksi"),/\bnew\s+Function\s*\(/.test(L)&&c("new Function() terdeteksi"),/javascript\s*:/i.test(L)&&c("javascript: URL terdeteksi"),/https?:\/\/[^\s"']*scalev\.(?:com|id)\/api\//i.test(L)&&c("Private Scalev API URL terdeteksi"),/(service[_-]?role|database[_-]?password|private[_-]?api[_-]?key|secret[_-]?token)\s*[:=]/i.test(L)&&c("Kemungkinan secret/private credential terdeteksi"),ec(c,h,m);let U=D("js");/\bconst\s+CONFIG\s*=/.test(U)||s.push("CONFIG strict canonical sebaiknya memakai const"),/\bconst\s+SVE_SCHEMA\s*=/.test(U)||s.push("SVE_SCHEMA strict canonical sebaiknya memakai const");let ne=B(u.config,"sections.rsvp")===!0,At=B(u.config,"sections.guestbook")===!0,X=String(B(u.config,"rsvp.endpoint")||""),We=B(u.config,"rsvp.enabled"),_e=!!X||We!==void 0;if(ne)if(_e)We!==!0&&c("RSVP & Ucapan visible tetapi rsvp.enabled bukan true"),/^https:\/\//i.test(X)||c("RSVP & Ucapan membutuhkan endpoint HTTPS");else{let F=String(B(u.config,"extensions.rsvpBackend.mode")||"none");if(F!=="none"&&F!=="external"&&c("RSVP backend mode harus none atau external"),F==="external"){let Ie=String(B(u.config,"extensions.rsvpBackend.endpoint")||"");/^https:\/\//i.test(Ie)||c("RSVP external membutuhkan endpoint HTTPS")}else s.push("RSVP backend belum dikonfigurasi; public runtime wajib fail-closed")}if(At){let F=B(u.config,"guestbook.enabled"),Ie=String(B(u.config,"guestbook.endpoint")||"");F!==!0&&c("Ucapan & Doa legacy visible tetapi guestbook.enabled bukan true"),/^https:\/\//i.test(Ie)||c("Ucapan & Doa legacy visible tetapi endpoint HTTPS belum valid")}let bt=on(),yi=oe.map(F=>F.variable).filter(F=>!hi(bt,F));yi.length?c("Typography role tokens belum lengkap: "+yi.join(", ")):m("Semua typography role tokens tersedia"),/(?:\.svw-(?:cover-names|heading|quote-text|person-name|item-title|date-display|count\s+strong|gallery-caption|event-meta|field\s+label|footer-brand|footer-creator|footer-note|btn|kicker))[^\{]*\{[^\}]*font-size\s*:\s*(?!var\()/is.test(bt)&&h("Terdeteksi typography editorial hardcoded; map seluruh teks ke role token --sve-*.");let cc=Xl();return Object.values(cc).reduce((F,Ie)=>F+Ie.length,0)?s.push("External origin terdeteksi; salin CSP manifest ke Scalev Security"):m("Tidak ada external origin wajib dari scanner"),{status:a.length?"BLOCKER":s.length?"WARNING":"PASS",blockers:a,warnings:s,passes:o,csp:cc}}function zd(r){return r==="PASS"?`
    ...
    `}function Wd(){if(!u.config)return fi();let r=ic(),a=(c,h)=>c.length?`<ul>${c.map(m=>`<li>${E(m)}</li>`).join("")}</ul>`:`<p class="compat-empty">${E(h)}</p>`,s=r.status==="PASS"?"Siap":r.status==="WARNING"?"Perlu dicek":"Masalah",o=r.status==="PASS"?"Semua siap":r.status==="WARNING"?"Perlu diperiksa":"Perlu diperbaiki";return`
    ...
    `}function Gd(r){let a=[],s=new WeakSet,o=(c,h="CONFIG")=>{if(c!==null){if(typeof c=="object"){if(s.has(c)){a.push("Referensi berulang: "+h);return}s.add(c)}if(Array.isArray(c)){c.forEach((m,v)=>o(m,h+"."+v));return}if(typeof c=="object"){Object.keys(c).forEach(m=>{z.has(m)&&a.push("Forbidden key: "+h+"."+m),o(c[m],h+"."+m)});return}["string","number","boolean"].includes(typeof c)||a.push("Non-static value: "+h),typeof c=="number"&&!Number.isFinite(c)&&a.push("Non-finite number: "+h)}};o(r);try{JSON.parse(JSON.stringify(r))}catch{a.push("CONFIG gagal round-trip JSON")}return a}function qd(){let r=u.templateLibrary,a=String(u.search||"").trim().toLowerCase(),s=r.templates.filter(h=>a?[h.name].join(" ").toLowerCase().includes(a):!0);r.status==="idle"&&gl().then(()=>{u.tab==="library"&&(u.uiPrepared=!1,ce())});let o=r.error?`
    ...
    `}function Kd(){let r=k("#"+e+"-search");if(!r)return;let a=u.tab==="library";r.placeholder=a?"Cari template...":"Cari section / field...",r.setAttribute("aria-label",a?"Cari template":"Cari section atau field")}function ce(){let r=performance.now(),a=k("#"+e+"-body");if(!a)return;if(u.uiPrepared&&u.renderedTab===u.tab&&u.renderedSearch===u.search){u.performance.skippedTabRenders+=1;return}a.dataset.sveTab=u.tab||"content",u.tab==="library"?a.innerHTML=qd():u.tab==="content"?a.innerHTML=jl():u.tab==="colors"?a.innerHTML=Td():u.tab==="style"?a.innerHTML=Vd():u.tab==="audio"?a.innerHTML=jd():u.tab==="compatibility"?a.innerHTML=Wd():a.innerHTML=jl(),ef(a),Kd(),u.tab==="content"&&ud(),u.uiPrepared=!0,u.renderedTab=u.tab||"content",u.renderedSearch=u.search||"";let s=performance.now()-r;u.performance.renderCount+=1,u.performance.lastRenderMs=Math.round(s*100)/100,u.performance.lastRenderTab=u.renderedTab,s>50&&(u.performance.slowRenders+=1)}function Yd(r,a){return k('[data-image-path="'+CSS.escape(a)+'"]',r)}let Qd="Gambar base64 (copy dari Canva) tidak didukung. Upload gambar ke hosting, lalu paste URL https-nya.";function rc(r){!r||typeof r.setCustomValidity!="function"||(r.setCustomValidity(Qd),r.reportValidity?.(),setTimeout(()=>{r.setCustomValidity("")},4e3))}async function Zd(r,a){let s=Yd(r,a);if(!s)return!1;try{if(!navigator.clipboard||typeof navigator.clipboard.readText!="function")throw new Error("clipboard-unavailable");let o=String(await navigator.clipboard.readText()).trim();return o?o===s.value.trim()?(s.focus({preventScroll:!0}),!0):Gr(o)?(rc(s),!1):(s.value=o,s.dispatchEvent(new Event("change",{bubbles:!0})),s.focus({preventScroll:!0}),!0):!1}catch{return s.focus({preventScroll:!0}),!1}}function Jd(r){let a=String(r.dataset.fieldType||"text"),s=r.value;return a==="boolean"?s=!!r.checked:a==="number"?(s=r.value===""?"":Number(r.value),s!==""&&!Number.isFinite(s)&&(s="")):a==="datetime"&&(s=Zh(r.value)),s}function nc(r){if(!r?.matches?.("[data-field-path]")||r.dataset.autoWeddingId==="1"||r.dataset.fieldReadonly==="1"||r.disabled)return!1;He(u.config,r.dataset.fieldPath,Jd(r));let a=r.closest("[data-section-card]");return Ji(a?.dataset.sectionCard),jt(a),u.contentStateDirty=!0,!0}function ac(r){if(r.dataset.contentDelegated==="1")return;r.dataset.contentDelegated="1";let a=()=>{C(".section.dragging, .section.drag-before, .section.drag-after",r).forEach(s=>{s.classList.remove("dragging","drag-before","drag-after"),delete s.dataset.dropPlacement})};r.addEventListener("click",s=>{let o=s.target.closest("[data-section-up]");if(o){if(s.preventDefault(),s.stopPropagation(),o.disabled)return;xe(),kl(o.dataset.sectionUp,-1);return}let c=s.target.closest("[data-section-down]");if(c){if(s.preventDefault(),s.stopPropagation(),c.disabled)return;xe(),kl(c.dataset.sectionDown,1);return}if(s.target.closest("[data-section-drag]")){s.preventDefault(),s.stopPropagation();return}let h=s.target.closest("[data-repeat-add]");if(h){let w=h.dataset.repeatAdd,A=ke().flatMap(L=>L.fields||[]).find(L=>(L.type==="repeater"||le(L)==="repeater-image")&&L.path===w),T=B(u.config,w);Array.isArray(T)||(He(u.config,w,[]),T=B(u.config,w)),T.push(nd(A||{})),u.contentStateDirty=!0,Ji(h.closest("[data-section-card]")?.dataset.sectionCard),xe("Item ditambahkan"),Dl(h.closest("[data-section-card]"));return}let m=s.target.closest("[data-repeat-delete]");if(m){let w=B(u.config,m.dataset.repeatDelete);if(!Array.isArray(w))return;let A=ke().flatMap(L=>L.fields||[]).find(L=>(L.type==="repeater"||le(L)==="repeater-image")&&L.path===m.dataset.repeatDelete),T=Number.isFinite(A?.min)?A.min:0;if(w.length<=T){xe("Minimal "+T+" item");return}w.splice(Number(m.dataset.repeatIndex),1),u.contentStateDirty=!0,Ji(m.closest("[data-section-card]")?.dataset.sectionCard),xe("Item dihapus"),Dl(m.closest("[data-section-card]"));return}if(s.target.closest("#"+e+"-reset-all")){clearTimeout(u.contentCommitTimer),u.contentCommitTimer=null,u.contentCommitMessage="",u.contentStateDirty=!1,Il();return}if(s.target.closest("#"+e+"-team-key-save")){Gh();return}if(s.target.closest("#"+e+"-pin-peek")){sn("peek");return}if(s.target.closest("#"+e+"-pin-generate")){sn("generate");return}if(s.target.closest("#"+e+"-pin-copy")){Kh();return}if(s.target.closest("#"+e+"-pin-changekey")){qh();return}let S=s.target.closest(".section-head");if(S&&!s.target.closest(".switch-wrap, .section-actions, .section-move-controls, .section-drag-btn")){let w=S.closest("[data-section-card]");if(!w)return;let A=!w.classList.contains("open");w.classList.toggle("open",A);let T=w.dataset.sectionCard;A?cn(w):(u.contentOpenSections.delete(T),k(".chev",w)?.setAttribute("aria-expanded","false"),jt(w),ln(r))}}),r.addEventListener("input",s=>{let o=s.target;o instanceof HTMLElement&&o.matches("[data-field-path]")&&(o.tagName==="SELECT"||o.matches('input[type="checkbox"], input[type="radio"]')||nc(o)&&Vl())}),r.addEventListener("change",s=>{let o=s.target;if(o instanceof HTMLElement){if(o.matches("[data-visible-path]")){He(u.config,o.dataset.visiblePath,o.checked),Vl(o.checked?"Section ditampilkan":"Section disembunyikan");return}nc(o)&&xe("Konten diperbarui")}}),r.addEventListener("dragstart",s=>{let o=s.target.closest("[data-section-drag]");if(!o)return;if(o.disabled||o.getAttribute("draggable")!=="true"){s.preventDefault();return}xe();let c=o.closest("[data-section-card]");c&&(c.classList.add("dragging"),s.dataTransfer.effectAllowed="move",s.dataTransfer.setData("text/plain",c.dataset.sectionCard),typeof s.dataTransfer.setDragImage=="function"&&s.dataTransfer.setDragImage(c,24,24))}),r.addEventListener("dragend",a),r.addEventListener("dragover",s=>{let o=s.target.closest("[data-section-card]");if(!o)return;let c=s.dataTransfer?.getData("text/plain")||k(".section.dragging",r)?.dataset?.sectionCard||"",h=o.dataset.sectionCard;if(!c||c===h)return;let m=ke().find(w=>Z(w)===h);if(h!=="cover"&&!Bt(m))return;s.preventDefault(),s.dataTransfer.dropEffect="move";let v=o.getBoundingClientRect(),S=s.clientY<v.top+v.height/2?"before":"after";h==="cover"&&(S="after"),C(".section.drag-before, .section.drag-after",r).forEach(w=>{w!==o&&(w.classList.remove("drag-before","drag-after"),delete w.dataset.dropPlacement)}),o.dataset.dropPlacement=S,o.classList.toggle("drag-before",S==="before"),o.classList.toggle("drag-after",S==="after")}),r.addEventListener("dragleave",s=>{let o=s.target.closest("[data-section-card]");o&&(s.relatedTarget&&o.contains(s.relatedTarget)||(o.classList.remove("drag-before","drag-after"),delete o.dataset.dropPlacement))}),r.addEventListener("drop",s=>{let o=s.target.closest("[data-section-card]");if(!o)return;let c=s.dataTransfer.getData("text/plain"),h=o.dataset.sectionCard,m=o.dataset.dropPlacement||(h==="cover"?"after":"before");s.preventDefault(),a(),Ph(c,h,m)})}function Xd(r){C("[data-library-import]",r).forEach(a=>{a.onclick=()=>{Th(a.dataset.libraryImport)}}),k("[data-library-clear]",r)?.addEventListener("click",_h),k("[data-library-refresh]",r)?.addEventListener("click",async()=>{await gl(!0),u.uiPrepared=!1,ce()})}function xi(r,a){let s=a+"Delegated";return r.dataset[s]==="1"?!1:(r.dataset[s]="1",!0)}function ef(r){if(u.tab==="library"){Xd(r);return}if(u.tab==="content"){ac(r),tf(r);return}if(u.tab==="colors"){rf(r);return}if(u.tab==="style"){nf(r);return}if(u.tab==="audio"){af(r);return}if(u.tab==="compatibility"){sf(r);return}ac(r)}function tf(r){if(!xi(r,"images"))return;r.addEventListener("click",s=>{let o=s.target.closest("[data-image-paste-path]");if(o){s.preventDefault(),s.stopPropagation(),Zd(r,o.dataset.imagePastePath);return}let c=s.target.closest("[data-image-delete-path]");if(c){wd(c.dataset.imageDeletePath);return}let h=s.target.closest("[data-image-open-advance]");if(h){let A=h.dataset.imageOpenAdvance,T=k(`[data-image-card-path="${CSS.escape(A)}"]`,r),L=T?k(".image-advance",T):null;if(L){let U=!L.open;L.open=U,h.setAttribute("aria-expanded",String(U)),h.setAttribute("aria-label",U?"Tutup pengaturan gambar":"Buka pengaturan gambar"),h.title=U?"Tutup pengaturan gambar":"Pengaturan gambar",h.classList.toggle("active",U),U?L.scrollIntoView({block:"nearest",behavior:"smooth"}):h.closest(".image-card")?.scrollIntoView({block:"nearest",behavior:"smooth"})}return}let m=s.target.closest("[data-image-align-path]");if(m){let A=m.dataset.imageAlignPath,T=["left","center","right"].includes(m.dataset.imageAlign)?m.dataset.imageAlign:"center";Ht(A,{align:T}),Ki(),er(r,A);let L=k(`[data-image-path="${CSS.escape(A)}"]`,r);L&&mi(L,A);return}let v=s.target.closest("[data-image-fit-path]");if(v){let A=v.dataset.imageFitPath,T=nl.includes(v.dataset.imageFit)?v.dataset.imageFit:"auto";Ht(A,{fit:T}),Ki(),er(r,A);let L=k(`[data-image-path="${CSS.escape(A)}"]`,r);L&&mi(L,A);return}let S=s.target.closest("[data-image-alignpos-path]");if(S){let A=S.dataset.imageAlignposPath,T=qr.includes(S.dataset.imageAlignpos)?S.dataset.imageAlignpos:"default";Ht(A,{alignPos:T}),Ki(),er(r,A);let L=k(`[data-image-path="${CSS.escape(A)}"]`,r);L&&mi(L,A);return}let w=s.target.closest("[data-gallery-delete-index]");if(w){Sd(w.dataset.galleryDeleteIndex,Number(w.dataset.galleryIndex));return}}),r.addEventListener("input",s=>{let o=s.target.dataset.imageWidthPath;if(o!==void 0){let h=k(`[data-image-width-number="${CSS.escape(o)}"]`,r);h&&(h.value=s.target.value);return}let c=s.target.dataset.imageWidthNumber;if(c!==void 0){let h=Math.max(0,Math.min(100,Number(s.target.value)||0)),m=k(`[data-image-width-path="${CSS.escape(c)}"]`,r);m&&(m.value=h);return}});let a=(s,o)=>{let c=Math.max(0,Math.min(100,Number(o)||0));Ht(s,{width:c}),Ki();let h=k(`[data-image-path="${CSS.escape(s)}"]`,r);h&&mi(h,s),er(r,s)};r.addEventListener("change",s=>{let o=s.target.dataset.imageWidthPath;if(o!==void 0){a(o,s.target.value);return}let c=s.target.dataset.imageWidthNumber;if(c!==void 0){a(c,s.target.value);return}let h=s.target.closest("[data-image-path]");if(!h)return;let m=h.dataset.imagePath,v=h.value.trim(),S=String(B(u.config,m)||"");if(v!==S){if(Gr(v)){h.value=S,rc(h);return}He(u.config,m,v),v&&Ht(m,{hidden:!1}),Te("Gambar diperbarui"),mi(h,m)}}),r.addEventListener("paste",s=>{let o=s.target.closest("[data-image-path]");o&&setTimeout(()=>{o.dispatchEvent(new Event("change",{bubbles:!0}))},0)})}function rf(r){if(!xi(r,"colors"))return;let a=(o,c,h)=>{let m=o.value.trim();if(!m||!Cd(m)){if(h){let S=be(c);S&&(o.value=S)}return}Re(c,m);let v=k(`[data-color-var="${CSS.escape(c)}"]`,r);v&&(v.value=gi(m,v.value||"#000000"))},s=o=>{let c=Qi(o);if(!c)return;Re(o,c);let h=k(`[data-color-token-var="${CSS.escape(o)}"], [data-style-var="${CSS.escape(o)}"]`,r),m=k(`[data-color-var="${CSS.escape(o)}"]`,r);if(h){let v=h.tagName==="SELECT"?Array.from(h.options).map(S=>S.value):[];(!v.length||v.includes(c))&&(h.value=c)}m&&(m.value=gi(c,m.value))};r.addEventListener("click",o=>{let c=o.target.closest("[data-reset-token]");if(c){s(c.dataset.resetToken);return}if(o.target.closest("#"+e+"-reset-colors")){_.forEach(([,,h])=>{let m=be(h);m&&Re(h,Qi(h)||m)}),C("[data-color-token-var]",r).forEach(h=>{let m=h.dataset.colorTokenVar,v=be(m);v&&(h.value=v)}),C("[data-color-var]",r).forEach(h=>{h.value=gi(be(h.dataset.colorVar),h.value)});return}}),r.addEventListener("input",o=>{let c=o.target.dataset.colorTokenVar;if(c!==void 0){a(o.target,c,!1);return}let h=o.target.dataset.colorVar;if(h!==void 0){Re(h,o.target.value);let m=k(`[data-color-token-var="${CSS.escape(h)}"]`,r);m&&(m.value=o.target.value)}}),r.addEventListener("change",o=>{let c=o.target.dataset.colorTokenVar;c!==void 0&&a(o.target,c,!0)})}function nf(r){if(!xi(r,"style"))return;let a=(o,c)=>{let h=String(o.value||"").trim();if(h){if((c==="--sve-heading-weight"||c==="--sve-body-weight")&&!Rd(c==="--sve-heading-weight"?"heading":"body",h)){let v=be(c);v&&(o.value=v);return}Re(c,h),(c==="--sve-heading-weight"||c==="--sve-body-weight")&&ir()}},s=o=>{let c=Qi(o);if(!c)return;Re(o,c);let h=k(`[data-color-token-var="${CSS.escape(o)}"], [data-style-var="${CSS.escape(o)}"]`,r),m=k(`[data-color-var="${CSS.escape(o)}"]`,r);if(h){let v=h.tagName==="SELECT"?Array.from(h.options).map(S=>S.value):[];(!v.length||v.includes(c))&&(h.value=c)}m&&(m.value=gi(c,m.value))};r.addEventListener("click",o=>{let c=o.target.closest("[data-reset-token]");if(c){s(c.dataset.resetToken);return}if(o.target.closest("#"+e+"-reset-style")){Dd();return}if(o.target.closest("#"+e+"-reset-all")){Il();return}if(o.target.closest("#"+e+"-heading-font-apply")){rr("heading");return}o.target.closest("#"+e+"-body-font-apply")&&rr("body")}),r.addEventListener("change",o=>{let c=o.target.dataset.styleVar;c!==void 0&&a(o.target,c)}),r.addEventListener("input",o=>{if(o.target.tagName!=="SELECT")return;let c=o.target.dataset.styleVar;c!==void 0&&a(o.target,c)}),r.addEventListener("keydown",o=>{o.key==="Enter"&&(o.target.id===e+"-heading-font"?(o.preventDefault(),rr("heading")):o.target.id===e+"-body-font"&&(o.preventDefault(),rr("body")))})}function af(r){if(!xi(r,"audio"))return;let s=Sl().path||"assets.audio",o=k("#"+e+"-audio-url",r),c=k("#"+e+"-audio-start-enabled",r),h=k("#"+e+"-audio-start-time",r);if(!o)return;let m=()=>{let S=o.value.trim(),w=B(u.config,s);if(typeof w=="string"&&w===S){Jl(r,S);return}He(u.config,s,S),Te("Audio diperbarui"),Jl(r,S)},v=()=>{if(!c||!h)return;let S=o.value.trim(),w=c.checked?ar(h.value):0,A=Bd(S,w);o.value=A,h.disabled=!c.checked,c.checked&&(h.value=xn(w)),He(u.config,s,A),Te(w>0?"Waktu mulai audio diperbarui":"Waktu mulai audio dimatikan")};o.addEventListener("paste",()=>{setTimeout(m,0)}),o.addEventListener("change",m),c?.addEventListener("change",()=>{h&&(h.disabled=!c.checked,c.checked&&ar(h.value)<=0&&(h.value="0:00",h.focus()),v())}),h?.addEventListener("change",v)}function sf(r){xi(r,"compat")}function sc(){Object.values(u.editors).forEach(r=>{r&&zi(r,!0)})}function of(){Object.values(u.editors).forEach(r=>{if(r)try{r.save?.();let a=r.getTextArea?.();a?.dispatchEvent(new Event("input",{bubbles:!0})),a?.dispatchEvent(new Event("change",{bubbles:!0}))}catch{}})}function lf(r,a=""){let s=k("#"+e+"-body");if(!s||!xe()||(u.sourceDirty||!u.doc)&&!Se()||(r=String(r||"").trim(),r&&!mt(r)))return!1;let o=r&&hn().find(w=>w.path===r),c=li(),h=w=>Zi(w).some(A=>A.path===r||(A.type==="repeater"||le(A)==="repeater-image")&&r.startsWith(A.path+".")),m=r&&(c.find(w=>Z(w)===a&&h(w))||c.find(h))||c.find(w=>Z(w)===a);if(!o&&!m)return!1;u.search="";let v=k("#"+e+"-search");v&&(v.value=""),u.open||Dt(!0),Vt("content");let S;if(o){let w=k(`[data-section-card="${CSS.escape(Z(m))}"]`,s);if(!w)return!1;cn(w),S=k(`[data-image-path="${CSS.escape(r)}"]`,w),S||(S=k(".chev",w))}else{let w=k(`[data-section-card="${CSS.escape(Z(m))}"]`,s);if(!w)return!1;cn(w),S=r&&k(`[data-field-path="${CSS.escape(r)}"]`,w),S||(S=k(".chev",w))}return S?(S.focus({preventScroll:!0}),S.scrollIntoView({block:"nearest",behavior:"auto"}),!0):!1}let oc='#builder-canvas-boundary iframe[title="HTML Mode preview"][srcdoc]';function cf(r,a,s){if(typeof a!="string"||!a||a.length>256||typeof s!="string"||!s.startsWith("html-mode-preview:")||s.length>256)return null;let o=r?.getAttribute("srcdoc")||"";if(!o)return null;let c=u.canvasPickSources.get(r);if(!c||c.source!==o){let S=document.createElement("template");S.innerHTML=o,c={source:o,root:S.content.querySelector("#scalev-html-mode-preview-root"),scripts:C("script",S.content).map(w=>w.textContent).join(`
`)},u.canvasPickSources.set(r,c)}if(!c.root||!c.scripts.includes(JSON.stringify(s)))return null;let h=c.root.querySelector(`[data-scalev-inspector-id="${CSS.escape(a)}"]`);if(!h)return null;let m=h.matches("[data-sve-field]")?h:h.querySelector("[data-sve-field]")||h.closest("[data-sve-field]"),v=h.closest("[data-section-id], [data-sve-section]");return{path:m?.getAttribute("data-sve-field")||"",sectionHint:v?.getAttribute("data-section-id")||v?.id||v?.getAttribute("data-sve-section")||""}}function uf(){if(u.canvasPickMessageBound)return;u.canvasPickMessageBound=!0;let r=location.href,a=null;window.addEventListener("message",s=>{if(location.href!==r)return;let o=s.data;if(!o||o.type!=="scalev-html-mode-inspector-selected"||s.origin!=="null"||typeof o.inspectorId!="string"||!o.inspectorId||o.inspectorId.length>256||typeof o.previewId!="string"||o.previewId.length>256)return;let c=C(oc).find(U=>U.contentWindow===s.source);if(!c||!c.sandbox.contains("allow-scripts")||c.sandbox.contains("allow-same-origin"))return;let h=c.getAttribute("srcdoc"),m=location.href,{open:v,tab:S,sourceDirty:w}=u,A=u.performance.configCommitCount,T=D("html"),L=D("js");cancelAnimationFrame(a),a=requestAnimationFrame(()=>{if(a=null,location.href!==m||!c.isConnected||!c.matches(oc)||c.contentWindow!==s.source||c.getAttribute("srcdoc")!==h||u.open!==v||u.tab!==S||u.sourceDirty!==w||u.performance.configCommitCount!==A||D("html")!==T||D("js")!==L)return;let U=cf(c,o.inspectorId,o.previewId);U&&(U.path||U.sectionHint)&&lf(U.path,U.sectionHint)})})}function pf(){return C("button").find(r=>{if(r.closest("#"+e))return!1;let a=(r.textContent||"").replace(/\s+/g," ").trim().toLowerCase();return a==="simpan"||a==="save"})||null}function hf(){let r="https://wa.me/"+p+"?text="+encodeURIComponent(d);window.open(r,"_blank","noopener,noreferrer")}function vx(){if(!xe())return;if(of(),sc(),Se(),ic().blockers.length){u.tab="compatibility";let s=document.getElementById(e);C(".tab",s).forEach(o=>{o.classList.toggle("active",o.dataset.tab==="compatibility")}),ce();return}let a=pf();a&&a.click()}function df(){performance.mark("sve-styles-start"),ff(),performance.mark("sve-styles-critical-done"),Ft(mf,50)}function ff(){if(document.getElementById(e+"-style-critical"))return;let r=document.createElement("style");r.id=e+"-style-critical",r.textContent=`#${e},
#${e} * {
...
`,document.head.appendChild(r)}function mf(){if(document.getElementById(e+"-style-deferred"))return;let r=document.createElement("style");r.id=e+"-style-deferred",r.textContent=`
...
`,document.head.appendChild(r),performance.mark("sve-styles-all-done")}function gf(){df();let r=document.createElement("div");r.id=e,r.dataset.sveChannel="production",r.innerHTML=`
      <aside id="${e}-dock">
    ...
    `,document.body.appendChild(r),k("#"+e+"-close").onclick=()=>{Dt(!1)},k("#"+e+"-refresh").onclick=()=>{Se()&&(ce(),ze({force:!0,syncImages:!0}))},document.getElementById(e+"-reload-source").onclick=()=>{clearTimeout(u.contentCommitTimer),u.contentCommitTimer=null,u.contentCommitMessage="",u.contentStateDirty=!1,u.commitError="",document.getElementById(e+"-commit-notice").hidden=!0,Se()&&(ce(),ze({force:!0,syncImages:!0}))},k("#"+e+"-support").onclick=hf;let a=k("#"+e+"-editor-update"),s=k("#"+e+"-update-status"),o=!1,c=!1,h=0,m=null,v=15e3,S=(A,T,L=!1)=>{a.textContent=A,a.title=T,a.setAttribute("aria-label",T),a.disabled=L},w=()=>{h=Date.now()+v,S("Cek Update","Cek update Visual Editor",!0),clearTimeout(m),m=setTimeout(()=>{h=0,!c&&!o&&S("Cek Update","Cek update Visual Editor")},v)};a.addEventListener("click",()=>{if(o){window.open(g,"_blank","noopener");return}if(c||Date.now()<h){s.textContent="Tunggu sebentar";return}o=!1,c=!0,S("Mengecek...","Sedang mengecek update Visual Editor",!0),s.textContent="Mengecek GitHub...",GM_xmlhttpRequest({method:"GET",url:`${x}?check=${Date.now()}`,onload(A){let T=At=>{o=!1,c=!1,S("Cek Update","Cek update Visual Editor"),s.textContent=At,w()};if(A.status<200||A.status>=300){T(A.status===403||A.status===429?"Tunggu sebentar":"Gagal cek update");return}let U=(A.responseText||"").match(/@version\s+([^\s]+)/),ne=U&&U[1];if(!ne){T("Gagal cek update");return}ne===t?(o=!1,c=!1,S("Cek Update","Cek update Visual Editor"),s.textContent="Sudah terbaru",w()):(o=!0,c=!1,S("Pasang",`Pasang update Visual Editor versi ${ne}`),s.textContent=`Update tersedia: versi ${ne}.`)},onerror(){o=!1,c=!1,S("Cek Update","Cek update Visual Editor"),s.textContent="Gagal cek update",w()}})}),k("#"+e+"-search").addEventListener("input",si(A=>{u.search=A.target.value.toLowerCase().trim(),u.uiPrepared=!1,ce()},100)),C(".tab",r).forEach(A=>{A.onclick=()=>{xe()&&Vt(A.dataset.tab)}})}function bf(){let r=si(()=>{u.performance.editorScanCount=(u.performance.editorScanCount||0)+1,Mt(),Bi(),ul();let m=Et();m&&oi(m,{commit:!0,silent:!0}),u.open&&ji(!0);let v=Xr();if(v.length!==u.allEditors.length||v.some((S,w)=>S!==u.allEditors[w])){if(u.sourceDirty=!0,!Se())return;pi.invalidate(),ll(),u.open?ce():Ui()}},160),a='.CodeMirror, iframe, input, button, header, [role="tab"]',s=new MutationObserver(m=>{m.some(v=>!v.target.closest?.("#"+e)&&[...v.addedNodes,...v.removedNodes].some(S=>S instanceof Element&&!S.closest("#"+e)&&(S.matches(a)||S.querySelector(a))))&&r()}),o=null,c=()=>{let m=Jr();m!==o&&(s.disconnect(),o=m,m&&s.observe(m,{childList:!0,subtree:!0}),r())};new MutationObserver(m=>{c(),m.some(v=>[...v.addedNodes,...v.removedNodes].some(S=>S instanceof Element&&S.id!==e&&!S.closest("#"+e)&&(S.matches(a)||S.querySelector(a))))&&r()}).observe(document.body,{childList:!0}),c(),document.addEventListener("load",m=>{m.target instanceof HTMLIFrameElement&&(pi.invalidate(),ze({force:!0,syncImages:!0}))},!0),document.addEventListener("click",m=>{let v=m.target.closest?.("button");if(!(!v||v.closest("#"+e)||!/^(simpan|save|publish|terbitkan|simpan\s+(?:&|dan)\s+terbitkan)$/i.test(v.textContent.trim()))&&!(!u.config&&!u.doc?.querySelector("[data-sve-template]")&&!D("js").includes("SVE_SCHEMA"))){if(!xe()){m.preventDefault(),m.stopImmediatePropagation();return}sc(),tc().blockers.length&&(m.preventDefault(),m.stopImmediatePropagation(),Dt(!0),u.uiPrepared=!1,Vt("compatibility"))}},!0),document.addEventListener("keydown",m=>{m.key==="Escape"&&u.open&&document.getElementById(e)?.contains(m.target)&&(Dt(!1),document.getElementById(e+"-toolbar-toggle")?.focus())}),document.addEventListener("input",m=>{Kr(m.target)&&(u.scalevSlug=Ct(m.target.value),nh())},!0),document.addEventListener("change",m=>{if(Kr(m.target)){let v=Ct(m.target.value);v&&(u.scalevSlug=v,oi(v,{commit:!0}))}},!0),window.addEventListener("resize",si(()=>{Bi(),u.open&&ji(!0)},80))}function lc(){b()&&(gf(),ul(),uf(),bf(),Zr(),requestAnimationFrame(()=>{Bi()}),Ui(),console.info("[Scalev Visual Editor]",t))}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",lc,{once:!0}):lc()})();})();
